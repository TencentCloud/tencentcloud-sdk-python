...
class LighthouseClient(AbstractClient):
    ...
    def ApplyDiskBackup(self, request):
        r"""本接口（ApplyDiskBackup）用于回滚指定云硬盘的备份点。
        * 仅支持回滚到原云硬盘。
    ...
    def ApplyFirewallTemplate(self, request):
        r"""本接口 (ApplyFirewallTemplate) 用于应用防火墙模板到多个实例。
    ...
    def ApplyInstanceSnapshot(self, request):
        r"""本接口（ApplyInstanceSnapshot）用于回滚指定实例的系统盘快照。
        - 仅支持回滚到原系统盘。
    ...
    def AssociateInstancesKeyPairs(self, request):
        r"""本接口（AssociateInstancesKeyPairs）用于绑定用户指定密钥对到实例。
    ...
    def AttachDisks(self, request):
        r"""本接口（AttachDisks）用于挂载一个或多个云硬盘。
    ...
    def CancelShareBlueprintAcrossAccounts(self, request):
        r"""本接口（CancelShareBlueprintAcrossAccounts）用于取消镜像跨账号共享。
    ...
    def CreateDiskBackup(self, request):
        r"""本接口 ( CreateDiskBackup  ) 用于创建指定云硬盘（当前只支持数据盘）的备份点。
    ...
    def CreateDisks(self, request):
        r"""本接口(CreateDisks)用于创建一个或多个云硬盘。
    ...
    def CreateFirewallRules(self, request):
        r"""本接口（CreateFirewallRules）用于在实例上添加防火墙规则。
    ...
    def CreateFirewallTemplate(self, request):
        r"""本接口 (CreateFirewallTemplate) 用于创建防火墙模板。
    ...
    def CreateFirewallTemplateRules(self, request):
        r"""本接口 (CreateFirewallTemplateRules) 用于创建防火墙模板规则。
    ...
    def CreateInstanceSnapshot(self, request):
        r"""本接口（CreateInstanceSnapshot）用于创建指定实例的系统盘快照。
    ...
    def CreateInstances(self, request):
        r"""本接口(CreateInstances)用于创建一个或多个指定套餐的轻量应用服务器实例。
    ...
    def CreateMcpServer(self, request):
        r"""本接口（CreateMcpServer）用于创建MCP Server。
    ...
    def DeleteBlueprints(self, request):
        r"""本接口 (DeleteBlueprints) 用于删除镜像。可删除的镜像应满足如下条件：
    ...
    def DeleteDiskBackups(self, request):
        r"""本接口（DeleteDiskBackups）用于删除云硬盘备份点。
    ...
    def DeleteFirewallRules(self, request):
        r"""本接口（DeleteFirewallRules）用于删除实例的防火墙规则。
    ...
    def DeleteFirewallTemplate(self, request):
        r"""本接口 (DeleteFirewallTemplate) 用于删除防火墙模板。
    ...
    def DeleteFirewallTemplateRules(self, request):
        r"""本接口 (DeleteFirewallTemplateRules) 用于删除防火墙模板规则。
    ...
    def DescribeAllScenes(self, request):
        r"""本接口(DescribeAllScenes)用于查询全地域使用场景列表。
    ...
    def DescribeBlueprints(self, request):
        r"""本接口（DescribeBlueprints）用于查询镜像信息。该接口返回的镜像类型有：自定义镜像、共享镜像、公共镜像。
    ...
    def DescribeBundles(self, request):
        r"""本接口（DescribeBundles）用于查询套餐信息。
    ...
    def DescribeCcnAttachedInstances(self, request):
        r"""本接口 (DescribeCcnAttachedInstances) 用于查询云联网关联的实例信息。
    ...
    def DescribeDiskBackups(self, request):
        r"""本接口（DescribeDiskBackups）用于查询云硬盘备份点的详细信息。
    ...
    def DescribeDiskBackupsDeniedActions(self, request):
        r"""本接口（DescribeDiskBackupsDeniedActions）用于查询一个或多个云硬盘备份点的操作限制列表信息。
    ...
    def DescribeDiskConfigs(self, request):
        r"""本接口（DescribeDiskConfigs）用于查询云硬盘配置。
    ...
    def DescribeDiskDiscount(self, request):
        r"""本接口(DescribeDiskDiscount)用于查询云硬盘折扣信息。
    ...
    def DescribeDisksDeniedActions(self, request):
        r"""本接口（DescribeDisksDeniedActions）用于查询一个或多个云硬盘的操作限制列表信息。
    ...
    def DescribeDisksReturnable(self, request):
        r"""本接口（DescribeDisksReturnable）用于查询云硬盘是否可退还。
    ...
    def DescribeFirewallRules(self, request):
        r"""本接口（DescribeFirewallRules）用于查询实例的防火墙规则。
    ...
    def DescribeFirewallRulesTemplate(self, request):
        r"""本接口（DescribeFirewallRulesTemplate）用于查询防火墙规则模板。
    ...
    def DescribeFirewallTemplateApplyRecords(self, request):
        r"""本接口 (DescribeFirewallTemplateApplyRecords) 用于查询防火墙模板应用记录列表。
    ...
    def DescribeFirewallTemplateQuota(self, request):
        r"""本接口 (DescribeFirewallTemplateQuota) 用于查询防火墙模板配额。
    ...
    def DescribeFirewallTemplateRuleQuota(self, request):
        r"""本接口 (DescribeFirewallTemplateRuleQuota) 用于查询防火墙模板规则配额。
    ...
    def DescribeFirewallTemplateRules(self, request):
        r"""本接口 (DescribeFirewallTemplateRules) 用于查询防火墙模板规则列表。
    ...
    def DescribeFirewallTemplates(self, request):
        r"""本接口 (DescribeFirewallTemplates) 用于查询防火墙模板列表。
    ...
    def DescribeGeneralResourceQuotas(self, request):
        r"""本接口（DescribeGeneralResourceQuotas）用于查询通用资源配额信息。
    ...
    def DescribeImagesToShare(self, request):
        r"""本接口 (DescribeImagesToShare) 用于查询CVM的自定义镜像列表共享到轻量应用服务器。
    ...
    def DescribeInstancesDeniedActions(self, request):
        r"""本接口（DescribeInstancesDeniedActions）用于查询一个或多个实例的操作限制列表信息。
    ...
    def DescribeInstancesDiskNum(self, request):
        r"""本接口(DescribeInstancesDiskNum)用于查询实例挂载云硬盘数量。
    ...
    def DescribeInstancesReturnable(self, request):
        r"""本接口（DescribeInstancesReturnable）用于查询实例是否可退还。
    ...
    def DescribeInstancesTrafficPackages(self, request):
        r"""本接口（DescribeInstancesTrafficPackages）用于查询一个或多个实例的流量包详情。
    ...
    def DescribeKeyPairs(self, request):
        r"""本接口 (DescribeKeyPairs) 用于查询用户密钥对信息。
    ...
    def DescribeModifyInstanceBundles(self, request):
        r"""本接口（DescribeModifyInstanceBundles）用于查询实例可变更套餐列表。
    ...
    def DescribeRegions(self, request):
        r"""本接口（DescribeRegions）用于查询地域信息。
    ...
    def DescribeResetInstanceBlueprints(self, request):
        r"""本接口（DescribeResetInstanceBlueprints）查询重置实例的镜像信息。对于游戏专区实例，该接口只会返回当前镜像，且不支持 Filters 参数。
    ...
    def DescribeScenes(self, request):
        r"""本接口(DescribeScenes)用于查看使用场景列表。
    ...
    def DescribeSnapshotsDeniedActions(self, request):
        r"""本接口（DescribeSnapshotsDeniedActions）用于查询一个或多个快照的操作限制列表信息。
    ...
    def DetachDisks(self, request):
        r"""本接口（DetachDisks）用于卸载一个或多个云硬盘。该操作目前仅支持云硬盘类型为数据盘的云硬盘。
    ...
    def DisassociateInstancesKeyPairs(self, request):
        r"""本接口（DisassociateInstancesKeyPairs）用于解除实例与指定密钥对的绑定关系。
    ...
    def ImportKeyPair(self, request):
        r"""本接口（ImportKeyPair）用于导入用户指定密钥对。
    ...
    def InquirePriceCreateBlueprint(self, request):
        r"""本接口 (InquirePriceCreateBlueprint) 用于创建镜像询价。
    ...
    def InquirePriceCreateDisks(self, request):
        r"""本接口（InquirePriceCreateDisks）用于新购云硬盘询价。
    ...
    def InquirePriceCreateInstances(self, request):
        r"""本接口（InquiryPriceCreateInstances）用于创建实例询价。
    ...
    def InquirePriceRenewDisks(self, request):
        r"""本接口（InquirePriceRenewDisks）用于续费云硬盘询价。
    ...
    def InquirePriceRenewInstances(self, request):
        r"""本接口（InquirePriceRenewInstances）用于续费实例询价。
    ...
    def IsolateDisks(self, request):
        r"""本接口(IsolateDisks)用于退还一个或多个轻量应用服务器云硬盘。
    ...
    def IsolateInstances(self, request):
        r"""本接口(IsolateInstances)用于退还一个或多个轻量应用服务器实例。
    ...
    def ModifyBlueprintAttribute(self, request):
        r"""本接口 (ModifyBlueprintAttribute) 用于修改镜像属性。
    ...
    def ModifyDiskBackupsAttribute(self, request):
        r"""本接口 (ModifyDiskBackupsAttribute) 用于修改云硬盘备份点属性。
    ...
    def ModifyDisksAttribute(self, request):
        r"""本接口(ModifyDisksAttribute)用于修改云硬盘属性。
        云硬盘必须处于以下状态:
        <li> ATTACHED（已挂载）</li>
    ...
    def ModifyDisksRenewFlag(self, request):
        r"""本接口（ModifyDisksRenewFlag）用于修改云硬盘续费标识。
        云硬盘需要处于以下状态：
        <li> ATTACHED （已挂载）</li>
        <li> UNATTACHED （待挂载）</li>
        <li> ATTACHING （挂载中） </li>
    ...
    def ModifyDockerContainer(self, request):
        r"""修改实例内的Docker容器，之后可以通过返回的ActivityId调用<a href="https://cloud.tencent.com/document/product/1207/95476" target="_blank">DescribeDockerActivities</a>接口查询重建情况。
    ...
    def ModifyFirewallRuleDescription(self, request):
        r"""本接口（ModifyFirewallRuleDescription）用于修改单条防火墙规则描述。
    ...
    def ModifyFirewallRules(self, request):
        r"""本接口（ModifyFirewallRules）用于重置实例防火墙规则。
    ...
    def ModifyFirewallTemplate(self, request):
        r"""本接口 (ModifyFirewallTemplate) 用于修改防火墙模板。
    ...
    def ModifyImageSharePermission(self, request):
        r"""本接口 (ModifyImageSharePermission) 用于共享和取消共享CVM自定义镜像到轻量应用服务器服务。
    ...
    def ModifyInstancesBundle(self, request):
        r"""本接口(ModifyInstancesBundle)用于变更一个或多个轻量应用服务器实例套餐。
    ...
    def ModifyMcpServer(self, request):
        r"""本接口（ModifyMcpServer）用于修改实例的MCP Server信息。
    ...
    def RemoveDockerContainers(self, request):
        r"""删除实例内的Docker容器，之后可以通过返回的ActivityId调用[DescribeDockerActivities](https://cloud.tencent.com/document/product/1207/95476)接口查询删除情况。
    ...
    def RemoveMcpServers(self, request):
        r"""本接口（RemoveMcpServers）用于删除MCP Server。
    ...
    def RenameDockerContainer(self, request):
        r"""重命名实例内的Docker容器，之后可以通过返回的ActivityId调用[DescribeDockerActivities](https://cloud.tencent.com/document/product/1207/95476)接口查询重命名情况。
    ...
    def RenewDisks(self, request):
        r"""本接口(RenewDisks)用于续费一个或多个轻量应用服务器云硬盘。
    ...
    def RenewInstances(self, request):
        r"""本接口(RenewInstances)用于续费一个或多个轻量应用服务器实例。
    ...
    def ReplaceFirewallTemplateRule(self, request):
        r"""本接口 (ReplaceFirewallTemplateRules) 用于替换防火墙模板规则。
    ...
    def RerunDockerContainer(self, request):
        r"""重新创建并运行实例内的Docker容器，之后可以通过返回的ActivityId调用[DescribeDockerActivities](https://cloud.tencent.com/document/product/1207/95476)接口查询重建情况。
    ...
    def ResetAttachCcn(self, request):
        r"""本接口 (ResetAttachCcn) 用于关联云联网实例申请过期时，重新申请关联操作。
    ...
    def ResetFirewallTemplateRules(self, request):
        r"""本接口 (ResetFirewallTemplateRules) 用于重置防火墙模板下所有规则。
    ...
    def ResetInstance(self, request):
        r"""本接口（ResetInstance）用于重装指定实例上的镜像。
    ...
    def ResizeDisks(self, request):
        r"""本接口(ResizeDisks)用于扩容云硬盘。该操作目前仅支持云硬盘类型为数据盘且状态处于ATTACHED（已挂载）或 UNATTACHED（待挂载）的云硬盘。
    ...
    def RestartDockerContainers(self, request):
        r"""重启实例内的Docker容器，之后可以通过返回的ActivityId调用[DescribeDockerActivities](https://cloud.tencent.com/document/product/1207/95476)接口查询重启情况。
    ...
    def RestartMcpServers(self, request):
        r"""本接口（RestartMcpServers）用于重启实例中的MCP Server。
        - 本接口为异步接口，API返回时操作并未立即完成。MCP Server的操作结果可以通过调用 DescribeMcpServers 接口查询。
    ...
    def RunDockerContainers(self, request):
        r"""创建并运行多个Docker容器，之后可以通过返回的ActivityIds调用<a href="https://cloud.tencent.com/document/product/1207/95476" target="_blank">DescribeDockerActivities</a>接口查询创建情况。
    ...
    def ShareBlueprintAcrossAccounts(self, request):
        r"""本接口（ShareBlueprintAcrossAccounts）用于跨账号共享镜像。
    ...
    def StartDockerContainers(self, request):
        r"""启动实例内的Docker容器，之后可以通过返回的ActivityId调用[DescribeDockerActivities](https://cloud.tencent.com/document/product/1207/95476)接口查询启动情况。
    ...
    def StartMcpServers(self, request):
        r"""本接口（StartMcpServers）用于开启实例中的MCP Server。
        - 本接口为异步接口，API返回时操作并未立即完成。MCP Server的操作结果可以通过调用 DescribeMcpServers 接口查询。
        - 本接口在操作多个MCP Server时，不会因为某一个失败而停止。您需要通过调用 DescribeMcpServers 接口查询最终操作结果。
    ...
    def StopDockerContainers(self, request):
        r"""停止实例内的Docker容器，之后可以通过返回的ActivityId调用[DescribeDockerActivities](https://cloud.tencent.com/document/product/1207/95476)接口查询停止情况。
    ...
    def StopMcpServers(self, request):
        r"""本接口（StopMcpServers）用于关闭实例中的MCP Server。
        - 本接口为异步接口，API返回时操作并未立即完成。MCP Server的操作结果可以通过调用 DescribeMcpServers 接口查询。
        - 本接口在操作多个MCP Server时，不会因为某一个失败而停止。您需要通过调用 DescribeMcpServers 接口查询最终操作结果。
    ...
    def SyncBlueprint(self, request):
        r"""本接口 (SyncBlueprint) 用于将自定义镜像同步到其它地域。
    ...
    def TerminateDisks(self, request):
        r"""本接口（TerminateDisks）用于销毁一个或多个云硬盘。
    ...
    def TerminateInstances(self, request):
        r"""本接口 (TerminateInstances) 用于销毁实例。
