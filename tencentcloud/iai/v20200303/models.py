...
class CopyPersonRequest(AbstractModel):
    ...
    @property
    def GroupIds(self):
        r"""待加入的人员库列表，数组元素取值为创建人员库接口中的GroupId。
        :rtype: list of str
        """
...
- 若您确认图片包含exif信息或者您确认输入图中人脸不会出现被旋转情况，请不要开启本参数。开启后，整体耗时将可能增加数百毫秒。
    ...
    @property
    def GroupId(self):
        r"""待加入的人员库ID，取值为创建人员库接口中的GroupId。
        :rtype: str
        """
        return self._GroupId
...
class DeleteFaceRequest(AbstractModel):
    ...
    @property
    def FaceIds(self):
        r"""待删除的人脸ID列表，数组元素取值为增加人脸接口返回的FaceId。
        :rtype: list of str
        """
...
- 此参数用于控制处理待检测图片中的人脸个数，值越小，处理速度越快。
    ...
    def MinFaceSize(self):
        r"""人脸长和宽的最小尺寸，单位为像素，低于MinFaceSize值的人脸不会被检测。
- 只支持设置34和20，建议使用34。
        :rtype: int
        """
...
- 支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。
    ...
    def NeedFaceAttributes(self):
        r"""是否需要返回人脸属性信息（FaceAttributesInfo）。
- 0 为不需要返回，1 为需要返回。
- 默认为 0。 
- 非 1 值均视为不需要返回，此时 FaceAttributesInfo 不具备参考意义。  
- 最多返回面积最大的 5 张人脸属性信息，超过 5 张人脸（第 6 张及以后的人脸）的 FaceAttributesInfo 不具备参考意义。  
...
class DetectFaceSimilarityRequest(AbstractModel):
    ...
    @property
    def ImageA(self):
        r"""<p>A 图片 base64 数据。</p><ul><li>base64 编码后大小不可超过5M。</li><li>jpg格式长边像素不可超过4000，其他格式图片长边像素不可超2000。所有格式的图片短边像素不小于64。</li><li>若图片中包含多张人脸，只选取其中置信度最高的人脸。</li><li>支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。</li></ul>
        :rtype: str
        """
        return self._ImageA
    ...
    @property
    def ImageB(self):
        r"""<p>B 图片 base64 数据。</p><ul><li>base64 编码后大小不可超过5M。</li><li>jpg格式长边像素不可超过4000，其他格式图片长边像素不可超2000。所有格式的图片短边像素不小于64。</li><li>若图片中包含多张人脸，只选取其中置信度最高的人脸。</li><li>支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。</li></ul>
        :rtype: str
        """
        return self._ImageB
    ...
    @property
    def UrlA(self):
        r"""<p>A 图片的 Url。</p><ul><li>对应图片 base64 编码后大小不可超过5M。</li><li>jpg格式长边像素不可超过4000，其他格式图片长边像素不可超2000。所有格式的图片短边像素不小于64。</li><li>A 图片的 Url、Image必须提供一个，如果都提供，只使用 Url。 </li><li>图片存储于腾讯云的Url可保障更高下载速度和稳定性，建议图片存储于腾讯云。 </li><li>非腾讯云存储的Url速度和稳定性可能受一定影响。</li><li>若图片中包含多张人脸，只选取其中人脸面积最大的人脸。</li><li>支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。</li></ul>
        :rtype: str
        """
        return self._UrlA
    ...
    @property
    def UrlB(self):
        r"""<p>B 图片的 Url 。</p><ul><li>对应图片 base64 编码后大小不可超过5M。</li><li>jpg格式长边像素不可超过4000，其他格式图片长边像素不可超2000。所有格式的图片短边像素不小于64。</li><li>B 图片的 Url、Image必须提供一个，如果都提供，只使用 Url。 </li><li>图片存储于腾讯云的Url可保障更高下载速度和稳定性，建议图片存储于腾讯云。 </li><li>非腾讯云存储的Url速度和稳定性可能受一定影响。</li><li>若图片中包含多张人脸，只选取其中人脸面积最大的人脸。</li><li>支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。</li></ul>
        :rtype: str
        """
        return self._UrlB
    ...
    @property
    def QualityControl(self):
        r"""<p>图片质量控制。 </p><ul><li><p>取值范围：<br>0: 不进行控制；<br>1: 较低的质量要求，图像存在非常模糊，眼睛鼻子嘴巴遮挡至少其中一种或多种的情况；<br>2: 一般的质量要求，图像存在偏亮，偏暗，模糊或一般模糊，眉毛遮挡，脸颊遮挡，下巴遮挡，至少其中三种的情况；<br>3: 较高的质量要求，图像存在偏亮，偏暗，一般模糊，眉毛遮挡，脸颊遮挡，下巴遮挡，其中一到两种的情况；<br>4: 很高的质量要求，各个维度均为最好或最多，在某一维度上存在轻微问题；<br>默认 0。 </p></li><li><p>若图片质量不满足要求，则返回结果中会提示图片质量检测不符要求。</p></li></ul>
        :rtype: int
        """
        return self._QualityControl
...
class DetectFaceSimilarityResponse(AbstractModel):
    r"""DetectFaceSimilarity返回参数结构体

    """

    def __init__(self):
        r"""
        :param _Score: <p>取值范围 [0.00, 100.00]。<br>推荐相似度大于等于70时可判断为同一人（采用固定阈值70，误通过率为万分之一，不支持调整阈值）。</p>
        :type Score: float
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
    ...
    @property
    def Score(self):
        r"""<p>取值范围 [0.00, 100.00]。<br>推荐相似度大于等于70时可判断为同一人（采用固定阈值70，误通过率为万分之一，不支持调整阈值）。</p>
        :rtype: float
        """
        return self._Score
...
class DetectLiveFaceAccurateRequest(AbstractModel):
    r"""DetectLiveFaceAccurate请求参数结构体
...
class DetectLiveFaceAccurateResponse(AbstractModel):
    r"""DetectLiveFaceAccurate返回参数结构体
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Hair(self):
        r"""头发信息，包含头发长度（length）、有无刘海（bang）、头发颜色（color）。
- NeedFaceAttributes 不为1 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
注意：此字段可能返回 null，表示取不到有效值。
...
- FaceAttributesType 不含Emotion 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
    ...
    @property
    def Eye(self):
        r"""眼睛相关信息，可识别是否戴眼镜、是否闭眼、是否双眼皮和眼睛大小。 
- FaceAttributesType 不含Eye 或检测超过 5 张人脸时，此参数仍返回，但不具备参考意义。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Length(self):
        r"""取值范围：0：光头，1：短发，2：中发，3：长发，4：绑发。
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._Length
...
class GetGroupInfoResponse(AbstractModel):
    ...
    def CreationTimestamp(self):
        r"""Group的创建时间和日期。CreationTimestamp 的值是自 Unix 纪元时间到Group创建时间的毫秒数。
        :rtype: int
        """
...
如果为0表示这个任务已经执行完毕。
    ...
    @property
    def Status(self):
        r"""0表示升级中，1表示升级完毕，2表示回滚完毕，3表示升级失败。
        :rtype: int
        """
        return self._Status
...
有关更多信息，请参阅 Unix 时间。
    ...
    def FailedFacesUrl(self):
        r"""无法升级的人脸Id信息，文件格式为json。内容参见下方示例。url有效期为半小时。
        :rtype: str
        """
...
- 有关更多信息，请参阅 Unix 时间。
    ...
    @property
    def CreationTimestamp(self):
        r"""人员的创建时间和日期 CreationTimestamp。
- CreationTimestamp 的值是自 Unix 纪元时间到Person创建时间的毫秒数。 
- Unix 纪元时间是 1970 年 1 月 1 日星期四，协调世界时 (UTC) 00:00:00。
- 有关更多信息，请参阅 Unix 时间。
        :rtype: int
...
- 若您确认图片包含exif信息或者您确认输入图中人脸不会出现被旋转情况，请不要开启本参数。开启后，整体耗时将可能增加数百毫秒。
    ...
    @property
    def GroupIds(self):
        r"""希望搜索的人员库列表，上限100个。数组元素取值为创建人员库接口中的GroupId。
        :rtype: list of str
        """
        return self._GroupIds
...
- 若您确认图片包含exif信息或者您确认输入图中人脸不会出现被旋转情况，请不要开启本参数。开启后，整体耗时将可能增加数百毫秒。
    ...
    @property
    def GroupIds(self):
        r"""希望搜索的人员库列表，上限60个。数组元素取值为创建人员库接口中的GroupId。
        :rtype: list of str
        """
        return self._GroupIds
...
- 2.0版本误识率千分之一对应分数为70分，误识率万分之一对应分数为80分，误识率十万分之一对应分数为90分。 一般超过80分则可认定为同一人。
    ...
    @property
    def FaceModelVersion(self):
        r"""人脸识别所用的算法模型版本，是该 Person 所在的人员库的算法模型版本。
- 在创建人员库时设置，详情可参考[算法模型版本](https://cloud.tencent.com/document/product/867/40042)
        :rtype: str
        """
        return self._FaceModelVersion
