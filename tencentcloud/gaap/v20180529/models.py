...
class AccessConfiguration(AbstractModel):
    r"""通道组加速地域列表，包括加速地域，以及该加速地域对应的带宽和并发配置。
    ...
    def NetworkType(self):
        r"""网络类型，可取值：normal、cn2，默认值为normal
        :rtype: str
        """
...
第7个bit，支持接入段Qos加速。
    ...
    @property
    def IDCType(self):
        r"""机房类型, dc表示DataCenter数据中心, ec表示EdgeComputing边缘节点
        :rtype: str
        """
...
class AccessRegionDomainConf(AbstractModel):
    ...
    def NationCountryInnerList(self):
        r"""就近接入区域国家内部编码，编码列表可通过DescribeCountryAreaMapping接口获取。
        :rtype: list of str
        """
...
class BanAndRecoverProxyRequest(AbstractModel):
    r"""BanAndRecoverProxy请求参数结构体

    """


class BanAndRecoverProxyResponse(AbstractModel):
    r"""BanAndRecoverProxy返回参数结构体
...
class BindListenerRealServersRequest(AbstractModel):
    r"""BindListenerRealServers请求参数结构体
...
class BindListenerRealServersResponse(AbstractModel):
    r"""BindListenerRealServers返回参数结构体
...
未开启健康检查状态时，该状态始终为正常。
    ...
    @property
    def DownIPList(self):
        r"""当源站为域名时，域名被解析成一个或者多个IP，该字段表示其中异常的IP列表。状态异常，但该字段为空时，表示域名解析异常。
        :rtype: list of str
        """
    ...
    def RealServerFailoverRole(self):
        r"""源站主备角色：master表示主，slave表示备，该参数必须在监听器打开了源站主备模式。
        :rtype: str
        """
...
class Certificate(AbstractModel):
    ...
    def CertificateName(self):
        r"""证书名称（旧参数，请使用CertificateAlias）。
        :rtype: str
        """
    ...
    @property
    def CreateTime(self):
        r"""证书创建时间，采用Unix时间戳的方式，表示从1970年1月1日（UTC/GMT的午夜）开始所经过的秒数。
        :rtype: int
        """
    ...
    @property
    def BeginTime(self):
        r"""证书生效起始时间，采用Unix时间戳的方式，表示从1970年1月1日（UTC/GMT的午夜）开始所经过的秒数。
        :rtype: int
        """
    ...
    @property
    def EndTime(self):
        r"""证书过期时间，采用Unix时间戳的方式，表示从1970年1月1日（UTC/GMT的午夜）开始所经过的秒数。
        :rtype: int
        """
...
class CertificateDetail(AbstractModel):
    r"""证书详情，包括证书ID， 证书名字，证书类型，证书内容以及密钥内容。
    ...
    @property
    def CreateTime(self):
        r"""创建时间，采用Unix时间戳的方式，表示从1970年1月1日（UTC/GMT的午夜）开始所经过的秒数。
        :rtype: int
        """
        return self._CreateTime
...
class CloseSecurityPolicyResponse(AbstractModel):
    ...
    @property
    def TaskId(self):
        r"""异步流程ID，可以通过DescribeAsyncTaskStatus 查询流程执行进展和状态
        :rtype: str
        """
        return self._TaskId
...
class CreateCustomHeaderRequest(AbstractModel):
    ...
    @property
    def Headers(self):
        r"""新增的header名称和内容列表， ‘’$remote_addr‘’会被解析替换成客户端ip，其他值原样透传到源站。
...
class CreateDomainErrorPageInfoRequest(AbstractModel):
    r"""CreateDomainErrorPageInfo请求参数结构体
...
class CreateDomainErrorPageInfoResponse(AbstractModel):
    r"""CreateDomainErrorPageInfo返回参数结构体
...
class CreateGlobalDomainDnsRequest(AbstractModel):
    r"""CreateGlobalDomainDns请求参数结构体
...
class CreateGlobalDomainDnsResponse(AbstractModel):
    r"""CreateGlobalDomainDns返回参数结构体
...
class CreateProxyGroupDomainRequest(AbstractModel):
    r"""CreateProxyGroupDomain请求参数结构体
...
class CreateProxyGroupDomainResponse(AbstractModel):
    r"""CreateProxyGroupDomain返回参数结构体
...
当设置该参数时，表示复制该通道。
    ...
    @property
    def RealServerRegion(self):
        r"""源站地域。当GroupId存在时，源站地域为通道组的源站地域,此时可不填该字段。当GroupId不存在时，需要填写该字段
        :rtype: str
        """
        return self._RealServerRegion
...
更多详细信息请参阅：如何保证幂等性。
    ...
    @property
    def GroupId(self):
        r"""通道所在的通道组ID，当在通道组中创建通道时必带，否则忽略该字段。
        :rtype: str
        """
        return self._GroupId
...
当设置该参数时，表示复制该通道。
    ...
    @property
    def NetworkType(self):
        r"""网络类型，normal表示常规BGP，cn2表示精品BGP，triple表示三网
        :rtype: str
        """
        return self._NetworkType
...
class CreateTCPListenersRequest(AbstractModel):
    ...
    @property
    def Scheduler(self):
        r"""监听器源站访问策略，其中：rr表示轮询；wrr表示加权轮询；lc表示最小连接数；lrtt表示最小时延。
        :rtype: str
        """
        return self._Scheduler
    ...
    @property
    def HealthCheck(self):
        r"""源站是否开启健康检查：1开启，0关闭，UDP监听器不支持健康检查
        :rtype: int
        """
        return self._HealthCheck
    ...
    @property
    def RealServerType(self):
        r"""监听器绑定源站类型。IP表示IP地址，DOMAIN表示域名。
        :rtype: str
        """
        return self._RealServerType
    ...
    def ClientIPMethod(self):
        r"""监听器获取客户端 IP 的方式，0表示 TOA, 1表示Proxy Protocol
        :rtype: int
        """
    ...
    def HealthyThreshold(self):
        r"""健康阈值，表示连续检查成功多少次后认定源站健康。范围为1到10
        :rtype: int
        """
    ...
    def UnhealthyThreshold(self):
        r"""不健康阈值，表示连续检查失败多少次数后认为源站不健康。范围为1到10
        :rtype: int
        """
...
class CreateUDPListenersRequest(AbstractModel):
    ...
    @property
    def CheckType(self):
        r"""UDP源站健康类型。PORT表示检查端口，PING表示PING。
        :rtype: str
        """
    ...
    def ContextType(self):
        r"""UDP源站健康检查端口探测报文类型：TEXT表示文本。仅在健康检查类型为PORT时使用。
        :rtype: str
        """
    ...
    def SendContext(self):
        r"""UDP源站健康检查端口探测发送报文。仅在健康检查类型为PORT时使用。
        :rtype: str
        """
    ...
    def RecvContext(self):
        r"""UDP源站健康检查端口探测接收报文。仅在健康检查类型为PORT时使用。
        :rtype: str
        """
...
class DeleteDomainErrorPageInfoRequest(AbstractModel):
    r"""DeleteDomainErrorPageInfo请求参数结构体
    ...
    @property
    def ErrorPageId(self):
        r"""定制错误响应页的唯一ID，请参考CreateDomainErrorPageInfo的响应
        :rtype: str
        """
        return self._ErrorPageId
...
class DeleteDomainErrorPageInfoResponse(AbstractModel):
    r"""DeleteDomainErrorPageInfo返回参数结构体
...
class DeleteGlobalDomainDnsRequest(AbstractModel):
    r"""DeleteGlobalDomainDns请求参数结构体
...
class DeleteGlobalDomainDnsResponse(AbstractModel):
    r"""DeleteGlobalDomainDns返回参数结构体
...
class DeleteListenersRequest(AbstractModel):
    ...
    @property
    def Force(self):
        r"""已绑定源站的监听器是否允许强制删除，1：允许， 0：不允许
        :rtype: int
        """
        return self._Force
    ...
    @property
    def GroupId(self):
        r"""通道组ID，该参数和ProxyId必须设置一个，但不能同时设置。
        :rtype: str
        """
        return self._GroupId
    ...
    @property
    def ProxyId(self):
        r"""通道ID，该参数和GroupId必须设置一个，但不能同时设置。
        :rtype: str
        """
        return self._ProxyId
...
class DeleteListenersResponse(AbstractModel):
    ...
    def InvalidStatusListenerSet(self):
        r"""无效的监听器ID列表，如：监听器不存在，监听器对应实例不匹配
        :rtype: list of str
        """
...
class DescribeAccessRegionsByDestRegionRequest(AbstractModel):
    r"""DescribeAccessRegionsByDestRegion请求参数结构体
    ...
    @property
    def DestRegion(self):
        r"""源站区域：接口DescribeDestRegions返回DestRegionSet中的RegionId字段值
        :rtype: str
        """
...
class DescribeAccessRegionsByDestRegionResponse(AbstractModel):
    r"""DescribeAccessRegionsByDestRegion返回参数结构体
...
class DescribeAuthSignatureRequest(AbstractModel):
    r"""DescribeAuthSignature请求参数结构体

    """


class DescribeAuthSignatureResponse(AbstractModel):
    r"""DescribeAuthSignature返回参数结构体
...
class DescribeBlackHeaderRequest(AbstractModel):
    r"""DescribeBlackHeader请求参数结构体

    """


class DescribeBlackHeaderResponse(AbstractModel):
    r"""DescribeBlackHeader返回参数结构体
...
class DescribeCertificateDetailRequest(AbstractModel):
    r"""DescribeCertificateDetail请求参数结构体
...
class DescribeCertificateDetailResponse(AbstractModel):
    r"""DescribeCertificateDetail返回参数结构体
...
class DescribeCountryAreaMappingRequest(AbstractModel):
    r"""DescribeCountryAreaMapping请求参数结构体

    """


class DescribeCountryAreaMappingResponse(AbstractModel):
    r"""DescribeCountryAreaMapping返回参数结构体
...
class DescribeCrossBorderProxiesRequest(AbstractModel):
    r"""DescribeCrossBorderProxies请求参数结构体

    """


class DescribeCrossBorderProxiesResponse(AbstractModel):
    r"""DescribeCrossBorderProxies返回参数结构体
...
class DescribeDestRegionsRequest(AbstractModel):
    ...
    def QualityType(self):
        r"""通道质量:0表示金牌，1表示银牌。默认不传该参数，表示金牌。本参数确定查询指定通道质量的源站区域
        :rtype: int
        """
...
class DescribeDomainErrorPageInfoByIdsRequest(AbstractModel):
    r"""DescribeDomainErrorPageInfoByIds请求参数结构体
...
class DescribeDomainErrorPageInfoByIdsResponse(AbstractModel):
    r"""DescribeDomainErrorPageInfoByIds返回参数结构体
...
class DescribeDomainErrorPageInfoRequest(AbstractModel):
    r"""DescribeDomainErrorPageInfo请求参数结构体
...
class DescribeDomainErrorPageInfoResponse(AbstractModel):
    r"""DescribeDomainErrorPageInfo返回参数结构体
...
class DescribeGlobalDomainDnsRequest(AbstractModel):
    r"""DescribeGlobalDomainDns请求参数结构体
...
class DescribeGlobalDomainDnsResponse(AbstractModel):
    r"""DescribeGlobalDomainDns返回参数结构体
...
class DescribeGlobalDomainsRequest(AbstractModel):
    r"""DescribeGlobalDomains请求参数结构体
...
class DescribeGlobalDomainsResponse(AbstractModel):
    r"""DescribeGlobalDomains返回参数结构体
...
class DescribeGroupAndStatisticsProxyRequest(AbstractModel):
    r"""DescribeGroupAndStatisticsProxy请求参数结构体
...
class DescribeGroupAndStatisticsProxyResponse(AbstractModel):
    r"""DescribeGroupAndStatisticsProxy返回参数结构体
...
class DescribeGroupDomainConfigRequest(AbstractModel):
    r"""DescribeGroupDomainConfig请求参数结构体
...
class DescribeGroupDomainConfigResponse(AbstractModel):
    r"""DescribeGroupDomainConfig返回参数结构体
...
class DescribeHTTPListenersRequest(AbstractModel):
    r"""DescribeHTTPListeners请求参数结构体
...
class DescribeHTTPListenersResponse(AbstractModel):
    r"""DescribeHTTPListeners返回参数结构体
...
class DescribeHTTPSListenersRequest(AbstractModel):
    r"""DescribeHTTPSListeners请求参数结构体
...
该功能的启停无法在监听器创建完毕后再修改。
    ...
    @property
    def ListenerId(self):
        r"""过滤条件，根据监听器ID进行精确查询。ListenerId、ProxyId、GroupId须至少填写一个，且ProxyId与GroupId至多只能填写其中一个。
        :rtype: str
        """
        return self._ListenerId
...
class DescribeHTTPSListenersResponse(AbstractModel):
    r"""DescribeHTTPSListeners返回参数结构体
...
class DescribeListenerRealServersRequest(AbstractModel):
    r"""DescribeListenerRealServers请求参数结构体
...
class DescribeListenerRealServersResponse(AbstractModel):
    r"""DescribeListenerRealServers返回参数结构体
...
class DescribeListenerStatisticsRequest(AbstractModel):
    r"""DescribeListenerStatistics请求参数结构体
...
查询间范围超过7天，支持最小粒度86400秒。
    ...
    def Granularity(self):
        r"""监控粒度，目前支持300，3600，86400，单位：秒。
查询时间范围不超过1天，支持最小粒度300秒；
查询间范围不超过7天，支持最小粒度3600秒；
查询间范围超过7天，支持最小粒度86400秒。
        :rtype: int
...
class DescribeListenerStatisticsResponse(AbstractModel):
    r"""DescribeListenerStatistics返回参数结构体
...
class DescribeProxiesStatusRequest(AbstractModel):
    r"""DescribeProxiesStatus请求参数结构体
...
class DescribeProxiesStatusResponse(AbstractModel):
    r"""DescribeProxiesStatus返回参数结构体
...
class DescribeProxyAndStatisticsListenersRequest(AbstractModel):
    r"""DescribeProxyAndStatisticsListeners请求参数结构体
...
class DescribeProxyAndStatisticsListenersResponse(AbstractModel):
    r"""DescribeProxyAndStatisticsListeners返回参数结构体
...
class DescribeProxyGroupDetailsRequest(AbstractModel):
    r"""DescribeProxyGroupDetails请求参数结构体
...
class DescribeProxyGroupDetailsResponse(AbstractModel):
    r"""DescribeProxyGroupDetails返回参数结构体
...
class DescribeProxyGroupListRequest(AbstractModel):
    r"""DescribeProxyGroupList请求参数结构体
...
class DescribeProxyGroupListResponse(AbstractModel):
    r"""DescribeProxyGroupList返回参数结构体
...
class DescribeProxyGroupStatisticsRequest(AbstractModel):
    r"""DescribeProxyGroupStatistics请求参数结构体
...
class DescribeProxyGroupStatisticsResponse(AbstractModel):
    r"""DescribeProxyGroupStatistics返回参数结构体
...
class DescribeProxyStatisticsRequest(AbstractModel):
    r"""DescribeProxyStatistics请求参数结构体
...
当时间范围不超过30天，支持最小粒度3600秒。
    ...
    @property
    def Isp(self):
        r"""运营商（通道为三网通道时有效），支持CMCC，CUCC，CTCC，传空值或不传则合并三个运营商数据
        :rtype: str
        """
        return self._Isp
...
class DescribeProxyStatisticsResponse(AbstractModel):
    r"""DescribeProxyStatistics返回参数结构体
...
class DescribeRealServerStatisticsRequest(AbstractModel):
    r"""DescribeRealServerStatistics请求参数结构体
    ...
    @property
    def WithinTime(self):
        r"""统计时长，单位：小时。仅支持最近1,3,6,12,24小时的统计查询
        :rtype: int
        """
    ...
    @property
    def Granularity(self):
        r"""统计的数据粒度，单位：秒，仅支持1分钟-60和5分钟-300粒度
        :rtype: int
        """
        return self._Granularity
...
class DescribeRealServerStatisticsResponse(AbstractModel):
    r"""DescribeRealServerStatistics返回参数结构体
...
最多支持5个标签，当存在两个或两个以上的标签时，满足其中任意一个标签时，源站会被拉取出来。
    ...
    @property
    def Filters(self):
        r"""过滤条件。filter的name取值(RealServerName,RealServerIP)
        :rtype: list of Filter
        """
        return self._Filters
...
class DescribeRealServersStatusRequest(AbstractModel):
    r"""DescribeRealServersStatus请求参数结构体
...
class DescribeRealServersStatusResponse(AbstractModel):
    r"""DescribeRealServersStatus返回参数结构体
...
class DescribeRegionAndPriceRequest(AbstractModel):
    r"""DescribeRegionAndPrice请求参数结构体
...
class DescribeRegionAndPriceResponse(AbstractModel):
    r"""DescribeRegionAndPrice返回参数结构体
...
class DescribeResourcesByTagRequest(AbstractModel):
    r"""DescribeResourcesByTag请求参数结构体
...
class DescribeResourcesByTagResponse(AbstractModel):
    r"""DescribeResourcesByTag返回参数结构体
...
class DescribeRuleRealServersRequest(AbstractModel):
    r"""DescribeRuleRealServers请求参数结构体
...
class DescribeRuleRealServersResponse(AbstractModel):
    r"""DescribeRuleRealServers返回参数结构体
...
class DescribeRulesByRuleIdsRequest(AbstractModel):
    r"""DescribeRulesByRuleIds请求参数结构体
...
class DescribeRulesByRuleIdsResponse(AbstractModel):
    r"""DescribeRulesByRuleIds返回参数结构体
...
class DescribeSecurityPolicyDetailRequest(AbstractModel):
    r"""DescribeSecurityPolicyDetail请求参数结构体
...
class DescribeSecurityPolicyDetailResponse(AbstractModel):
    r"""DescribeSecurityPolicyDetail返回参数结构体
...
class DescribeSecurityRulesRequest(AbstractModel):
    r"""DescribeSecurityRules请求参数结构体
...
class DescribeSecurityRulesResponse(AbstractModel):
    r"""DescribeSecurityRules返回参数结构体
...
当设置了GroupId时，会检查该监听器是否归属于该通道组。
    ...
    @property
    def ProxyId(self):
        r"""过滤条件，根据通道ID进行拉取，ProxyId/GroupId/ListenerId必须设置一个，但ProxyId和GroupId不能同时设置。
        :rtype: str
        """
        return self._ProxyId
...
当设置了GroupId时，会检查该监听器是否归属于该通道组。
    ...
    @property
    def GroupId(self):
        r"""过滤条件，根据通道组ID进行拉取，ProxyId/GroupId/ListenerId必须设置一个，但ProxyId和GroupId不能同时设置。
        :rtype: str
        """
        return self._GroupId
...
class DescribeTaskStatusRequest(AbstractModel):
    ...
    @property
    def TaskId(self):
        r"""任务ID，值为异步接口返回的RequestId，此参数不能传空值。
        :rtype: str
        """
        return self._TaskId
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Status(self):
        r"""状态，1表示关闭，0表示开启，2表示关闭中，3表示开启中
        :rtype: int
        """
        return self._Status
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def BanStatus(self):
        r"""封禁解封状态：BANNED表示已封禁，RECOVER表示已解封或未封禁，BANNING表示封禁中，RECOVERING表示解封中，BAN_FAILED表示封禁失败，RECOVER_FAILED表示解封失败。
        :rtype: str
        """
...
1表示启用。
    ...
    @property
    def CertificateId(self):
        r"""该域名对应的服务器证书ID，值为default时，表示使用默认证书（监听器配置的证书）。
        :rtype: str
        """
        return self._CertificateId
    ...
    @property
    def ClientCertificateId(self):
        r"""该域名对应的客户端证书ID，值为default时，表示使用默认证书（监听器配置的证书）。
        :rtype: str
        """
        return self._ClientCertificateId
...
class GlobalDns(AbstractModel):
    ...
    @property
    def Status(self):
        r"""解析状态：1表示运行中，2表示创建中，3表示修改中，4表示删除中
        :rtype: int
        """
        return self._Status
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Protocol(self):
        r"""监听器协议， HTTP表示HTTP，HTTPS表示HTTPS，此结构取值HTTP
        :rtype: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Protocol(self):
        r"""监听器协议， HTTP表示HTTP，HTTPS表示HTTPS，此结构取值HTTPS
        :rtype: str
        """
        return self._Protocol
...
class IPDetail(AbstractModel):
    ...
    @property
    def Provider(self):
        r"""供应商，BGP表示默认，CMCC表示中国移动，CUCC表示中国联通，CTCC表示中国电信
        :rtype: str
        """
...
class InquiryPriceCreateProxyRequest(AbstractModel):
    r"""InquiryPriceCreateProxy请求参数结构体
    ...
    @property
    def DestRegion(self):
        r"""（旧参数，请切换到RealServerRegion）源站区域名称。
        :rtype: str
        """
        return self._DestRegion
    ...
    def Concurrency(self):
        r"""（此参数为旧参数，请填写新参数Concurrent，二者必须填写一个）通道并发量上限，表示同时在线的连接数，单位：万。
        :rtype: int
        """
    ...
    @property
    def BillingType(self):
        r"""计费方式，0表示按带宽计费，1表示按流量计费。默认按带宽计费
        :rtype: int
        """
        return self._BillingType
...
class InquiryPriceCreateProxyResponse(AbstractModel):
    r"""InquiryPriceCreateProxy返回参数结构体
...
class ModifyCertificateAttributesRequest(AbstractModel):
    r"""ModifyCertificateAttributes请求参数结构体
...
class ModifyCertificateAttributesResponse(AbstractModel):
    r"""ModifyCertificateAttributes返回参数结构体
...
其他情况，使用该ClientCertificateId或PolyClientCertificateIds指定的证书。
    ...
    @property
    def CertificateId(self):
        r"""服务器SSL证书ID，仅适用于version3.0的通道。其中：
不带该字段时，表示使用原证书；
携带该字段时并且CertificateId=default，表示使用监听器证书；
其他情况，使用该CertificateId指定的证书。
        :rtype: str
    ...
    @property
    def ClientCertificateId(self):
        r"""客户端CA证书ID，仅适用于version3.0的通道。其中：
不带该字段和PolyClientCertificateIds时，表示使用原证书；
携带该字段时并且ClientCertificateId=default，表示使用监听器证书；
其他情况，使用该ClientCertificateId或PolyClientCertificateIds指定的证书。
        :rtype: str
...
class ModifyGlobalDomainAttributeRequest(AbstractModel):
    r"""ModifyGlobalDomainAttribute请求参数结构体
...
class ModifyGlobalDomainAttributeResponse(AbstractModel):
    r"""ModifyGlobalDomainAttribute返回参数结构体
...
class ModifyGlobalDomainDnsRequest(AbstractModel):
    r"""ModifyGlobalDomainDns请求参数结构体
...
class ModifyGlobalDomainDnsResponse(AbstractModel):
    r"""ModifyGlobalDomainDns返回参数结构体
...
class ModifyGroupDomainConfigRequest(AbstractModel):
    r"""ModifyGroupDomainConfig请求参数结构体
...
class ModifyGroupDomainConfigResponse(AbstractModel):
    r"""ModifyGroupDomainConfig返回参数结构体
...
class ModifyHTTPListenerAttributeRequest(AbstractModel):
    r"""ModifyHTTPListenerAttribute请求参数结构体
...
class ModifyHTTPListenerAttributeResponse(AbstractModel):
    r"""ModifyHTTPListenerAttribute返回参数结构体
...
class ModifyHTTPSListenerAttributeRequest(AbstractModel):
    r"""ModifyHTTPSListenerAttribute请求参数结构体
    ...
    @property
    def ClientCertificateId(self):
        r"""修改后的监听器客户端证书ID，不支持多客户端证书，多客户端证书新采用PolyClientCertificateIds字段
        :rtype: str
        """
        return self._ClientCertificateId
...
class ModifyHTTPSListenerAttributeResponse(AbstractModel):
    r"""ModifyHTTPSListenerAttribute返回参数结构体
...
class ModifyProxiesAttributeRequest(AbstractModel):
    r"""ModifyProxiesAttribute请求参数结构体
...
更多详细信息请参阅：如何保证幂等性。
    ...
    @property
    def InstanceIds(self):
        r"""（旧参数，请切换到ProxyIds）一个或多个待操作的通道ID。
        :rtype: list of str
        """
        return self._InstanceIds
...
class ModifyProxiesAttributeResponse(AbstractModel):
    r"""ModifyProxiesAttribute返回参数结构体
...
class ModifyProxyConfigurationRequest(AbstractModel):
    r"""ModifyProxyConfiguration请求参数结构体
...
class ModifyProxyConfigurationResponse(AbstractModel):
    r"""ModifyProxyConfiguration返回参数结构体
...
class ModifyProxyGroupAttributeRequest(AbstractModel):
    r"""ModifyProxyGroupAttribute请求参数结构体
...
class ModifyProxyGroupAttributeResponse(AbstractModel):
    r"""ModifyProxyGroupAttribute返回参数结构体
...
0，关闭。
    ...
    @property
    def ForwardProtocol(self):
        r"""加速通道转发到源站的协议类型，支持：default, HTTP和HTTPS。
当ForwardProtocol=default时，表示使用对应监听器的ForwardProtocol。
        :rtype: str
        """
        return self._ForwardProtocol
...
当ForwardHost=default时，使用规则的域名，其他情况为该字段所设置的值。
    ...
    @property
    def ServerNameIndicationSwitch(self):
        r"""服务器名称指示（ServerNameIndication，简称SNI）开关。ON表示开启，OFF表示关闭。
        :rtype: str
        """
        return self._ServerNameIndicationSwitch
...
class ModifyTCPListenerAttributeRequest(AbstractModel):
    r"""ModifyTCPListenerAttribute请求参数结构体
...
class ModifyTCPListenerAttributeResponse(AbstractModel):
    r"""ModifyTCPListenerAttribute返回参数结构体
...
class ModifyUDPListenerAttributeRequest(AbstractModel):
    r"""ModifyUDPListenerAttribute请求参数结构体
...
class ModifyUDPListenerAttributeResponse(AbstractModel):
    r"""ModifyUDPListenerAttribute返回参数结构体
...
class OpenSecurityPolicyResponse(AbstractModel):
    ...
    @property
    def TaskId(self):
        r"""异步流程ID，可以通过DescribeAsyncTaskStatus接口查询流程运行状态
        :rtype: str
        """
        return self._TaskId
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def IsOldGroup(self):
        r"""是否老通道组，2018-08-03之前创建的通道组为老通道组
        :rtype: bool
        """
    ...
    @property
    def ClientIPMethod(self):
        r"""通道获取客户端IP的方式，0表示TOA，1表示Proxy Protocol
        :rtype: list of int
        """
        return self._ClientIPMethod
    ...
    @property
    def PackageType(self):
        r"""通道组套餐类型：Thunder表示标准通道组，Accelerator表示银牌加速通道组，CrossBorder表示跨境通道组。
        :rtype: str
        """
        return self._PackageType
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def ProxyType(self):
        r"""通道类型，100表示THUNDER通道，103表示微软合作通道
        :rtype: int
        """
        return self._ProxyType
    ...
    @property
    def NetworkType(self):
        r"""网络类型：normal表示常规BGP，cn2表示精品BGP，triple表示三网，secure_eip表示定制安全EIP
        :rtype: str
        """
        return self._NetworkType
    ...
    @property
    def PackageType(self):
        r"""通道套餐类型：Thunder表示标准通道，Accelerator表示银牌加速通道，
CrossBorder表示跨境通道。
        :rtype: str
        """
        return self._PackageType
...
1表示启用。
    ...
    def InBanBlacklist(self):
        r"""是否在封禁黑名单中，其中：0表示不在黑名单中，1表示在黑名单中。
        :rtype: int
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def IsAutoScaleProxy(self):
        r"""是否是开启了auto scale的通道，0表示否，1表示是。
        :rtype: int
        """
...
class ProxySimpleInfo(AbstractModel):
    r"""内部接口使用，返回可以查询统计数据的通道和对应的监听器信息
...
class RealServerStatus(AbstractModel):
    r"""源站绑定信息查询，BindStatus， 0: 未被绑定 1：被规则或者监听器绑定
...
当调用ModifyRuleAttribute时，不支持修改该参数。
    ...
    @property
    def StatusCode(self):
        r"""确认源站正常的返回码，可选范围[100, 200, 300, 400, 500]
        :rtype: list of int non-negative
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def RuleStatus(self):
        r"""规则状态，0表示运行中，1表示创建中，2表示销毁中，3表示绑定解绑源站中，4表示配置更新中
        :rtype: int
        """
...
只要有一个源站健康状态为异常时，该状态为异常，具体源站的状态请查看RealServerSet。
    ...
    @property
    def ForwardHost(self):
        r"""通道转发到源站的请求所携带的host，其中default表示直接转发接收到的host。
        :rtype: str
        """
        return self._ForwardHost
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def ForcedRedirect(self):
        r"""强转HTTPS指示，当传递值为https:时表示强转为https
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._ForcedRedirect
...
[GAAP_TLS_CIPHERS_WIDE,GAAPTLS_CIPHERS_GENERAL,GAAPTLS_CIPHERS_STRICT]
    ...
    @property
    def Domain(self):
        r"""需要进行高级配置的域名，该域名为监听器下的转发规则的域名。
        :rtype: str
        """
        return self._Domain
...
默认为0。
    ...
    @property
    def RealServerCertificateId(self):
        r"""源站CA证书ID，从证书管理页获取。源站认证时，填写该参数或RealServerCertificateId参数
        :rtype: str
        """
        return self._RealServerCertificateId
    ...
    def PolyRealServerCertificateIds(self):
        r"""多源站CA证书ID，从证书管理页获取。源站认证时，填写该参数或RealServerCertificateId参数
        :rtype: list of str
        """
...
class SetTlsVersionRequest(AbstractModel):
    ...
    @property
    def TLSSupportVersion(self):
        r"""TLS版本,可选TLSv1、TLSv1.1、TLSv1.2、TLSv1.3
        :rtype: list of str
        """
        return self._TLSSupportVersion
    ...
    @property
    def TLSCiphers(self):
        r"""密码套件包,可选 GAAP_TLS_CIPHERS_STRICT，GAAP_TLS_CIPHERS_GENERAL，GAAP_TLS_CIPHERS_WIDE(默认)
        :rtype: str
        """
        return self._TLSCiphers
...
class SupportFeature(AbstractModel):
    ...
    @property
    def NetworkType(self):
        r"""接入区域支持的网络类型列表，normal表示支持常规BGP，cn2表示精品BGP，triple表示三网，secure_eip表示定制安全eip。
        :rtype: list of str
        """
        return self._NetworkType
...
1表示正常。
    ...
    @property
    def ClientIPMethod(self):
        r"""监听器获取客户端 IP 的方式，0表示TOA, 1表示Proxy Protocol
        :rtype: int
        """
        return self._ClientIPMethod
    ...
    def SessionPersist(self):
        r"""是否开启会话保持选项：0关闭， 非0开启，非0值为会话保持时间
        :rtype: int
        """
...
4表示配置变更中。
    ...
    @property
    def BindStatus(self):
        r"""监听器绑定源站状态， 0表示正常，1表示IP异常，2表示域名解析异常
        :rtype: int
        """
        return self._BindStatus
