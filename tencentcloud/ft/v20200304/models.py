...
您可以通过 [人脸检测与分析](https://cloud.tencent.com/document/api/867/32800)  接口获取人脸框位置信息。
    ...
    @property
    def FaceRect(self):
        r"""人脸框位置。若不输入则选择 Image 或 Url 中面积最大的人脸。  
您可以通过 [人脸检测与分析](https://cloud.tencent.com/document/api/867/32800)  接口获取人脸框位置信息。
...
支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。
    ...
    @property
    def Url(self):
        r"""图片的 Url ，对应图片 base64 编码后大小不可超过5M。 
图片的 Url、Image必须提供一个，如果都提供，只使用 Url。 
图片存储于腾讯云的 Url 可保障更高下载速度和稳定性，建议图片存储于腾讯云。 
非腾讯云存储的Url速度和稳定性可能受一定影响。 
支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。
    ...
    @property
    def RspImgType(self):
        r"""返回图像方式（base64 或 url ) ，二选一。url有效期为1天。默认值为base64。
        :rtype: str
        """
...
class ChangeAgePicResponse(AbstractModel):
    ...
    def ResultImage(self):
        r"""RspImgType 为 base64 时，返回处理后的图片 base64 数据。默认返回base64
        :rtype: str
        """
    ...
    @property
    def ResultUrl(self):
        r"""RspImgType 为 url 时，返回处理后的图片 url 数据。
        :rtype: str
        """
...
支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。
    ...
    @property
    def RspImgType(self):
        r"""返回图像方式（base64 或 url ) ，二选一。url有效期为1天。
        :rtype: str
        """
        return self._RspImgType
    ...
    def DisableGlobalEffect(self):
        r"""关闭全图动漫化，传入true（不分大小写）即关闭全图动漫化。
        :rtype: str
        """
...
class FaceCartoonPicResponse(AbstractModel):
    ...
    @property
    def ResultUrl(self):
        r"""RspImgType 为 url 时，返回处理后的图片 url 数据。(默认为base64)
        :rtype: str
        """
        return self._ResultUrl
...
class GradientInfo(AbstractModel):
    ...
    @property
    def Tempo(self):
        r"""图片的展示时长，即单张图片静止不变的时间。GIF默认每张图片0.7s，视频默认每张图片0.5s。最大取值1s。
        :rtype: float
        """
        return self._Tempo
    ...
    @property
    def MorphTime(self):
        r"""人像渐变的最长时间，即单张图片使用渐变特效的时间。 GIF默认值为0.5s，视频默值认为1s。最大取值1s。
        :rtype: float
        """
...
class MorphFaceRequest(AbstractModel):
    ...
    @property
    def Images(self):
        r"""<p>图片 base64 数据，base64 编码后大小不可超过5M。<br>jpg格式长边像素不可超过4000，其他格式图片长边像素不可超2000。<br>人员人脸总数量至少2张，不可超过5张。<br>若图片中包含多张人脸，只选取其中人脸面积最大的人脸。<br>支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。</p>
        :rtype: list of str
        """
        return self._Images
    ...
    @property
    def Urls(self):
        r"""<p>图片的 Url 。对应图片 base64 编码后大小不可超过5M。jpg格式长边像素不可超过4000，其他格式图片长边像素不可超2000。<br>Url、Image必须提供一个，如果都提供，只使用 Url。图片存储于腾讯云的Url可保障更高下载速度和稳定性，建议图片存储于腾讯云。<br>非腾讯云存储的Url速度和稳定性可能受一定影响。<br>支持PNG、JPG、JPEG、BMP，不支持 GIF 图片。<br>人员人脸总数量不可超过5张。<br>若图片中包含多张人脸，只选取其中人脸面积最大的人脸。</p>
        :rtype: list of str
        """
        return self._Urls
    ...
    def GradientInfos(self):
        r"""<p>人脸渐变参数。可调整每张图片的展示时长、人像渐变的最长时间</p>
    ...
    @property
    def OutputType(self):
        r"""<p>视频类型，取值0。目前仅支持MP4格式，默认为MP4格式</p>
        :rtype: int
        """
    ...
    def OutputWidth(self):
        r"""<p>视频宽度，取值[128,1280]。<br>单位：px<br>默认值：720</p>
        :rtype: int
        """
    ...
    def OutputHeight(self):
        r"""<p>视频高度，取值[128,1280]。<br>单位：px<br>默认值：1280</p>
        :rtype: int
        """
...
class MorphFaceResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _JobId: <p>人像渐变任务的Job id</p>
        :type JobId: str
        :param _EstimatedProcessTime: <p>预估处理时间，粒度为秒</p>
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def JobStatusCode(self):
        r"""当前任务状态码：1：排队中、3: 处理中、5: 处理失败、7:处理完成
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
