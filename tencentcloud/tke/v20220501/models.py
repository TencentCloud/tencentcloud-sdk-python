...
class DetachApplicationRoleRequest(AbstractModel):
    r"""DetachApplicationRole请求参数结构体
...
class DetachApplicationRoleResponse(AbstractModel):
    r"""DetachApplicationRole返回参数结构体
