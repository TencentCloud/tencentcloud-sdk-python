...
class IotexplorerClient(AbstractClient):
    ...
    async def BindUserDevice(
            self,
            request: models.BindUserDeviceRequest,
            opts: Dict = None,
    ) -> models.BindUserDeviceResponse:
        """
        ...
        kwargs = {}
        kwargs["action"] = "BindUserDevice"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.BindUserDeviceResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
    ...
    async def CallDeviceRRPCSync(
            self,
            request: models.CallDeviceRRPCSyncRequest,
            opts: Dict = None,
    ) -> models.CallDeviceRRPCSyncResponse:
        """
        ...
        kwargs = {}
        kwargs["action"] = "CallDeviceRRPCSync"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.CallDeviceRRPCSyncResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
    ...
    async def RevokeBindUserDevice(
            self,
            request: models.RevokeBindUserDeviceRequest,
            opts: Dict = None,
    ) -> models.RevokeBindUserDeviceResponse:
        """
        ...
        kwargs = {}
        kwargs["action"] = "RevokeBindUserDevice"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.RevokeBindUserDeviceResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
