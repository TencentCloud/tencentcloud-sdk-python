...
class CheckRequest(AbstractModel):
    """Check请求参数结构体
...
class CheckResponse(AbstractModel):
    """Check返回参数结构体
...
class DescribeMfaCodeStatusRequest(AbstractModel):
    ...
    def _deserialize(self, params):
        self.Tmpcode = params.get("Tmpcode")
        self.Skey = params.get("Skey")
        self.ClientUA = params.get("ClientUA")
        self.Interface = params.get("Interface")
        self.ClientIP = params.get("ClientIP")
...
class DescribeMfaCodeStatusResponse(AbstractModel):
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def _deserialize(self, params):
        ...
        self.RmDevice = params.get("RmDevice")
        self.Tmpcode = params.get("Tmpcode")
        self.Nickname = params.get("Nickname")
        self.HasOpenId = params.get("HasOpenId")
        self.RequestId = params.get("RequestId")
...
class DetectAuthRequest(AbstractModel):
    ...
    def _deserialize(self, params):
        ...
        self.UseAuthInfo = params.get("UseAuthInfo")
...
class DetectMaskAuthRequest(AbstractModel):
...
class DetectMaskAuthResponse(AbstractModel):
...
class DetectStateRequest(AbstractModel):
    """DetectState请求参数结构体
...
class DetectStateResponse(AbstractModel):
    """DetectState返回参数结构体
