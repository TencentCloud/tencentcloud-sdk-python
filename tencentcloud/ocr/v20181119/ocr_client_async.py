...
class OcrClient(AbstractClient):
    ...
    async def VerifyBizLicenseEnterprise4(
            ...
            opts: Dict = None,
    ) -> models.VerifyBizLicenseEnterprise4Response:
        """
        ...
        kwargs = {}
        kwargs["action"] = "VerifyBizLicenseEnterprise4"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.VerifyBizLicenseEnterprise4Response
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
        
        return await self.call_and_deserialize(**kwargs)
        
    async def VerifyGeneralCardWarn(
            self,
            request: models.VerifyGeneralCardWarnRequest,
            opts: Dict = None,
    ) -> models.VerifyGeneralCardWarnResponse:
        """
        提供针对卡证（如身份证、营业执照等）图片的PS篡改、AIGC合成、图片质量检测能力，可应用于业务流程中对卡证图片真实性、有效性校验的场景。
        """
        
        kwargs = {}
        kwargs["action"] = "VerifyGeneralCardWarn"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.VerifyGeneralCardWarnResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
