...
class OcrClient(AbstractClient):
    ...
    def AdvertiseOCR(self, request):
        r"""<b>此接口不再进行服务升级，建议您使用识别能力更强、服务性能更优的<a href="https://cloud.tencent.com/document/product/866/33526">通用印刷体识别</a>。</b>
    ...
    def FormulaOCR(self, request):
        r"""本接口支持识别主流初高中数学符号和公式，返回公式的 Latex 格式文本。
    ...
    def RecognizeFormulaOCR(self, request):
        r"""公式识别是教育的基础OCR识别能力，可支持理科（数学、物理、化学、生物）的印刷体和手写体的公式识别。
