...
class TsiClient(AbstractClient):
    ...
    async def TongChuanDisplay(
            self,
            request: models.TongChuanDisplayRequest,
            opts: Dict = None,
    ) -> models.TongChuanDisplayResponse:
        """
        获取同传结果。
        """
        
        kwargs = {}
        kwargs["action"] = "TongChuanDisplay"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.TongChuanDisplayResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
        
        return await self.call_and_deserialize(**kwargs)
        
    async def TongChuanRecognize(
            self,
            request: models.TongChuanRecognizeRequest,
            opts: Dict = None,
    ) -> models.TongChuanRecognizeResponse:
        """
        ...
        kwargs = {}
        kwargs["action"] = "TongChuanRecognize"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.TongChuanRecognizeResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
        
        return await self.call_and_deserialize(**kwargs)
        
    async def TongChuanSync(
            self,
            request: models.TongChuanSyncRequest,
            opts: Dict = None,
    ) -> models.TongChuanSyncResponse:
        """
        本接口提供上传音频，将音频进行语音识别并翻译成文本的服务。
        ...
        kwargs = {}
        kwargs["action"] = "TongChuanSync"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.TongChuanSyncResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
