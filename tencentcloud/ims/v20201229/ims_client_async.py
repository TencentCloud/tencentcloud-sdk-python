...
class ImsClient(AbstractClient):
    ...
    async def CreateImageModerationAsyncTask(
            self,
            request: models.CreateImageModerationAsyncTaskRequest,
            opts: Dict = None,
    ) -> models.CreateImageModerationAsyncTaskResponse:
        """
        ...
        kwargs = {}
        kwargs["action"] = "CreateImageModerationAsyncTask"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.CreateImageModerationAsyncTaskResponse
