...
class ImageRecognitionRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type CustomSubAccountUin: str
        :param StreamId: 视频流ID
        :type StreamId: str
        """
        self.Channel = None
        self.CustomAppId = None
        self.BizType = None
        self.DataId = None
        self.FileContent = None
        self.FileUrl = None
        ...
        self.Device = None
        self.CustomUin = None
        self.CustomSubAccountUin = None
        self.StreamId = None


    def _deserialize(self, params):
        self.Channel = params.get("Channel")
        self.CustomAppId = params.get("CustomAppId")
        self.BizType = params.get("BizType")
        self.DataId = params.get("DataId")
        self.FileContent = params.get("FileContent")
        self.FileUrl = params.get("FileUrl")
        ...
        if params.get("Device") is not None:
            self.Device = Device()
            self.Device._deserialize(params.get("Device"))
        self.CustomUin = params.get("CustomUin")
        self.CustomSubAccountUin = params.get("CustomSubAccountUin")
