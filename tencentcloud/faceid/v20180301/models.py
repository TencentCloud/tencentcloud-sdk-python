...
class BankCard2EVerificationRequest(AbstractModel):
    r"""BankCard2EVerification请求参数结构体
...
class BankCard2EVerificationResponse(AbstractModel):
    r"""BankCard2EVerification返回参数结构体
...
class BankCard4EVerificationRequest(AbstractModel):
    r"""BankCard4EVerification请求参数结构体
...
class BankCard4EVerificationResponse(AbstractModel):
    r"""BankCard4EVerification返回参数结构体
...
class CheckBankCardInformationRequest(AbstractModel):
    r"""CheckBankCardInformation请求参数结构体
...
class CheckBankCardInformationResponse(AbstractModel):
    r"""CheckBankCardInformation返回参数结构体
...
class CheckEidTokenStatusRequest(AbstractModel):
    ...
    @property
    def EidToken(self):
        r"""E证通流程的唯一标识，调用[GetEidToken](https://cloud.tencent.com/document/product/1007/54089)接口时生成。
        :rtype: str
        """
...
class CheckIdCardInformationRequest(AbstractModel):
    r"""CheckIdCardInformation请求参数结构体
    ...
    def __init__(self):
        ...
        :param _ImageUrl: <p>身份证人像面的 Url 地址</p><ul><li>支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。</li><li>支持的图片大小：所下载图片经 Base64 编码后不超过 10M。图片下载时间不超过 3 秒。</li><li>图片存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议图片存储于腾讯云。</li><li>非腾讯云存储的 Url 速度和稳定性可能受一定影响。</li></ul>
        :type ImageUrl: str
    ...
    def ImageBase64(self):
        r"""<p>身份证人像面的 Base64 值。</p><ul><li>支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。</li><li>支持的图片大小：所下载图片经Base64编码后不超过 7M。</li><li>请使用标准的Base64编码方式(带=补位)，编码规范参考RFC4648。</li><li>ImageBase64、ImageUrl二者必须提供其中之一。若都提供了，则按照ImageUrl&gt;ImageBase64的优先级使用参数。</li></ul>
        :rtype: str
        """
    ...
    @property
    def ImageUrl(self):
        r"""<p>身份证人像面的 Url 地址</p><ul><li>支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。</li><li>支持的图片大小：所下载图片经 Base64 编码后不超过 10M。图片下载时间不超过 3 秒。</li><li>图片存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议图片存储于腾讯云。</li><li>非腾讯云存储的 Url 速度和稳定性可能受一定影响。</li></ul>
        :rtype: str
        """
    ...
    @property
    def Config(self):
        r"""<p>配置。</p><ul><li><p>以下可选字段均为bool 类型，默认false。<br>CopyWarn，复印件告警。<br>BorderCheckWarn，边框和框内遮挡告警。<br>ReshootWarn，翻拍告警。<br>DetectPsWarn，PS检测告警（疑似存在PS痕迹）。<br>TempIdWarn，临时身份证告警。<br>Quality，图片质量告警（评价图片模糊程度）。</p></li><li><p>SDK 设置方式参考：<br>Config = Json.stringify({&quot;CopyWarn&quot;:true,&quot;ReshootWarn&quot;:true})。</p></li><li><p>API 3.0 Explorer 设置方式参考：<br>Config = {&quot;CopyWarn&quot;:true,&quot;ReshootWarn&quot;:true}。</p></li></ul>
        :rtype: str
        """
        return self._Config
    ...
    @property
    def IsEncrypt(self):
        r"""<p>是否需要对返回中的敏感信息进行加密。</p><ul><li>默认false。</li><li>敏感信息包括：Response.IdNum、Response.Name。</li></ul>
        :rtype: bool
        """
    ...
    @property
    def Encryption(self):
        r"""<p>是否需要对返回中的敏感信息进行加密,需指定加密算法Algorithm、CBC加密的初始向量、加密后的对称密钥。</p>
        :rtype: :class:`tencentcloud.faceid.v20180301.models.Encryption`
        """
        return self._Encryption
...
class CheckIdCardInformationResponse(AbstractModel):
    r"""CheckIdCardInformation返回参数结构体
    ...
    def __init__(self):
        ...
        :type IdNum: str
        :param _Portrait: <p>身份证头像照片的base64编码，如果抠图失败会拿整张身份证做比对并返回空。</p>
        :type Portrait: str
        :param _Warnings: <p>告警信息。</p><ul><li><p>当在Config中配置了告警信息会停止人像比对，Result返回错误（FailedOperation.OcrWarningOccurred）并有此告警信息。</p></li><li><p>Code 告警码列表和释义：<br>&#39;-9101&#39;：身份证边框不完整告警。<br>&#39;-9102&#39;：身份证复印件告警。<br>&#39;-9103&#39;：身份证翻拍告警。<br>&#39;-9105&#39;：身份证框内遮挡告警。<br>&#39;-9104&#39;：临时身份证告警。<br>&#39;-9106&#39;：身份证 PS 告警（疑似存在PS痕迹）。<br>&#39;-8001&#39;：图片模糊告警。</p></li><li><p>多个会用“|” 隔开，如 &quot;-9101|-9106|-9104&quot;。</p></li></ul>
        :type Warnings: str
        :param _Quality: <p>图片质量分数。</p><ul><li>当请求Config中配置图片模糊告警该参数才有意义。</li><li>取值范围（0～100），目前默认阈值是50分，低于50分会触发模糊告警。</li></ul>
        :type Quality: float
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Portrait(self):
        r"""<p>身份证头像照片的base64编码，如果抠图失败会拿整张身份证做比对并返回空。</p>
        :rtype: str
        """
    ...
    @property
    def Warnings(self):
        r"""<p>告警信息。</p><ul><li><p>当在Config中配置了告警信息会停止人像比对，Result返回错误（FailedOperation.OcrWarningOccurred）并有此告警信息。</p></li><li><p>Code 告警码列表和释义：<br>&#39;-9101&#39;：身份证边框不完整告警。<br>&#39;-9102&#39;：身份证复印件告警。<br>&#39;-9103&#39;：身份证翻拍告警。<br>&#39;-9105&#39;：身份证框内遮挡告警。<br>&#39;-9104&#39;：临时身份证告警。<br>&#39;-9106&#39;：身份证 PS 告警（疑似存在PS痕迹）。<br>&#39;-8001&#39;：图片模糊告警。</p></li><li><p>多个会用“|” 隔开，如 &quot;-9101|-9106|-9104&quot;。</p></li></ul>
        :rtype: str
        """
    ...
    @property
    def Quality(self):
        r"""<p>图片质量分数。</p><ul><li>当请求Config中配置图片模糊告警该参数才有意义。</li><li>取值范围（0～100），目前默认阈值是50分，低于50分会触发模糊告警。</li></ul>
        :rtype: float
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def ErrCode(self):
        r"""<p>本次流程最终验证结果。</p><ul><li>取值范围：0为成功。</li><li>仅包含活体人脸核身结果，不包含意愿核身结果。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._ErrCode
    ...
    @property
    def ErrMsg(self):
        r"""<p>本次流程最终验证结果描述。</p><ul><li>仅描述用，文案更新时不会通知。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._ErrMsg
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def UseIDType(self):
        r"""<p>用户认证时使用的证件号码类型。</p><ul><li>取值范围：<br>  0：二代身份证的证件号码。<br>  1：港澳台居住证的证件号码。<br>  2：其他（核验使用的证件号码非合法身份号码）。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def OcrBirth(self):
        r"""<p>身份校验环节识别结果：生日。</p><ul><li>格式为：YYYY/M/D</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def OcrValidDate(self):
        r"""<p>身份校验环节识别结果：有效日期。</p><ul><li>格式为：YYYY.MM.DD-YYYY.MM.DD。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def IdInfoFrom(self):
        r"""<p>身份校验环节采用的信息上传方式。</p><ul><li>取值有&quot;NFC&quot;、&quot;OCR&quot;、&quot;手动输入&quot;、&quot;其他&quot;</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
    ...
    @property
    def LiveStatus(self):
        r"""<p>本次流程最终活体结果。</p><ul><li>0为成功</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._LiveStatus
    ...
    @property
    def LiveMsg(self):
        r"""<p>本次流程最终活体结果描述。</p><ul><li>仅描述用，文案更新时不会通知。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._LiveMsg
    ...
    @property
    def Comparestatus(self):
        r"""<p>本次流程最终一比一结果。</p><ul><li>0为成功</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._Comparestatus
    ...
    @property
    def Comparemsg(self):
        r"""<p>本次流程最终一比一结果描述。</p><ul><li>仅描述用，文案更新时不会通知。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._Comparemsg
    ...
    @property
    def Sim(self):
        r"""<p>本次流程活体一比一的分数。- 取值范围 [0.00, 100.00]。- 相似度大于等于70时才判断为同一人，阈值不支持自定义。- 阈值70的误通过率为万分之一。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._Sim
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def LivenessDetail(self):
        r"""<p>本次流程进行的活体一比一流水。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: list of DetectDetail
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def CompareLibType(self):
        r"""<p>本次流程最终比对库源类型。</p><ul><li>取值范围：<br>  权威库。<br>  业务方自有库（用户上传照片、客户的混合库、混合部署库）。<br>  二次验证库。<br>  人工审核库。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._CompareLibType
    ...
    @property
    def LivenessMode(self):
        r"""<p>本次流程最终活体类型。</p><ul><li>取值范围：<br>  0：未知<br>  1：数字活体<br>  2：动作活体<br>  3：静默活体<br>  4：一闪活体（动作+光线）<br>  5：远近活体</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._LivenessMode
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def LivenessActionSequence(self):
        r"""<p>活体检测的动作顺序，多动作以“,”分隔。<br>输出格式如：“1,2”表示“张嘴+眨眼”。</p><ul><li>详细序列值含义如下：<br> 1：张嘴<br>2：眨眼<br>3：点头<br>4：摇头<br>5：静默<br>注：仅浮层H5产品返回</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def LivenessVideos(self):
        r"""当次token中所有用户活体视频的COS存储路径，仅当您开启数据存储服务且“IsReturnAllVideo”入参取值为true 时返回。
注意：此字段可能返回 null，表示取不到有效值。
...
class EidInfo(AbstractModel):
    r"""Eid出参，包括商户方用户的标识和加密的用户姓名身份证信息。
    ...
    @property
    def DesKey(self):
        r"""商户方公钥加密的会话密钥的base64字符串，[指引详见](https://cloud.tencent.com/document/product/1007/63370)。
        :rtype: str
        """
        return self._DesKey
    ...
    @property
    def UserInfo(self):
        r"""会话密钥sm2加密后的base64字符串，[指引详见](https://cloud.tencent.com/document/product/1007/63370)。
        :rtype: str
        """
...
class EncryptedPhoneVerificationRequest(AbstractModel):
    r"""EncryptedPhoneVerification请求参数结构体
...
3：使用SM3加密
    ...
    def EncryptionMode(self):
        r"""敏感信息的加密方式，目前支持明文、MD5和SHA256加密传输，参数取值：
...
class EncryptedPhoneVerificationResponse(AbstractModel):
    r"""EncryptedPhoneVerification返回参数结构体
...
class GetActionSequenceResponse(AbstractModel):
    r"""GetActionSequence返回参数结构体

    """

    def __init__(self):
        r"""
        :param _ActionSequence: 动作顺序，例如：2,1 or 1,2。
- 1代表张嘴，2代表闭眼。
...
class GetDetectInfoEnhancedRequest(AbstractModel):
    r"""GetDetectInfoEnhanced请求参数结构体
...
- 敏感信息包括：Response.Text.IdCard、Response.Text.Name、Response.Text.OcrIdCard、Response.Text.OcrName。
    ...
    @property
    def BizToken(self):
        r"""人脸核身流程的标识，调用[DetectAuth](https://cloud.tencent.com/document/product/1007/31816)接口时生成。
        :rtype: str
        """
        return self._BizToken
...
- 敏感信息包括：Response.Text.IdCard、Response.Text.Name、Response.Text.OcrIdCard、Response.Text.OcrName。
    ...
    def IsReturnAllVideo(self):
        r"""是否需要返回认证中间过程的刷脸重试视频，默认不开启，多段视频需要存储到COS空间中，因此开启后还需要额外开启数据存储服务才可生效。详见[数据存储指引](https://cloud.tencent.com/document/product/1007/104229)。
        :rtype: bool
        """
...
class GetDetectInfoEnhancedResponse(AbstractModel):
    r"""GetDetectInfoEnhanced返回参数结构体
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def IdCardData(self):
        r"""身份证照片信息。
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: :class:`tencentcloud.faceid.v20180301.models.DetectInfoIdCardData`
        """
    ...
    def BestFrame(self):
        r"""最佳帧信息。
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: :class:`tencentcloud.faceid.v20180301.models.DetectInfoBestFrame`
        """
        return self._BestFrame
    ...
    def VideoData(self):
        r"""视频信息。
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: :class:`tencentcloud.faceid.v20180301.models.DetectInfoVideoData`
        """
...
默认值：0
    ...
    @property
    def RuleId(self):
        r"""用于细分客户使用场景，申请开通服务后，可以在腾讯云慧眼人脸核身控制台（https://console.cloud.tencent.com/faceid） 自助接入里面创建，审核通过后即可调用。如有疑问，请加慧眼小助手微信（faceid001）进行咨询。
        :rtype: str
        """
        return self._RuleId
    ...
    @property
    def InfoType(self):
        r"""指定拉取的结果信息，取值（0：全部；1：文本类；2：身份证正反面；3：视频最佳截图照片；4：视频）。
如 134表示拉取文本类、视频最佳截图照片、视频。
默认值：0
        :rtype: str
        """
...
class GetFaceIdRiskInfoRequest(AbstractModel):
    ...
    @property
    def FaceIdToken(self):
        r"""SDK人脸核身流程的标识，调用[GetFaceidRiskInfoToken](https://cloud.tencent.com/document/product/1007/104581)接口时生成。
        :rtype: str
        """
        return self._FaceIdToken
...
class GetFaceidRiskInfoTokenRequest(AbstractModel):
    r"""GetFaceidRiskInfoToken请求参数结构体
...
class GetFaceidRiskInfoTokenResponse(AbstractModel):
    r"""GetFaceidRiskInfoToken返回参数结构体
...
class GetLiveCodeRequest(AbstractModel):
    r"""GetLiveCode请求参数结构体

    """


class GetLiveCodeResponse(AbstractModel):
    r"""GetLiveCode返回参数结构体

    """

    def __init__(self):
        r"""
        :param _LiveCode: 数字验证码。
        :type LiveCode: str
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
...
class IdCardOCRVerificationResponse(AbstractModel):
    r"""IdCardOCRVerification返回参数结构体
...
class ImageRecognitionV2Request(AbstractModel):
    ...
    @property
    def Name(self):
        r"""<p>姓名。</p><ul><li>中文请使用UTF-8编码。</li></ul>
        :rtype: str
        """
        return self._Name
    ...
    @property
    def Extra(self):
        r"""<p>自定义描述字段。</p><ul><li><p>用于描述调用业务信息，出参中将返回此描述字段。</p></li><li><p>每个自定义描述字段最长支持10 个字符（即 [0,10] 个字符）；不传该参数时，出参中此字段返回空字符串。</p></li></ul>
        :rtype: str
        """
        return self._Extra
...
class ImageRecognitionV2Response(AbstractModel):
    ...
    def __init__(self):
        ...
        :param _Description: <p>业务结果描述。</p>
        :type Description: str
        :param _Extra: <p>调用接口中自定义的描述字段。</p>
        :type Extra: str
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
    ...
    @property
    def Result(self):
        r"""<p>业务错误码。</p><ul><li>成功情况返回Success。</li><li>错误情况请参考下方错误码 列表中FailedOperation部分</li></ul>
        :rtype: str
        """
        return self._Result
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Video(self):
        r"""视频base64编码（其中包含全程提示文本和点头音频，mp4格式）
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._Video
...
- 最大长度为250个字符。
    ...
    @property
    def Answers(self):
        r"""当选择语音问答模式时，用于判断用户回答是否通过的标准答案列表。
- 传入后可自动判断用户回答文本是否在标准文本列表中。
- 列表长度最大为50，单个答案长度限制10个字符。
        :rtype: list of str
        """
...
class LivenessCompareRequest(AbstractModel):
    ...
    def LivenessType(self):
        r"""<p>活体检测类型。</p><ul><li>取值：LIP/ACTION/SILENT。</li><li>LIP为数字模式，ACTION为动作模式，SILENT为静默模式，三种模式选择一种传入。</li></ul>
        :rtype: str
        """
    ...
    @property
    def ImageBase64(self):
        r"""<p>用于人脸比对的照片的Base64值。</p><ul><li>Base64编码后的图片数据大小不超过3M，仅支持jpg、png格式。</li><li>请使用标准的Base64编码方式(带=补位)，编码规范参考RFC4648。</li><li>图片的 ImageUrl、ImageBase64 必须提供一个，如果都提供，只使用 ImageBase64。</li></ul>
        :rtype: str
        """
        return self._ImageBase64
    ...
    @property
    def ImageUrl(self):
        r"""<p>用于人脸比对照片的URL地址。</p><ul><li>图片下载后经Base64编码后的数据大小不超过3M，仅支持jpg、png格式。</li><li>图片的 ImageUrl、ImageBase64 必须提供一个，如果都提供，只使用 ImageBase64。</li><li>图片存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议图片存储于腾讯云。</li><li>非腾讯云存储的 Url 速度和稳定性可能受一定影响。</li></ul>
        :rtype: str
        """
        return self._ImageUrl
    ...
    def ValidateData(self):
        r"""<p>验证数据。</p><ul><li>数字模式传参：传数字验证码，验证码需先调用<a href="https://cloud.tencent.com/document/product/1007/31821">获取数字验证码接口</a>得到；</li><li>动作模式传参：传动作顺序，动作顺序需先调用<a href="https://cloud.tencent.com/document/product/1007/31822">获取动作顺序接口</a>得到；</li><li>静默模式传参：空。</li></ul>
        :rtype: str
        """
    ...
    @property
    def Optional(self):
        r"""<p>额外配置，传入JSON字符串。</p><ul><li>格式如下：<br>{<br>&quot;BestFrameNum&quot;: 2  //需要返回多张最佳截图，取值范围2-10<br>}</li></ul>
        :rtype: str
        """
        return self._Optional
    ...
    @property
    def VideoBase64(self):
        r"""<p>用于活体检测的视频，视频的Base64值。</p><ul><li>Base64编码后的大小不超过8M，支持mp4、avi、flv格式。</li><li>请使用标准的Base64编码方式(带=补位)，编码规范参考RFC4648。</li><li>视频的 VideoUrl、VideoBase64 必须提供一个，如果都提供，只使用 VideoBase64。</li></ul>
        :rtype: str
        """
        return self._VideoBase64
    ...
    @property
    def VideoUrl(self):
        r"""<p>用于活体检测的视频Url 地址。</p><ul><li>视频下载后经Base64编码后不超过 8M，视频下载耗时不超过4S，支持mp4、avi、flv格式。</li><li>视频的 VideoUrl、VideoBase64 必须提供一个，如果都提供，只使用 VideoBase64。</li><li>建议视频存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议视频存储于腾讯云。</li><li>非腾讯云存储的 Url 速度和稳定性可能受一定影响。</li></ul>
        :rtype: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        :param _Description: <p>业务结果描述。</p>
        :type Description: str
        :param _BestFrameList: <p>最佳截图列表。</p><ul><li>仅在配置了返回多张最佳截图时返回。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def BestFrameBase64(self):
        r"""<p>验证通过后的视频最佳截图照片。</p><ul><li>照片为BASE64编码后的值，jpg格式。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._BestFrameBase64
    ...
    def BestFrameList(self):
        r"""<p>最佳截图列表。</p><ul><li>仅在配置了返回多张最佳截图时返回。</li></ul>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: list of str
        """
...
class LivenessRecognitionRequest(AbstractModel):
    ...
    @property
    def VideoBase64(self):
        r"""<p>用于活体检测的视频，视频的BASE64值；<br>BASE64编码后的大小不超过8M，支持mp4、avi、flv格式。</p>
        :rtype: str
        """
        return self._VideoBase64
    ...
    @property
    def VideoUrl(self):
        r"""<p>用于活体检测的视频Url 地址。</p><ul><li>视频下载后经Base64编码不超过 8M，视频下载耗时不超过4S，支持mp4、avi、flv格式。</li><li>视频的 VideoUrl、VideoBase64 必须提供一个，如果都提供，只使用 VideoBase64。</li><li>建议视频存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议视频存储于腾讯云。</li><li>非腾讯云存储的 Url 速度和稳定性可能受一定影响。</li></ul>
        :rtype: str
        """
        return self._VideoUrl
    ...
    @property
    def ValidateData(self):
        r"""<p>验证数据。</p><ul><li>数字活体模式传参：传数字验证码，验证码需先调用<a href="https://cloud.tencent.com/document/product/1007/31821">获取数字验证码接口</a>得到；</li><li>动作活体模式传参：传动作顺序，动作顺序需先调用<a href="https://cloud.tencent.com/document/product/1007/31822">获取动作顺序接口</a>得到；</li><li>静默活体模式传参：空。</li></ul>
        :rtype: str
        """
        return self._ValidateData
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        :param _Description: <p>业务结果描述。</p>
        :type Description: str
        :param _BestFrameList: <p>最佳截图列表，仅在配置了返回多张最佳截图时返回。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :type BestFrameList: list of str
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
...
手机号验证只限制在腾讯健康守护可信模型覆盖的数据范围内，与手机号本身在运营商是否实名无关联，不在范围会提示“手机号未实名”，建议客户与传入姓名和身份证号信息组合使用。
    ...
    @property
    def Encryption(self):
        r"""敏感数据加密信息。对传入信息（姓名、身份证号、手机号）有加密需求的用户可使用此参数，详情请点击左侧链接。
        :rtype: :class:`tencentcloud.faceid.v20180301.models.Encryption`
        """
        return self._Encryption
...
class MobileNetworkTimeVerificationRequest(AbstractModel):
    r"""MobileNetworkTimeVerification请求参数结构体
...
class MobileNetworkTimeVerificationResponse(AbstractModel):
    r"""MobileNetworkTimeVerification返回参数结构体
...
class PhoneVerificationCMCCRequest(AbstractModel):
    r"""PhoneVerificationCMCC请求参数结构体
...
class PhoneVerificationCMCCResponse(AbstractModel):
    r"""PhoneVerificationCMCC返回参数结构体
...
class PhoneVerificationCTCCRequest(AbstractModel):
    r"""PhoneVerificationCTCC请求参数结构体
...
class PhoneVerificationCTCCResponse(AbstractModel):
    r"""PhoneVerificationCTCC返回参数结构体
...
class PhoneVerificationCUCCRequest(AbstractModel):
    r"""PhoneVerificationCUCC请求参数结构体
...
class PhoneVerificationCUCCResponse(AbstractModel):
    r"""PhoneVerificationCUCC返回参数结构体
...
- 默认值为0。
    ...
    @property
    def CiphertextBlob(self):
        r"""有加密需求的用户，传入kms的CiphertextBlob。关于数据加密可查阅 <a href="https://cloud.tencent.com/document/product/1007/47180">数据加密</a> 文档。
        :rtype: str
        """
        return self._CiphertextBlob
...
3：固定1.5倍速
    ...
    @property
    def IntentionRecognition(self):
        r"""意愿核身过程中识别用户的回答意图，开启后除了IntentionQuestions的Answers列表中的标准回答会通过，近似意图的回答也会通过，默认开启。
        :rtype: bool
        """
        return self._IntentionRecognition
...
1：点头模式，DetectAuth接口需要传入IntentionActions字段；
    ...
    @property
    def MouthOpenRecognition(self):
        r"""用户语音回答过程中是否开启张嘴识别检测，默认不开启，仅在意愿核身问答模式中使用。
        :rtype: bool
        """
        return self._MouthOpenRecognition
    ...
    @property
    def Speed(self):
        r"""意愿核身语音播报速度，配置后问答模式和点头模式的语音播报环节都会生效，默认值为0：
0：智能语速（根据播报文案的长度自动调整语音播报速度）
1：固定1倍速
2：固定1.2倍速
3：固定1.5倍速
...
class WeChatBillDetail(AbstractModel):
    ...
    def ChargeCount(self):
        r"""本token收费次数。（说明：一次核身过程用户可能会重试多次，因此一个biztoken可能会对应多次计费，如需配置重试上限，请[联系我们](https://cloud.tencent.com/document/product/1007/56130)配置。）
        :rtype: int
        """
