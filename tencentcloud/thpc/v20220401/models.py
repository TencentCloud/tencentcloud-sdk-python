...
class AddClusterStorageOptionRequest(AbstractModel):
    ...
    def StorageOption(self):
        r"""集群存储选项。
        :rtype: :class:`tencentcloud.thpc.v20220401.models.StorageOption`
        """
...
class AddNodesRequest(AbstractModel):
    ...
    def Placement(self):
        r"""<p>集群中实例所在的位置。</p>
        :rtype: :class:`tencentcloud.thpc.v20220401.models.Placement`
        """
    ...
    def VirtualPrivateCloud(self):
        r"""<p>私有网络相关信息配置。</p>
        :rtype: :class:`tencentcloud.thpc.v20220401.models.VirtualPrivateCloud`
        """
    ...
    @property
    def ImageId(self):
        r"""<p>指定有效的<a href="https://cloud.tencent.com/document/product/213/4940">镜像</a>ID，格式形如<code>img-xxx</code>。目前仅支持公有镜像和特定自定义镜像。</p>
        :rtype: str
        """
    ...
    def InstanceChargeType(self):
        r"""<p>节点<a href="https://cloud.tencent.com/document/product/213/2180">计费类型</a>。<br><li>PREPAID：预付费，即包年包月</li><br><li>POSTPAID_BY_HOUR：按小时后付费</li><br><li>SPOTPAID：竞价付费<br>默认值：POSTPAID_BY_HOUR。</li></p>
        :rtype: str
        """
    ...
    def LoginSettings(self):
        r"""<p>集群登录设置。</p>
        :rtype: :class:`tencentcloud.thpc.v20220401.models.LoginSettings`
        """
    ...
    @property
    def NodeRole(self):
        r"""<p>添加节点角色。默认值：Compute<br><li>Compute：计算节点。</li><br><li>Login：登录节点。</li></p>
        :rtype: str
        """
...
class CreateClusterRequest(AbstractModel):
    ...
    def ManagerNode(self):
        r"""<p>指定管理节点。</p>
        :rtype: :class:`tencentcloud.thpc.v20220401.models.ManagerNode`
        """
    ...
    def ComputeNode(self):
        r"""<p>指定计算节点。</p>
        :rtype: :class:`tencentcloud.thpc.v20220401.models.ComputeNode`
        """
    ...
    @property
    def SchedulerType(self):
        r"""<p>调度器类型。默认取值：SLURM。<br><li>SLURM：SLURM调度器。</li></p>
        :rtype: str
        """
        return self._SchedulerType
    ...
    @property
    def ImageId(self):
        r"""<p>指定有效的<a href="https://cloud.tencent.com/document/product/213/4940">镜像</a>ID，格式形如<code>img-xxx</code>。目前支持部分公有镜像和自定义镜像。</p>
        :rtype: str
        """
        return self._ImageId
    ...
    def AccountType(self):
        r"""<p>域名字服务类型。默认取值：NIS。<li>NIS：NIS域名字服务。</li></p>
        :rtype: str
        """
    ...
    def LoginNode(self):
        r"""<p>指定登录节点。</p>
        :rtype: :class:`tencentcloud.thpc.v20220401.models.LoginNode`
        """
    ...
    def AutoScalingType(self):
        r"""<p>弹性伸缩类型。<br><li>AS：集群自动扩缩容由<a href="https://cloud.tencent.com/document/product/377/3154">弹性伸缩</a>产品实现。</li><br><li>THPC_AS：集群自动扩缩容由THPC产品内部实现。</li></p>
        :rtype: str
        """
...
class DescribeClusterStorageOptionResponse(AbstractModel):
    ...
    def StorageOption(self):
        r"""集群存储选项信息概览。
        :rtype: :class:`tencentcloud.thpc.v20220401.models.StorageOptionOverview`
        """
        return self._StorageOption
...
class DescribeNodesRequest(AbstractModel):
    ...
    @property
    def Filters(self):
        r"""<li><strong>queue-name</strong></li> <p style="padding-left: 30px;">按照【<strong>队列名称</strong>】进行过滤。队列名称形如：compute。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><p style="padding-left: 30px;"><li><strong>node-role</strong></li> <p style="padding-left: 30px;">按照【<strong>节点角色</strong>】进行过滤。节点角色形如：Manager。（Manager：管控节点。Compute：计算节点。Login：登录节点。ManagerBackup：备用管控节点。）</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><p style="padding-left: 30px;"><li><strong>node-type</strong></li> <p style="padding-left: 30px;">按照【<strong>节点类型</strong>】进行过滤。节点类型形如：STATIC。(STATIC：静态节点。DYNAMIC：弹性节点。)</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><p style="padding-left: 30px;">每次请求的`Filters`的上限为10，`Filter.Values`的上限为5。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def NodeState(self):
        r"""节点状态。<br><li>SUBMITTED：已完成提交。<br><li>CREATING：创建中。<br><li>CREATED：完成创建。<br><li>INITING：初始化中。<br><li>INIT_FAILED：初始化失败。<br><li>RUNNING：运行中。<br><li>DELETING：销毁中。
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def NodeRole(self):
        r"""节点角色。<br><li>Manager：管控节点。<br><li>Compute：计算节点。<br><li>Login：登录节点。<br><li>ManagerBackup：备用管控节点。
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._NodeRole
    ...
    @property
    def NodeType(self):
        r"""节点类型。<br><li>STATIC：静态节点。<br><li>DYNAMIC：弹性节点。
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._NodeType
