...
class CreateGroupLiveCodesRequest(AbstractModel):
    r"""CreateGroupLiveCodes请求参数结构体
...
class CreateGroupLiveCodesResponse(AbstractModel):
    r"""CreateGroupLiveCodes返回参数结构体

    """

    def __init__(self):
        r"""
        :param _GroupLiveCodes: <p>分组直播参加码</p>
        :type GroupLiveCodes: list of str
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self._GroupLiveCodes = None
        self._RequestId = None

    @property
    def GroupLiveCodes(self):
        r"""<p>分组直播参加码</p>
        :rtype: list of str
        """
        return self._GroupLiveCodes

    @GroupLiveCodes.setter
    def GroupLiveCodes(self, GroupLiveCodes):
        self._GroupLiveCodes = GroupLiveCodes
    ...
    def _deserialize(self, params):
        self._GroupLiveCodes = params.get("GroupLiveCodes")
        self._RequestId = params.get("RequestId")
...
class CreateRoomRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        self._EnableLiveRelay = None

    @property
    def Name(self):
        r"""<p>课堂名称。<br>字符数不超过256</p>
        :rtype: str
        """
        return self._Name
    ...
    @property
    def Resolution(self):
        r"""<p>头像区域，摄像头视频画面的分辨率。可以有如下取值：<br>1 标清<br>2 高清<br>3 全高清<br>注意：连麦人数（MaxMicNumber）&gt;6时，仅可使用标清</p>
        :rtype: int
        """
    ...
    def MaxMicNumber(self):
        r"""<p>设置课堂同时最大可与老师进行连麦互动的人数，该参数支持正式上课/开播前调用修改房间修改。小班课取值范围[0,16]，大班课取值范围[0,1]，当取值为0时表示当前课堂/直播，不支持连麦互动。该取值影响计费，请根据业务实际情况设置。计费规则见“购买指南”下“计费概述”。</p>
        :rtype: int
        """
    ...
    @property
    def SubType(self):
        r"""<p>课堂子类型，可以有以下取值：videodoc 文档+视频video 纯视频</p>
        :rtype: str
        """
    ...
    @property
    def TeacherId(self):
        r"""<p>老师ID。通过[注册用户]接口获取的UserId。指定后该用户在房间内拥有老师权限。</p>
        :rtype: str
        """
        return self._TeacherId
    ...
    @property
    def AutoMic(self):
        r"""<p>进入课堂时是否自动连麦。可以有以下取值：<br>0 不自动连麦（需要手动申请上麦，默认值）<br>1 自动连麦</p>
        :rtype: int
        """
    ...
    @property
    def TurnOffMic(self):
        r"""<p>释放音视频权限后是否自动取消连麦。可以有以下取值：<br>0 自动取消连麦（默认值）<br>1 保持连麦状态</p>
        :rtype: int
        """
    ...
    def AudioQuality(self):
        r"""<p>声音音质。可以有以下取值：<br>0：流畅模式（默认值），占用更小的带宽、拥有更好的降噪效果，适用于1对1、小班教学、多人音视频会议等场景。<br>1：高音质模式，适合需要高保真传输音乐的场景，但降噪效果会被削弱，适用于音乐教学场景。</p>
        :rtype: int
        """
    ...
    @property
    def Assistants(self):
        r"""<p>助教Id列表。通过[注册用户]接口获取的UserId。指定后该用户在房间内拥有助教权限。</p>
        :rtype: list of str
        """
    ...
    def RecordLayout(self):
        r"""<p>录制模板。未配置时默认取值0。录制模板枚举值参考：https://cloud.tencent.com/document/product/1639/89744</p>
        :rtype: int
        """
    ...
    def EnableDirectControl(self):
        r"""<p>是否允许老师/助教直接控制学生的摄像头/麦克风。可以有以下取值：<br>0 不允许直接控制（需同意，默认值）<br>1 允许直接控制（无需同意）</p>
        :rtype: int
        """
    ...
    def InteractionMode(self):
        r"""<p>开启专注模式。<br>0 收看全部角色音视频(默认)<br>1 只看老师和助教</p>
        :rtype: int
        """
    ...
    def VideoOrientation(self):
        r"""<p>横竖屏。0：横屏开播（默认值）; 1：竖屏开播，当前仅支持移动端的纯视频类型</p>
        :rtype: int
        """
    ...
    @property
    def RoomType(self):
        r"""<p>课堂类型。  注：大班课的布局(layout)只有三分屏</p><p>枚举值：</p><ul><li>0： 小班课（默认值）</li><li>1： 大班课</li><li>2： 1V1 (预留参数，暂未开放);</li><li>3： 圆桌会议</li><li>4： 分组直播 </li></ul><p>默认值：0</p>
        :rtype: int
        """
    ...
    @property
    def Guests(self):
        r"""<p>嘉宾Id列表。当圆桌会议模式（RoomType==3）时生效</p>
        :rtype: list of str
        """
        return self._Guests
    ...
    def EndDelayTime(self):
        r"""<p>拖堂时间：单位分钟，0为不限制(默认值), -1为不能拖堂，大于0为拖堂的时间，最大值120分钟</p>
        :rtype: int
        """
    ...
    @property
    def LiveType(self):
        r"""<p>直播类型：0 常规（默认）1 伪直播 2 RTMP推流直播</p>
        :rtype: int
        """
    ...
    def RecordLiveUrl(self):
        r"""<p>伪直播链接。 支持的协议以及格式： 协议：HTTP、HTTPS、RTMP、HLS 。格式：FLV、MP3、MP4、MPEG-TS、MOV、MKV、M4A。视频编码：H.264、VP8。音频编码：AAC、OPUS。</p><p>注意：伪直播视频规格建议最高使用1080p 30fps，4k视频会有兼容性问题导致直播失败。</p>
        :rtype: str
        """
    ...
    def EnableAutoStart(self):
        r"""<p>是否自动开始上课：0 不自动上课（默认） 1 自动上课 live_type=1或2的时候有效</p>
        :rtype: int
        """
    ...
    def RecordBackground(self):
        r"""<p>录制文件背景图片，支持png、jpg、jpeg、bmp格式，暂不支持透明通道</p>
        :rtype: str
        """
    ...
    def RecordScene(self):
        r"""<p>录制自定义场景。注意：仅recordlayout=9的时候此参数有效。需注意各类参数配置正确能够生效。不然会造成录制失败，失败后无法补救。数据内容为用户自定义场景参数，数据格式为json键值对方式，其中键值对的value为string类型。</p><p>自定义场景参数的含义。如下：<br>     scene：自定义js/css对应的场景值。如scene=recordScene，会加载 recordScene 场景对应的 js/css，这样就可以自定义录制页面的元素。<br>    lng：录制页面对应的语种。如lng=en，则录制界面为en。（枚举值：en,zh，zh-TW，jp，ar，kr，vi）<br>     customToken：录制页面中涉及客户自己的服务需要鉴权时进行配置。一般情况下，无需配置。</p>
        :rtype: str
        """
    ...
    def RecordLang(self):
        ...
        r"""<p>录制自定义语言，仅recordlayout=9的时候此参数有效</p>
        :rtype: str
        """
    ...
    def RecordStream(self):
        r"""<p>录制类型 0 仅录制混流（默认） ;1 录制混流+单流，该模式下除混流录制基础上，分别录制老师、台上学生的音视频流，每路录制都会产生相应的录制费用 。示例：0</p>
        :rtype: int
        """
    ...
    def WhiteBoardSnapshotMode(self):
        r"""<p>板书截图生成类型。0 不生成板书（默认）；1 全量模式；2 单页去重模式</p>
        :rtype: int
        """
    ...
    def SubtitlesTranscription(self):
        r"""<p>字幕转写功能开关。可以有以下取值：<br>0 不开启字幕转写功能（默认值）<br>1 自动转写模式：上课自动开启，下课自动停止<br>2 手动转写模式：支持老师或者助教通过客户端API手动开启/关闭字幕转写<br>设置0和1时客户端均不展示手动开关，设置2时老师或者助教端展示字幕转写开关</p>
        :rtype: int
        """
    ...
    def RecordMerge(self):
        r"""<p>录制文件合并开关。0 关闭 1 开启 注：只有在一节课多次启用手动录制时，此功能才有效</p>
        :rtype: int
        """
    ...
    @property
    def EnableLiveRelay(self):
        r"""<p>转推开关</p><p>枚举值：</p><ul><li>0： 关闭</li><li>1： 开启</li></ul>
        :rtype: int
        """
        return self._EnableLiveRelay

    @EnableLiveRelay.setter
    def EnableLiveRelay(self, EnableLiveRelay):
        self._EnableLiveRelay = EnableLiveRelay
    ...
    def _deserialize(self, params):
        ...
        self._EnableLiveRelay = params.get("EnableLiveRelay")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            property_name = name[1:]
            if property_name in memeber_set:
...
class DescribeGroupLiveCodesRequest(AbstractModel):
    r"""DescribeGroupLiveCodes请求参数结构体
...
class DescribeGroupLiveCodesResponse(AbstractModel):
    r"""DescribeGroupLiveCodes返回参数结构体
...
class DescribeRoomResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _Name: <p>课堂名称。</p>
        :type Name: str
        :param _StartTime: <p>预定的课堂开始时间，unix时间戳（秒）。</p>
        :type StartTime: int
        :param _EndTime: <p>预定的课堂结束时间，unix时间戳（秒）。</p>
        :type EndTime: int
        :param _TeacherId: <p>老师的UserId。</p>
        :type TeacherId: str
        :param _SdkAppId: <p>低代码互动课堂的SdkAppId。</p>
        :type SdkAppId: int
        :param _AudienceType: <p>观看类型。互动观看 （默认）</p>
        ...
        :type Resolution: int
        :param _MaxMicNumber: <p>设置课堂同时最大可与老师进行连麦互动的人数，该参数支持正式上课/开播前调用修改房间修改。小班课取值范围[0,16]，大班课取值范围[0,1]，当取值为0时表示当前课堂/直播，不支持连麦互动。</p>
        :type MaxMicNumber: int
        :param _AutoMic: <p>进入课堂时是否自动连麦。可以有以下取值：<br>0 不自动连麦（需要手动申请上麦，默认值）<br>1 自动连麦</p>
        :type AutoMic: int
        :param _AudioQuality: <p>高音质模式。可以有以下取值：<br>0 不开启高音质（默认值）<br>1 开启高音质</p>
        :type AudioQuality: int
        :param _SubType: <p>课堂子类型，可以有以下取值：videodoc 文档+视频video 纯视频</p>
        :type SubType: str
        ...
        :type DisableRecord: int
        :param _Assistants: <p>助教UserId列表。</p>
        :type Assistants: list of str
        :param _RecordUrl: <p>录制地址（协议为https)。仅在房间结束后存在。</p>
        :type RecordUrl: str
        :param _Status: <p>课堂状态。0为未开始，1为已开始，2为已结束，3为已过期。</p>
        :type Status: int
        :param _GroupId: <p>课堂绑定的群组ID</p>
        :type GroupId: str
        ...
        :param _RecordStream: <p>录制类型 0 仅录制混流（默认） ;1 录制混流+单流，该模式下除混流录制基础上，分别录制老师、台上学生的音视频流，每路录制都会产生相应的录制费用 。示例：0</p>
        :type RecordStream: int
        :param _RecordLayout: <p>录制模板。房间子类型为视频+白板（SubType=videodoc）时默认为3，房间子类型为纯视频（SubType=video）时默认为0。录制模板枚举值参考：https://cloud.tencent.com/document/product/1639/89744</p>
        :type RecordLayout: int
    ...
    @property
    def Resolution(self):
        r"""<p>头像区域，摄像头视频画面的分辨率。可以有如下取值：<br>1 标清<br>2 高清<br>3 全高清</p>
        :rtype: int
        """
        return self._Resolution
    ...
    @property
    def MaxMicNumber(self):
        r"""<p>设置课堂同时最大可与老师进行连麦互动的人数，该参数支持正式上课/开播前调用修改房间修改。小班课取值范围[0,16]，大班课取值范围[0,1]，当取值为0时表示当前课堂/直播，不支持连麦互动。</p>
        :rtype: int
        """
        return self._MaxMicNumber
    ...
    @property
    def AudioQuality(self):
        r"""<p>高音质模式。可以有以下取值：<br>0 不开启高音质（默认值）<br>1 开启高音质</p>
        :rtype: int
        """
        return self._AudioQuality
    ...
    @property
    def DisableRecord(self):
        r"""<p>录制方式。</p><p>枚举值：</p><ul><li>0： 开启自动录制</li><li>1： 禁止录制</li><li>2： 开启手动录制。（仅支持页面录制，需通过startRecord、stopRecord接口控制录制的开始和结束。）</li><li>3： 信令录制。</li></ul>
        :rtype: int
        """
        return self._DisableRecord
    ...
    @property
    def Status(self):
        r"""<p>课堂状态。0为未开始，1为已开始，2为已结束，3为已过期。</p>
        :rtype: int
        """
        return self._Status
    ...
    @property
    def IsGradingRequiredPostClass(self):
        r"""<p>该课堂是否开启了课后评分功能。0：未开启  1：开启</p>
        :rtype: int
        """
        return self._IsGradingRequiredPostClass
    ...
    @property
    def RoomType(self):
        r"""<p>课堂类型: 0 小班课（默认值）; 1 大班课; 2 1V1 (预留参数，暂未开放); 3 圆桌会议 注：大班课的布局(layout)只有三分屏</p>
        :rtype: int
        """
        return self._RoomType
    ...
    @property
    def EnableAutoStart(self):
        r"""<p>是否自动开始上课：0 不自动上课（默认） 1 自动上课 live_type=1的时候有效</p>
        :rtype: int
        """
        return self._EnableAutoStart
    ...
    @property
    def RecordLayout(self):
        r"""<p>录制模板。房间子类型为视频+白板（SubType=videodoc）时默认为3，房间子类型为纯视频（SubType=video）时默认为0。录制模板枚举值参考：https://cloud.tencent.com/document/product/1639/89744</p>
        :rtype: int
        """
        return self._RecordLayout
    ...
    @property
    def WhiteBoardSnapshotMode(self):
        r"""<p>板书截图生成类型。0 不生成板书；1 全量模式；2 单页去重模式</p>
        :rtype: int
        """
        return self._WhiteBoardSnapshotMode
...
class ModifyRoomRequest(AbstractModel):
    ...
    @property
    def StartTime(self):
        r"""<p>预定的房间开始时间，unix时间戳（秒）。直播开始后不允许修改。</p>
        :rtype: int
        """
        return self._StartTime
    ...
    @property
    def EndTime(self):
        r"""<p>预定的房间结束时间，unix时间戳（秒）。直播开始后不允许修改。</p>
        :rtype: int
        """
        return self._EndTime
    ...
    @property
    def Resolution(self):
        r"""<p>分辨率。可以有如下取值：<br>1 标清<br>2 高清<br>3 全高清<br>直播开始后不允许修改。</p>
        :rtype: int
        """
        return self._Resolution
    ...
    @property
    def MaxMicNumber(self):
        r"""<p>设置房间/课堂同时最大可与老师进行连麦互动的人数，该参数支持正式上课/开播前调用修改房间修改。小班课取值范围[0,16]，大班课取值范围[0,1]，当取值为0时表示当前课堂/直播，不支持连麦互动。</p>
        :rtype: int
        """
        return self._MaxMicNumber
    ...
    @property
    def AutoMic(self):
        r"""<p>进入房间时是否自动连麦。可以有以下取值：<br>0 不自动连麦（默认值）<br>1 自动连麦<br>直播开始后不允许修改。</p>
        :rtype: int
        """
        return self._AutoMic
    ...
    @property
    def AudioQuality(self):
        r"""<p>高音质模式。可以有以下取值：<br>0 不开启高音质（默认值）<br>1 开启高音质<br>直播开始后不允许修改。</p>
        :rtype: int
        """
        return self._AudioQuality
    ...
    @property
    def SubType(self):
        r"""<p>房间子类型，可以有以下取值：<br>videodoc 文档+视频<br>video 纯视频<br>直播开始后不允许修改。</p>
        :rtype: str
        """
        return self._SubType
    ...
    @property
    def EnableDirectControl(self):
        r"""<p>打开学生麦克风/摄像头的授权开关。直播开始后不允许修改。</p>
        :rtype: int
        """
        return self._EnableDirectControl
    ...
    @property
    def RoomType(self):
        r"""<p>房间类型: 0 小班课（默认值）; 1 大班课; 2 1V1 （预留参数、暂未开放)<br>注：大班课的布局(layout)只有三分屏</p>
        :rtype: int
        """
        return self._RoomType
    ...
    @property
    def RecordLayout(self):
        r"""<p>录制模板。仅可修改还未开始的房间。录制模板枚举值参考：https://cloud.tencent.com/document/product/1639/89744</p>
        :rtype: int
        """
        return self._RecordLayout
    ...
    @property
    def LiveType(self):
        r"""<p>直播方式：0 常规模式（默认）1 回放直播模式（伪直播）。 目前支持从回放直播模式（伪直播）改为常规模式，不支持从常规模式改为回放直播模式（伪直播）</p>
        :rtype: int
        """
        return self._LiveType
    ...
    @property
    def RecordScene(self):
        r"""<p>录制自定义场景，仅recordlayout=9的时候此参数有效,数据内容为用户自定义场景参数，数据格式为json键值对方式，其中键值对的value为string类型。</p>
        :rtype: str
        """
        return self._RecordScene
...
class RoomInfo(AbstractModel):
    ...
    @property
    def SubType(self):
        r"""<p>房间子类型，可以有以下取值： videodoc 文档+视频 video 纯视频</p>
        :rtype: str
        """
        return self._SubType
    ...
    @property
    def TeacherId(self):
        r"""<p>老师ID。通过[注册用户]接口获取的UserId。</p>
        :rtype: str
        """
        return self._TeacherId
    ...
    @property
    def AutoMic(self):
        r"""<p>进入课堂时是否自动连麦。可以有以下取值： 0 不自动连麦（需要手动申请上麦，默认值） 1 自动连麦</p>
        :rtype: int
        """
        return self._AutoMic
    ...
    @property
    def TurnOffMic(self):
        r"""<p>释放音视频权限后是否自动取消连麦。可以有以下取值： 0 自动取消连麦（默认值） 1 保持连麦状态</p>
        :rtype: int
        """
        return self._TurnOffMic
    ...
    @property
    def AudioQuality(self):
        r"""<p>高音质模式。可以有以下取值： 0 不开启高音质（默认值） 1 开启高音质</p>
        :rtype: int
        """
        return self._AudioQuality
    ...
    @property
    def Assistants(self):
        r"""<p>助教Id列表。通过[注册用户]接口获取的UserId。</p>
        :rtype: list of str
        """
        return self._Assistants
    ...
    @property
    def InteractionMode(self):
        r"""<p>开启专注模式。 0 收看全部角色音视频(默认) 1 只看老师和助教</p>
        :rtype: int
        """
        return self._InteractionMode
