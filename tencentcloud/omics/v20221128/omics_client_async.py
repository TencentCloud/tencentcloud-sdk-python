...
class OmicsClient(AbstractClient):
    ...
    async def DeleteEnvironmentCache(
            self,
            request: models.DeleteEnvironmentCacheRequest,
            opts: Dict = None,
    ) -> models.DeleteEnvironmentCacheResponse:
        """
        删除环境缓存。
        """
        
        kwargs = {}
        kwargs["action"] = "DeleteEnvironmentCache"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.DeleteEnvironmentCacheResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
