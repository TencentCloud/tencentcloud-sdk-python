...
class CreateBasicDBInstancesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Zone: str
        :param _Cpu: <p>实例的CPU核心数</p>
        :type Cpu: int
        :param _Memory: <p>实例内存大小，单位GB</p>
        :type Memory: int
        :param _Storage: <p>实例磁盘大小，单位GB</p>
        :type Storage: int
        :param _SubnetId: <p>VPC子网ID，形如subnet-bdoe83fa</p>
        :type SubnetId: str
        :param _VpcId: <p>VPC网络ID，形如vpc-dsp338hz</p>
        :type VpcId: str
        :param _MachineType: <p>购买实例的宿主机类型，CLOUD_PREMIUM-虚拟机高性能云硬盘，CLOUD_SSD-虚拟机SSD云硬盘,CLOUD_HSSD-虚拟机增强型SSD云硬盘，CLOUD_BSSD-虚拟机通用型SSD云盘</p>
    ...
    @property
    def Zone(self):
        r"""<p>实例可用区，类似ap-guangzhou-1（广州一区）；实例可售卖区域可以通过接口DescribeZones获取</p>
        :rtype: str
        """
        return self._Zone
    ...
    @property
    def SubnetId(self):
        r"""<p>VPC子网ID，形如subnet-bdoe83fa</p>
        :rtype: str
        """
    ...
    def MachineType(self):
        r"""<p>购买实例的宿主机类型，CLOUD_PREMIUM-虚拟机高性能云硬盘，CLOUD_SSD-虚拟机SSD云硬盘,CLOUD_HSSD-虚拟机增强型SSD云硬盘，CLOUD_BSSD-虚拟机通用型SSD云盘</p>
        :rtype: str
        """
    ...
    def InstanceChargeType(self):
        r"""<p>付费模式，取值支持 PREPAID（预付费），POSTPAID（后付费）。</p>
        :rtype: str
        """
    ...
    @property
    def DBVersion(self):
        r"""<p>sqlserver版本，目前所有支持的版本有：2008R2 (SQL Server 2008 R2 Enterprise)，2012SP3 (SQL Server 2012 Enterprise)，201202 (SQL Server 2012 Standard)，2014SP2 (SQL Server 2014 Enterprise)，201402 (SQL Server 2014 Standard)，2016SP1 (SQL Server 2016 Enterprise)，201602 (SQL Server 2016 Standard)，2017 (SQL Server 2017 Enterprise)，201702 (SQL Server 2017 Standard)，2019 (SQL Server 2019 Enterprise)，201902 (SQL Server 2019 Standard)。每个地域支持售卖的版本不同，可通过DescribeProductConfig接口来拉取每个地域可售卖的版本信息。不填，默认为版本2008R2。</p>
        :rtype: str
        """
    ...
    @property
    def Period(self):
        r"""<p>购买实例周期，默认取值为1，表示一个月。取值不超过48</p>
        :rtype: int
        """
        return self._Period
    ...
    def AutoRenewFlag(self):
        r"""<p>自动续费标志：0-正常续费  1-自动续费，默认为1自动续费。只在购买预付费实例时有效。</p>
        :rtype: int
        """
    ...
    @property
    def Weekly(self):
        r"""<p>可维护时间窗配置，以周为单位，表示周几允许维护，1-7分别代表周一到周末</p>
        :rtype: list of int
        """
        return self._Weekly
    ...
    @property
    def Collation(self):
        r"""<p>系统字符集排序规则，默认：Chinese_PRC_CI_AS</p>
        :rtype: str
        """
    ...
    @property
    def TimeZone(self):
        r"""<p>系统时区，默认：China Standard Time</p>
        :rtype: str
        """
    ...
    def ThroughputPerformance(self):
        r"""<p>额外磁盘 IO 吞吐量，仅 CLOUD_HSSD 支持</p><p>取值范围：[0, 650]</p><p>单位：MB/s</p>
        :rtype: int
        """
...
class CreateCloudDBInstancesRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        self._DiskEncryptFlag = None
        self._ThroughputPerformance = None
        self._AvailabilityStrategy = None
    ...
    @property
    def MachineType(self):
        r"""<p>购买实例的宿主机磁盘类型,CLOUD_HSSD-虚拟机加强型SSD云盘，CLOUD_TSSD-虚拟机极速型SSD云盘，CLOUD_BSSD-虚拟机通用型SSD云盘</p>
        :rtype: str
        """
        return self._MachineType
    ...
    @property
    def SubnetId(self):
        r"""<p>VPC子网ID，形如subnet-bdoe83fa；SubnetId和VpcId需同时设置或者同时不设置</p>
        :rtype: str
        """
        return self._SubnetId
    ...
    @property
    def VpcId(self):
        r"""<p>VPC网络ID，形如vpc-dsp338hz；SubnetId和VpcId需同时设置或者同时不设置</p>
        :rtype: str
        """
        return self._VpcId
    ...
    @property
    def MultiNodes(self):
        r"""<p>是否多节点架构实例，默认值为false。当MultiNodes = true时，参数MultiZones必须取值为true。</p>
        :rtype: bool
        """
    ...
    @property
    def DrZones(self):
        r"""<p>备节点可用区，默认为空。当MultiNodes = true时，主节点和备节点可用区不能全部相同。备机可用区集合最小为2个，最大不超过5个。</p>
        :rtype: list of str
        """
    ...
    @property
    def ThroughputPerformance(self):
        r"""<p>额外磁盘 IO 性能，仅 CLOUD_HSSD 支持</p><p>取值范围：[0, 650]</p><p>单位：MB/s</p>
        :rtype: int
        """
        return self._ThroughputPerformance
    ...
    @property
    def AvailabilityStrategy(self):
        r"""<p>可用性策略</p><p>枚举值：</p><ul><li>Async： 可用性优先（异步传输）</li><li>Sync： 可靠性优先（同步传输）</li></ul><p>默认值：Async</p><p>仅 AlwaysOn 双节点架构生效，单节点/多节点/MIRROR 架构忽略此参数</p>
        :rtype: str
        """
        return self._AvailabilityStrategy

    @AvailabilityStrategy.setter
    def AvailabilityStrategy(self, AvailabilityStrategy):
        self._AvailabilityStrategy = AvailabilityStrategy
    ...
    def _deserialize(self, params):
        ...
        self._DiskEncryptFlag = params.get("DiskEncryptFlag")
        self._ThroughputPerformance = params.get("ThroughputPerformance")
        self._AvailabilityStrategy = params.get("AvailabilityStrategy")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            property_name = name[1:]
            if property_name in memeber_set:
...
class CreateCloudReadOnlyDBInstancesRequest(AbstractModel):
    ...
    @property
    def InstanceId(self):
        r"""<p>主实例ID，格式如：mssql-3l3fgqn7</p>
        :rtype: str
        """
        return self._InstanceId
    ...
    def ReadOnlyGroupType(self):
        r"""<p>只读组类型选项，1-按照一个实例一个只读组的方式发货，2-新建只读组后发货，所有实例都在这个只读组下面， 3-发货的所有实例都在已有的只读组下面</p>
        :rtype: int
        """
    ...
    def ReadOnlyGroupForcedUpgrade(self):
        r"""<p>0-默认不升级主实例，1-强制升级主实例完成ro部署；主实例为非集群版时需要填1，强制升级为集群版。填1 说明您已同意将主实例升级到集群版实例。</p>
        :rtype: int
        """
    ...
    @property
    def ReadOnlyGroupId(self):
        r"""<p>ReadOnlyGroupType=3时必填,已存在的只读组ID</p>
        :rtype: str
        """
        return self._ReadOnlyGroupId
    ...
    def ReadOnlyGroupName(self):
        r"""<p>ReadOnlyGroupType=2时必填，新建的只读组名称</p>
        :rtype: str
        """
    ...
    def ReadOnlyGroupIsOfflineDelay(self):
        r"""<p>ReadOnlyGroupType=2时必填，新建的只读组是否开启延迟剔除功能，1-开启，0-关闭。当只读副本与主实例延迟大于阈值后，自动剔除。</p>
        :rtype: int
        """
    ...
    def ReadOnlyGroupMaxDelayTime(self):
        r"""<p>ReadOnlyGroupType=2 且 ReadOnlyGroupIsOfflineDelay=1时必填，新建的只读组延迟剔除的阈值。</p>
        :rtype: int
        """
    ...
    def ReadOnlyGroupMinInGroup(self):
        r"""<p>ReadOnlyGroupType=2 且 ReadOnlyGroupIsOfflineDelay=1时必填，新建的只读组延迟剔除后至少保留只读副本的个数。</p>
        :rtype: int
        """
...
class CreateDBInstancesRequest(AbstractModel):
    ...
    @property
    def HAType(self):
        r"""<p>购买高可用实例的类型：DUAL-双机高可用  CLUSTER-集群，默认值为DUAL</p>
        :rtype: str
        """
        return self._HAType
...
class CreateExportTaskRequest(AbstractModel):
    ...
    @property
    def LogType(self):
        r"""<p>日志类型：auditLog,slowLog,errLog</p>
        :rtype: str
        """
        return self._LogType
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def Status(self):
        r"""<p>实例状态。取值范围： <li>1：申请中</li> <li>2：运行中</li> <li>3：受限运行中 (主备切换中)</li> <li>4：已隔离</li> <li>5：回收中</li> <li>6：已回收</li> <li>7：任务执行中 (实例做备份、回档等操作)</li> <li>8：已下线</li> <li>9：实例扩容中</li> <li>10：实例迁移中</li> <li>11：只读</li> <li>12：重启中</li>  <li>13：实例修改中且待切换</li> <li>14：订阅发布创建中</li> <li>15：订阅发布修改中</li> <li>16：实例修改中且切换中</li> <li>17：创建RO副本中</li></p>
        :rtype: int
        """
        return self._Status
    ...
    @property
    def RenewFlag(self):
        r"""<p>实例续费标记，0-正常续费，1-自动续费，2-到期不续费</p>
        :rtype: int
        """
    ...
    @property
    def Model(self):
        r"""<p>实例高可用， 1-双机高可用，2-单机，3-跨可用区，4-集群跨可用区，5-集群，6-多节点集群，7-多节点集群跨可用区，9-自研机房</p>
        :rtype: int
        """
        return self._Model
    ...
    @property
    def Zone(self):
        r"""<p>实例所在可用区名称，如 ap-guangzhou-1</p>
        :rtype: str
        """
        return self._Zone
    ...
    @property
    def Type(self):
        r"""<p>实例类型代号：&quot;TS85&quot;-物理机，本地SSD硬盘；&quot;Z3&quot;-物理机早期版本，本地SSD硬盘；&quot;CLOUD_BASIC&quot;-虚拟机，普通云硬盘；&quot;CLOUD_PREMIUM&quot;-虚拟机，高性能云硬盘；&quot;CLOUD_SSD&quot;-虚拟机，云SSD硬盘；&quot;CLOUD_HSSD&quot;-虚拟机，增强型SSD云硬盘；&quot;CLOUD_TSSD&quot;-虚拟机，极速型SSD云硬盘；&quot;CLOUD_BSSD&quot;-虚拟机，通用型SSD云硬盘</p>
        :rtype: str
        """
        return self._Type
    ...
    @property
    def UniqVpcId(self):
        r"""<p>实例所属VPC的唯一字符串ID，格式如：vpc-xxx，基础网络时为空字符串</p>
        :rtype: str
        """
    ...
    def UniqSubnetId(self):
        r"""<p>实例所属子网的唯一字符串ID，格式如： subnet-xxx，基础网络时为空字符串</p>
        :rtype: str
        """
    ...
    @property
    def SubFlag(self):
        r"""<p>发布订阅标识，SUB-订阅实例，PUB-发布实例，空值-没有发布订阅的普通实例</p>
        :rtype: str
        """
    ...
    @property
    def ROFlag(self):
        r"""<p>只读标识，RO-只读实例，MASTER-有RO实例的主实例，空值-没有只读组的非RO实例</p>
        :rtype: str
        """
        return self._ROFlag
    ...
    @property
    def HAFlag(self):
        r"""<p>容灾类型，MIRROR-镜像，ALWAYSON-AlwaysOn, SINGLE-单例</p>
        :rtype: str
        """
        return self._HAFlag
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def BackupModel(self):
        r"""<p>备份模式，master_pkg-主节点打包备份(默认) ；master_no_pkg-主节点不打包备份；slave_pkg-从节点打包备份(always on集群有效)；slave_no_pkg-从节点不打包备份(always on集群有效)；只读副本对该值无效。</p>
        :rtype: str
        """
    ...
    def BackupCycleType(self):
        r"""<p>备份周期类型，[daily、weekly、monthly]</p>
        :rtype: str
        """
    ...
    def InstanceType(self):
        r"""<p>实例类型 HA-高可用，RO-只读实例，SI-基础版，BI-商业智能服务，cvmHA-云盘高可用，cvmRO-云盘只读实例，MultiHA-多节点，cvmMultiHA-云盘多节点</p>
        :rtype: str
        """
    ...
    @property
    def CrossRegions(self):
        r"""<p>跨地域备份目的地域，如果为空，则表示未开启跨地域备份</p>
        :rtype: list of str
        """
        return self._CrossRegions
    ...
    @property
    def CrossBackupEnabled(self):
        r"""<p>跨地域备份状态 enable-开启，disable-关闭</p>
        :rtype: str
        """
        return self._CrossBackupEnabled
    ...
    def Architecture(self):
        r"""<p>架构标识，SINGLE-单节点 DOUBLE-双节点</p>
        :rtype: str
        """
    ...
    @property
    def Style(self):
        r"""<p>类型标识，EXCLUSIVE-独享型，SHARED-共享型</p>
        :rtype: str
        """
        return self._Style
...
class DescribeLogInstanceListRequest(AbstractModel):
    ...
    @property
    def LogType(self):
        r"""<p>日志类型：auditLog,slowLog,errorLog</p>
        :rtype: str
        """
        return self._LogType
    ...
    @property
    def LogSwitch(self):
        r"""<p>日志开关,不传查询所有日志实例： on-开启，off-未开启。</p>
        :rtype: str
        """
...
class DescribeLogsResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _TotalCount: <p>日志总数</p>
        :type TotalCount: int
        :param _Items: <p>日志详情，根据产品的不同返回的字段有差异</p>
注意：此字段可能返回 null，表示取不到有效值。
...
class DescribeUpgradeInstanceCheckRequest(AbstractModel):
    ...
    @property
    def InstanceId(self):
        r"""<p>数据库实例ID，形如mssql-njj2mtpl</p>
        :rtype: str
        """
        return self._InstanceId
    ...
    @property
    def HAType(self):
        r"""<p>实例变配后的类型，可选值：CLUSTER-集群，不填则不修改</p>
        :rtype: str
        """
        return self._HAType
    ...
    @property
    def MultiZones(self):
        r"""<p>实例变配后的跨可用区类型，可选值： SameZones-修改为同可用区 MultiZones-修改为跨可用区，不填则不修改</p>
        :rtype: str
        """
        return self._MultiZones
    ...
    @property
    def DrZones(self):
        r"""<p>多节点架构实例的备节点可用区，默认为空。如果需要在变配的同时修改指定备节点的可用区时必传，当MultiZones = MultiZones时主节点和备节点可用区不能全部相同。备机可用区集合最小为2个，最大不超过5个。</p>
    ...
    @property
    def ThroughputPerformance(self):
        r"""<p>额外磁盘IO吞吐量</p><p>取值范围：[0, 650]</p><p>单位：MB/s</p><p>不传-保持原值不变；0-取消额外IO；&gt;0-设为新值</p>
        :rtype: int
        """
        return self._ThroughputPerformance
...
class DescribeUpgradeInstanceCheckResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _IsAffect: <p>本变配是否对实例有影响，0-没有影响 1-有影响</p>
        :type IsAffect: int
        :param _Passed: <p>本变配是否可以执行 0-不通过，不能变配 1-通过，可以变配</p>
        :type Passed: int
        :param _ModifyMode: <p>本变配是升配还是降配，down-降配 up-升配</p>
        :type ModifyMode: str
        :param _CheckItems: <p>检查项列表</p>
    ...
    @property
    def IsAffect(self):
        r"""<p>本变配是否对实例有影响，0-没有影响 1-有影响</p>
        :rtype: int
        """
        return self._IsAffect
    ...
    @property
    def Passed(self):
        r"""<p>本变配是否可以执行 0-不通过，不能变配 1-通过，可以变配</p>
        :rtype: int
        """
        return self._Passed
    ...
    @property
    def ModifyMode(self):
        r"""<p>本变配是升配还是降配，down-降配 up-升配</p>
        :rtype: str
        """
...
class InquiryPriceCreateDBInstancesRequest(AbstractModel):
    ...
    @property
    def Zone(self):
        r"""<p>可用区ID。该参数可以通过调用 DescribeZones 接口的返回值中的Zone字段来获取。</p>
        :rtype: str
        """
        return self._Zone
    ...
    @property
    def InstanceChargeType(self):
        r"""<p>计费类型，取值支持 PREPAID，POSTPAID。</p>
        :rtype: str
        """
        return self._InstanceChargeType
    ...
    @property
    def GoodsNum(self):
        r"""<p>一次性购买的实例数量。取值1-100，默认取值为1</p>
        :rtype: int
        """
        return self._GoodsNum
    ...
    @property
    def InstanceType(self):
        r"""<p>购买实例的类型 HA-高可用型(包括双机高可用，alwaysOn集群)，RO-只读副本型，SI-单节点型,cvmHA-虚拟机双机高可用,cvmRO-虚拟机只读，MultiHA-多节点，cvmMultiHA-云盘</p>
        :rtype: str
        """
        return self._InstanceType
    ...
    @property
    def MachineType(self):
        r"""<p>购买实例的宿主机类型，PM-物理机, CLOUD_PREMIUM-虚拟机高性能云盘，CLOUD_SSD-虚拟机SSD云盘,<br>CLOUD_HSSD-虚拟机加强型SSD云盘，CLOUD_TSSD-虚拟机极速型SSD云盘，CLOUD_BSSD-虚拟机通用型SSD云盘</p>
        :rtype: str
        """
        return self._MachineType
    ...
    @property
    def DrZones(self):
        r"""<p>备节点可用区，默认为空。如果是多节点架构时必传，并且备机可用区集合最小为2个，最大不超过5个。</p>
        :rtype: list of str
        """
        return self._DrZones
...
class InquiryPriceCreateDBInstancesResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _OriginalPrice: <p>未打折前价格，其值除以100表示最终的价格。<br>InstanceChargeType=PREPAID时，单位是&quot;每月&quot;。<br>InstanceChargeType=POSTPAID时，单位是&quot;每小时&quot;。<br>例如10010，在InstanceChargeType=PREPAID情况下，表示每月100.10元。</p>
        :type OriginalPrice: int
        :param _Price: <p>实际需要支付的价格，其值除以100表示最终的价格。<br>InstanceChargeType=PREPAID时，单位是&quot;每月&quot;。<br>InstanceChargeType=POSTPAID时，单位是&quot;每小时&quot;。<br>例如10010，在InstanceChargeType=PREPAID情况下，表示每月100.10元。</p>
        :type Price: int
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
    ...
    def OriginalPrice(self):
        r"""<p>未打折前价格，其值除以100表示最终的价格。<br>InstanceChargeType=PREPAID时，单位是&quot;每月&quot;。<br>InstanceChargeType=POSTPAID时，单位是&quot;每小时&quot;。<br>例如10010，在InstanceChargeType=PREPAID情况下，表示每月100.10元。</p>
        :rtype: int
        """
    ...
    @property
    def Price(self):
        r"""<p>实际需要支付的价格，其值除以100表示最终的价格。<br>InstanceChargeType=PREPAID时，单位是&quot;每月&quot;。<br>InstanceChargeType=POSTPAID时，单位是&quot;每小时&quot;。<br>例如10010，在InstanceChargeType=PREPAID情况下，表示每月100.10元。</p>
        :rtype: int
        """
        return self._Price
...
class InquiryPriceUpgradeDBInstanceRequest(AbstractModel):
    ...
    @property
    def Memory(self):
        r"""<p>实例升级后的内存大小，单位GB，其值不能比当前实例内存小</p>
        :rtype: int
        """
        return self._Memory
    ...
    @property
    def Storage(self):
        r"""<p>实例升级后的磁盘大小，单位GB，其值不能比当前实例磁盘小</p>
        :rtype: int
        """
        return self._Storage
    ...
    @property
    def Cpu(self):
        r"""<p>实例升级后的CPU核心数，其值不能比当前实例CPU小</p>
        :rtype: int
        """
        return self._Cpu
    ...
    @property
    def ThroughputPerformance(self):
        r"""<p>额外磁盘 IO 吞吐量</p><p>取值范围：[0, 650]</p><p>单位：MB/s</p>
        :rtype: int
        """
        return self._ThroughputPerformance
...
class InquiryPriceUpgradeDBInstanceResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _OriginalPrice: <p>未打折的原价，其值除以100表示最终的价格。例如10094表示100.94元</p>
        :type OriginalPrice: int
        :param _Price: <p>实际需要支付价格，其值除以100表示最终的价格。例如10094表示100.94元</p>
        :type Price: int
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
    ...
    @property
    def OriginalPrice(self):
        r"""<p>未打折的原价，其值除以100表示最终的价格。例如10094表示100.94元</p>
        :rtype: int
        """
        return self._OriginalPrice
    ...
    @property
    def Price(self):
        r"""<p>实际需要支付价格，其值除以100表示最终的价格。例如10094表示100.94元</p>
        :rtype: int
        """
        return self._Price
...
注意：此字段可能返回 null，表示取不到有效值。
        :type AuditLogStatus: str
        :param _AuditLogHosts: <p>审计日志上报地址</p>
注意：此字段可能返回 null，表示取不到有效值。
        :type AuditLogHosts: list of str
        :param _AuditLogStatusMessage: <p>审计日志状态信息</p>
注意：此字段可能返回 null，表示取不到有效值。
        :type AuditLogStatusMessage: str
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        self._InstanceType = None
        self._Type = None
        self._AuditLogStatus = None
        self._AuditLogHosts = None
        self._AuditLogStatusMessage = None
        self._Version = None
        self._VersionName = None
        self._RegionId = None
        self._ZoneId = None
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def AuditLogStatus(self):
        r"""<p>审计日志状态 ON, OFF, ERROR</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._AuditLogStatus

    @AuditLogStatus.setter
    def AuditLogStatus(self, AuditLogStatus):
        self._AuditLogStatus = AuditLogStatus

    @property
    def AuditLogHosts(self):
        r"""<p>审计日志上报地址</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: list of str
        """
        return self._AuditLogHosts

    @AuditLogHosts.setter
    def AuditLogHosts(self, AuditLogHosts):
        self._AuditLogHosts = AuditLogHosts

    @property
    def AuditLogStatusMessage(self):
        r"""<p>审计日志状态信息</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._AuditLogStatusMessage

    @AuditLogStatusMessage.setter
    def AuditLogStatusMessage(self, AuditLogStatusMessage):
        self._AuditLogStatusMessage = AuditLogStatusMessage
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def _deserialize(self, params):
        ...
        self._InstanceType = params.get("InstanceType")
        self._Type = params.get("Type")
        self._AuditLogStatus = params.get("AuditLogStatus")
        self._AuditLogHosts = params.get("AuditLogHosts")
        self._AuditLogStatusMessage = params.get("AuditLogStatusMessage")
        self._Version = params.get("Version")
        self._VersionName = params.get("VersionName")
        self._RegionId = params.get("RegionId")
        self._ZoneId = params.get("ZoneId")
...
RA – 范围；
    ...
    @property
    def Value(self):
        r"""过滤条件匹配值。当Compare=RG时，例：["1-100","200-300"]
        :rtype: list of str
        """
        return self._Value
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        :type InstanceInfo: :class:`tencentcloud.sqlserver.v20180328.models.InstanceInfo`
        """
        self._InstanceId = None
        self._Status = None
    ...
    @property
    def Status(self):
        r"""日志状态，create：创建中；normal：开启；close：关闭中。
        :rtype: str
        """
        return self._Status
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def InstanceInfo(self):
        r"""业务侧实例相关信息，根据业务不同，返回相关信息不同。
        :rtype: :class:`tencentcloud.sqlserver.v20180328.models.InstanceInfo`
        """
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        self._Timestamp = None
        self._Category = None
        self._ClientAppName = None
        self._ClientHostName = None
        self._CpuTime = None
        self._DatabaseId = None
        self._DatabaseName = None
        self._Duration = None
        self._ErrorNumber = None
        self._IsIntercepted = None
        self._LastRowCount = None
        self._LogicalReads = None
        self._Message = None
        self._ObjectId = None
        self._ObjectName = None
        self._ObjectType = None
        self._OutputParameters = None
        self._ParameterizedPlanHandle = None
        self._PhysicalReads = None
        self._Result = None
        self._RowCount = None
        self._ServerPrincipalName = None
        self._SessionServerPrincipalName = None
        self._Severity = None
        self._SourceDatabaseId = None
        self._SqlText = None
        self._State = None
        self._Statement = None
        self._SystemThreadId = None
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @ClientAppName.setter
    def ClientAppName(self, ClientAppName):
        self._ClientAppName = ClientAppName
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._ClientHostName

    @ClientHostName.setter
    def ClientHostName(self, ClientHostName):
        self._ClientHostName = ClientHostName
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @ErrorNumber.setter
    def ErrorNumber(self, ErrorNumber):
        self._ErrorNumber = ErrorNumber
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._IsIntercepted

    @IsIntercepted.setter
    def IsIntercepted(self, IsIntercepted):
        self._IsIntercepted = IsIntercepted
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @LastRowCount.setter
    def LastRowCount(self, LastRowCount):
        self._LastRowCount = LastRowCount
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._LogicalReads

    @LogicalReads.setter
    def LogicalReads(self, LogicalReads):
        self._LogicalReads = LogicalReads
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._OutputParameters

    @OutputParameters.setter
    def OutputParameters(self, OutputParameters):
        self._OutputParameters = OutputParameters
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._ParameterizedPlanHandle

    @ParameterizedPlanHandle.setter
    def ParameterizedPlanHandle(self, ParameterizedPlanHandle):
        self._ParameterizedPlanHandle = ParameterizedPlanHandle
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._PhysicalReads

    @PhysicalReads.setter
    def PhysicalReads(self, PhysicalReads):
        self._PhysicalReads = PhysicalReads
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._ServerPrincipalName

    @ServerPrincipalName.setter
    def ServerPrincipalName(self, ServerPrincipalName):
        self._ServerPrincipalName = ServerPrincipalName
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._SessionServerPrincipalName

    @SessionServerPrincipalName.setter
    def SessionServerPrincipalName(self, SessionServerPrincipalName):
        self._SessionServerPrincipalName = SessionServerPrincipalName
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._SourceDatabaseId

    @SourceDatabaseId.setter
    def SourceDatabaseId(self, SourceDatabaseId):
        self._SourceDatabaseId = SourceDatabaseId
...
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: int
        """
        return self._SystemThreadId

    @SystemThreadId.setter
    def SystemThreadId(self, SystemThreadId):
        self._SystemThreadId = SystemThreadId
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def _deserialize(self, params):
        ...
        self._ClientAppName = params.get("ClientAppName")
        self._ClientHostName = params.get("ClientHostName")
        self._CpuTime = params.get("CpuTime")
        self._DatabaseId = params.get("DatabaseId")
        self._DatabaseName = params.get("DatabaseName")
        self._Duration = params.get("Duration")
        self._ErrorNumber = params.get("ErrorNumber")
        self._IsIntercepted = params.get("IsIntercepted")
        self._LastRowCount = params.get("LastRowCount")
        self._LogicalReads = params.get("LogicalReads")
        self._Message = params.get("Message")
        self._ObjectId = params.get("ObjectId")
        self._ObjectName = params.get("ObjectName")
        self._ObjectType = params.get("ObjectType")
        self._OutputParameters = params.get("OutputParameters")
        self._ParameterizedPlanHandle = params.get("ParameterizedPlanHandle")
        self._PhysicalReads = params.get("PhysicalReads")
        self._Result = params.get("Result")
        self._RowCount = params.get("RowCount")
        self._ServerPrincipalName = params.get("ServerPrincipalName")
        self._SessionServerPrincipalName = params.get("SessionServerPrincipalName")
        self._Severity = params.get("Severity")
        self._SourceDatabaseId = params.get("SourceDatabaseId")
        self._SqlText = params.get("SqlText")
        self._State = params.get("State")
        self._Statement = params.get("Statement")
        self._SystemThreadId = params.get("SystemThreadId")
...
class ModifyLogRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type LogType: str
        :param _LogExpireDay: <p>日志有效期, 单位：天。</p><p>枚举值：</p><ul><li>7： 7天</li><li>30： 30天</li><li>90： 90天</li><li>180： 180天</li><li>365： 365天</li><li>1095： 1095天</li><li>1825： 1825天</li></ul>
        :type LogExpireDay: int
        :param _HighLogExpireDay: <p>高频日志有效期, 单位：天。</p><p>枚举值：</p><ul><li>7： 7天</li></ul>
        :type HighLogExpireDay: int
        """
        self._InstanceId = None
        self._LogType = None
    ...
    @property
    def LogExpireDay(self):
        r"""<p>日志有效期, 单位：天。</p><p>枚举值：</p><ul><li>7： 7天</li><li>30： 30天</li><li>90： 90天</li><li>180： 180天</li><li>365： 365天</li><li>1095： 1095天</li><li>1825： 1825天</li></ul>
        :rtype: int
        """
        return self._LogExpireDay
    ...
    @property
    def HighLogExpireDay(self):
        r"""<p>高频日志有效期, 单位：天。</p><p>枚举值：</p><ul><li>7： 7天</li></ul>
        :rtype: int
        """
        return self._HighLogExpireDay
...
class SpecInfo(AbstractModel):
    ...
    def __init__(self):
        ...
        self._MinBaselineIOPS = None
        self._MaxBaselineIOPS = None
        self._MinBaselineThroughput = None
        self._MaxBaselineThroughput = None
        self._ExtraIOSupported = None
        self._MaxExtraThroughput = None
        self._MinDiskSizeForExtraIO = None

    @property
    def SpecId(self):
        r"""<p>实例规格ID，利用DescribeZones返回的SpecId，结合DescribeProductConfig返回的可售卖规格信息，可获悉某个可用区下可购买什么规格的实例</p>
        :rtype: int
        """
        return self._SpecId
    ...
    @property
    def Version(self):
        r"""<p>数据库版本信息。取值为2008R2（表示SQL Server 2008 R2），2012SP3（表示SQL Server 2012），2016SP1（表示SQL Server 2016 SP1）</p>
        :rtype: str
        """
        return self._Version
    ...
    def PayModeStatus(self):
        r"""<p>此规格下支持的付费模式，POST-仅支持按量计费 PRE-仅支持包年包月 ALL-支持所有</p>
        :rtype: str
        """
    ...
    @property
    def InstanceType(self):
        r"""<p>购买实例的类型 HA-本地盘高可用(包括双机高可用，alwaysOn集群)，RO-本地盘只读副本，SI-云盘版单节点,BI-商业智能服务，cvmHA-云盘版高可用，cvmRO-云盘版只读副本，MultiHA-多节点，cvmMultiHA-云盘多节点<br>示例值：HA</p>
        :rtype: str
        """
        return self._InstanceType
    ...
    def MultiZonesStatus(self):
        r"""<p>跨可用区类型，MultiZones-只支持跨可用区，SameZones-只支持同可用区，ALL-支持所有</p>
        :rtype: str
        """
    ...
    @property
    def MinBaselineIOPS(self):
        r"""<p>最小磁盘容量时的基准</p><p>单位：IOPS</p>
        :rtype: int
        """
        return self._MinBaselineIOPS

    @MinBaselineIOPS.setter
    def MinBaselineIOPS(self, MinBaselineIOPS):
        self._MinBaselineIOPS = MinBaselineIOPS

    @property
    def MaxBaselineIOPS(self):
        r"""<p>最大磁盘容量时的基准</p><p>单位：IOPS</p>
        :rtype: int
        """
        return self._MaxBaselineIOPS

    @MaxBaselineIOPS.setter
    def MaxBaselineIOPS(self, MaxBaselineIOPS):
        self._MaxBaselineIOPS = MaxBaselineIOPS

    @property
    def MinBaselineThroughput(self):
        r"""<p>最小磁盘容量时的基准吞吐量</p><p>单位：MB/s</p>
        :rtype: int
        """
        return self._MinBaselineThroughput

    @MinBaselineThroughput.setter
    def MinBaselineThroughput(self, MinBaselineThroughput):
        self._MinBaselineThroughput = MinBaselineThroughput

    @property
    def MaxBaselineThroughput(self):
        r"""<p>最大磁盘容量时的基准吞吐量</p><p>单位：MB/s</p>
        :rtype: int
        """
        return self._MaxBaselineThroughput

    @MaxBaselineThroughput.setter
    def MaxBaselineThroughput(self, MaxBaselineThroughput):
        self._MaxBaselineThroughput = MaxBaselineThroughput

    @property
    def ExtraIOSupported(self):
        r"""<p>是否支持额外 IO 性能</p><p>枚举值：</p><ul><li>TRUE： 支持额外 IO 性能</li><li>FALSE： 不支持额外 IO 性能</li></ul>
        :rtype: bool
        """
        return self._ExtraIOSupported

    @ExtraIOSupported.setter
    def ExtraIOSupported(self, ExtraIOSupported):
        self._ExtraIOSupported = ExtraIOSupported

    @property
    def MaxExtraThroughput(self):
        r"""<p>额外 IO 最大吞吐量</p><p>单位：MB/s</p>
        :rtype: int
        """
        return self._MaxExtraThroughput

    @MaxExtraThroughput.setter
    def MaxExtraThroughput(self, MaxExtraThroughput):
        self._MaxExtraThroughput = MaxExtraThroughput

    @property
    def MinDiskSizeForExtraIO(self):
        r"""<p>支持额外 IO 的最小磁盘容量</p><p>单位： GB</p><p>默认值：460</p>
        :rtype: int
        """
        return self._MinDiskSizeForExtraIO

    @MinDiskSizeForExtraIO.setter
    def MinDiskSizeForExtraIO(self, MinDiskSizeForExtraIO):
        self._MinDiskSizeForExtraIO = MinDiskSizeForExtraIO
    ...
    def _deserialize(self, params):
        ...
        self._MinBaselineIOPS = params.get("MinBaselineIOPS")
        self._MaxBaselineIOPS = params.get("MaxBaselineIOPS")
        self._MinBaselineThroughput = params.get("MinBaselineThroughput")
        self._MaxBaselineThroughput = params.get("MaxBaselineThroughput")
        self._ExtraIOSupported = params.get("ExtraIOSupported")
        self._MaxExtraThroughput = params.get("MaxExtraThroughput")
        self._MinDiskSizeForExtraIO = params.get("MinDiskSizeForExtraIO")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            property_name = name[1:]
            if property_name in memeber_set:
...
class SpecSellStatus(AbstractModel):
    ...
    @property
    def InstanceType(self):
        r"""<p>产品类型，购买实例的类型 HA-本地盘高可用(包括双机高可用，alwaysOn集群)，RO-本地盘只读副本，SI-云盘版单节点,BI-商业智能服务，cvmHA-云盘版高可用，cvmRO-云盘版只读副本，MultiHA-多节点，cvmMultiHA-云盘多节点</p>
        :rtype: str
        """
        return self._InstanceType
    ...
    @property
    def MultiZonesStatus(self):
        r"""<p>该规格支持的是否跨可用去，MultiZones-只支持跨可用区，SameZones-只支持同可用区，ALL-支持所有</p>
        :rtype: str
        """
        return self._MultiZonesStatus
    ...
    @property
    def Architecture(self):
        r"""<p>架构标识，SINGLE-单节点 DOUBLE-双节点 TRIPLE-三节点 MULTI-多节点<br>示例值：SINGLE</p>
        :rtype: str
        """
        return self._Architecture
    ...
    @property
    def Status(self):
        r"""<p>规格售卖状态 1-正常 2-关闭售卖但是可以升级 3-完全关闭售卖</p>
        :rtype: int
        """
        return self._Status
...
class UpgradeDBInstanceRequest(AbstractModel):
    ...
    @property
    def Memory(self):
        r"""<p>实例升级后内存大小，单位GB，其值不能小于当前实例内存大小</p>
        :rtype: int
        """
        return self._Memory
    ...
    @property
    def Storage(self):
        r"""<p>实例升级后磁盘大小，单位GB，其值不能小于当前实例磁盘大小</p>
        :rtype: int
        """
        return self._Storage
    ...
    @property
    def AutoVoucher(self):
        r"""<p>是否自动使用代金券，0 - 不使用；1 - 默认使用。取值默认为0</p>
        :rtype: int
        """
        return self._AutoVoucher
    ...
    @property
    def DBVersion(self):
        r"""<p>升级sqlserver的版本，目前支持：2008R2（SQL Server 2008 Enterprise），2012SP3（SQL Server 2012 Enterprise）版本等。每个地域支持售卖的版本不同，可通过DescribeProductConfig接口来拉取每个地域可售卖的版本信息，版本不支持降级，不填则不修改版本</p>
        :rtype: str
        """
        return self._DBVersion
    ...
    @property
    def HAType(self):
        r"""<p>升级sqlserver的高可用架构,从镜像容灾升级到always on集群容灾，仅支持2017及以上版本且支持always on高可用的实例，不支持降级到镜像方式容灾，CLUSTER-升级为always on容灾，不填则不修改高可用架构</p>
        :rtype: str
        """
        return self._HAType
    ...
    @property
    def MultiZones(self):
        r"""<p>修改实例是否为跨可用区容灾，SameZones-修改为同可用区 MultiZones-修改为跨可用区</p>
        :rtype: str
        """
        return self._MultiZones
    ...
    @property
    def WaitSwitch(self):
        r"""<p>执行变配的方式，默认为 1。支持值包括：0 - 立刻执行，1 - 维护时间窗执行</p>
        :rtype: int
        """
        return self._WaitSwitch
    ...
    def UpgradeCompatLevel(self):
        r"""<p>是否自动升级数据库的兼容性级别，默认0。0-否，1-是</p>
        :rtype: int
        """
