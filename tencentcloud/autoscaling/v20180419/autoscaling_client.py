...
class AutoscalingClient(AbstractClient):
    ...
    def AttachInstances(self, request):
        r"""本接口（AttachInstances）用于将 CVM 实例添加到伸缩组。
    ...
    def AttachLoadBalancers(self, request):
        r"""此接口（AttachLoadBalancers）用于将负载均衡器添加到伸缩组。
    ...
    def ClearLaunchConfigurationAttributes(self, request):
        r"""本接口（ClearLaunchConfigurationAttributes）用于将启动配置内的特定属性完全清空。
    ...
    def CompleteLifecycleAction(self, request):
        r"""本接口（CompleteLifecycleAction）用于完成生命周期动作。
    ...
    def CreateAutoScalingGroup(self, request):
        r"""本接口（CreateAutoScalingGroup）用于创建伸缩组
    ...
    def CreateAutoScalingGroupFromInstance(self, request):
        r"""本接口（CreateAutoScalingGroupFromInstance）用于根据实例创建启动配置及伸缩组。
    ...
    def CreateLaunchConfiguration(self, request):
        r"""本接口（CreateLaunchConfiguration）用于创建新的启动配置。
    ...
    def CreateLifecycleHook(self, request):
        r"""本接口（CreateLifecycleHook）用于创建生命周期挂钩。
    ...
    def CreateNotificationConfiguration(self, request):
        r"""本接口（CreateNotificationConfiguration）用于创建通知。
    ...
    def CreateScheduledAction(self, request):
        r"""本接口（CreateScheduledAction）用于创建定时任务。
    ...
    def DeleteAutoScalingGroup(self, request):
        r"""本接口（DeleteAutoScalingGroup）用于删除指定伸缩组，删除前提是伸缩组内无运行中（IN_SERVICE）状态的实例且当前未在执行伸缩活动。删除伸缩组后，创建失败（CREATION_FAILED）、中止失败（TERMINATION_FAILED）、解绑失败（DETACH_FAILED）等非运行中状态的实例不会被销毁。
    ...
    def DeleteLaunchConfiguration(self, request):
        r"""本接口（DeleteLaunchConfiguration）用于删除启动配置。
    ...
    def DeleteLifecycleHook(self, request):
        r"""本接口（DeleteLifecycleHook）用于删除生命周期挂钩。
    ...
    def DeleteNotificationConfiguration(self, request):
        r"""本接口（DeleteNotificationConfiguration）用于删除特定的通知。
    ...
    def DeleteScalingPolicy(self, request):
        r"""本接口（DeleteScalingPolicy）用于删除告警触发策略。
    ...
    def DeleteScheduledAction(self, request):
        r"""本接口（DeleteScheduledAction）用于删除特定的定时任务。
    ...
    def DescribeAccountLimits(self, request):
        r"""本接口（DescribeAccountLimits）用于查询用户账户在弹性伸缩中的资源限制。
    ...
    def DescribeAutoScalingActivities(self, request):
        r"""本接口（DescribeAutoScalingActivities）用于查询伸缩组的伸缩活动记录。当前仅保存近两年的伸缩活动。
    ...
    def DescribeAutoScalingGroupLastActivities(self, request):
        r"""本接口（DescribeAutoScalingGroupLastActivities）用于查询伸缩组的最新一次伸缩活动记录。
    ...
    def DescribeAutoScalingGroups(self, request):
        r"""本接口（DescribeAutoScalingGroups）用于查询伸缩组信息。
    ...
    def DescribeAutoScalingInstances(self, request):
        r"""本接口（DescribeAutoScalingInstances）用于查询弹性伸缩关联实例的信息。
    ...
    def DescribeLaunchConfigurations(self, request):
        r"""本接口（DescribeLaunchConfigurations）用于查询启动配置的信息。
    ...
    def DescribeLifecycleHooks(self, request):
        r"""本接口（DescribeLifecycleHooks）用于查询生命周期挂钩信息。
    ...
    def DescribeNotificationConfigurations(self, request):
        r"""本接口 (DescribeNotificationConfigurations) 用于查询一个或多个通知的详细信息。
    ...
    def DescribeRefreshActivities(self, request):
        r"""本接口（DescribeRefreshActivities）用于查询伸缩组的实例刷新活动记录。
    ...
    def DescribeScalingPolicies(self, request):
        r"""本接口（DescribeScalingPolicies）用于查询告警触发策略。
    ...
    def DescribeScheduledActions(self, request):
        r"""本接口 (DescribeScheduledActions) 用于查询一个或多个定时任务的详细信息。
    ...
    def DetachInstances(self, request):
        r"""本接口（DetachInstances）用于从伸缩组移出 CVM 实例，本接口不会销毁实例。
    ...
    def DetachLoadBalancers(self, request):
        r"""本接口（DetachLoadBalancers）用于从伸缩组移出负载均衡器，本接口不会销毁负载均衡器。
    ...
    def DisableAutoScalingGroup(self, request):
        r"""本接口（DisableAutoScalingGroup）用于停用指定伸缩组。
    ...
    def EnableAutoScalingGroup(self, request):
        r"""本接口（EnableAutoScalingGroup）用于启用指定伸缩组。
    ...
    def ExecuteScalingPolicy(self, request):
        r"""本接口（ExecuteScalingPolicy）用于执行伸缩策略。
    ...
    def ModifyAutoScalingGroup(self, request):
        r"""本接口（ModifyAutoScalingGroup）用于修改伸缩组。
    ...
    def ModifyDesiredCapacity(self, request):
        r"""本接口（ModifyDesiredCapacity）用于修改指定伸缩组的期望实例数
    ...
    def ModifyLaunchConfigurationAttributes(self, request):
        r"""本接口（ModifyLaunchConfigurationAttributes）用于修改启动配置部分属性。
    ...
    def ModifyLoadBalancerTargetAttributes(self, request):
        r"""本接口（ModifyLoadBalancerTargetAttributes）用于修改伸缩组内负载均衡器的目标规则属性。
    ...
    def ModifyLoadBalancers(self, request):
        r"""本接口（ModifyLoadBalancers）用于修改伸缩组的负载均衡器。
    ...
    def ModifyNotificationConfiguration(self, request):
        r"""本接口（ModifyNotificationConfiguration）用于修改通知。
        * 通知的接收端类型不支持修改。
    ...
    def ModifyScalingPolicy(self, request):
        r"""本接口（ModifyScalingPolicy）用于修改告警触发策略。
    ...
    def ModifyScheduledAction(self, request):
        r"""本接口（ModifyScheduledAction）用于修改定时任务。
    ...
    def RemoveInstances(self, request):
        r"""本接口（RemoveInstances）用于从伸缩组删除 CVM 实例。根据当前的产品逻辑，如果实例由弹性伸缩自动创建，则实例会被销毁；如果实例系创建后加入伸缩组的，则会从伸缩组中移除，保留实例。
    ...
    def ResumeInstanceRefresh(self, request):
        r"""恢复暂停状态的实例刷新活动，使其重试当前批次刷新失败实例或继续刷新后续批次，非暂停状态下调用该接口无效。
    ...
    def RollbackInstanceRefresh(self, request):
        r"""回滚操作会生成一个新的实例刷新活动，该活动也支持分批次刷新以及暂停、恢复、取消操作，接口返回回滚活动的 RefreshActivityId。
    ...
    def ScaleInInstances(self, request):
        r"""为伸缩组指定数量缩容实例，返回缩容活动的 ActivityId。
        * 伸缩组需要未处于活动中
    ...
    def ScaleOutInstances(self, request):
        r"""为伸缩组指定数量扩容实例，返回扩容活动的 ActivityId。
        * 伸缩组需要未处于活动中
        * 伸缩组处于停用状态时，该接口也会生效，可参考[停用伸缩组](https://cloud.tencent.com/document/api/377/20435)文档查看伸缩组停用状态的影响范围
    ...
    def StartAutoScalingInstances(self, request):
        r"""本接口（StartAutoScalingInstances）用于开启伸缩组内 CVM 实例。
    ...
    def StartInstanceRefresh(self, request):
        r"""根据启动配置中参数，刷新伸缩组内运行中状态 CVM 实例，返回实例刷新活动的 RefreshActivityId。
    ...
    def StopAutoScalingInstances(self, request):
        r"""本接口（StopAutoScalingInstances）用于关闭伸缩组内 CVM 实例。
    ...
    def UpgradeLaunchConfiguration(self, request):
        r"""已有替代接口ModifyLaunchConfiguration。该接口存在覆盖参数风险，目前官网已隐藏
    ...
    def UpgradeLifecycleHook(self, request):
        r"""本接口（UpgradeLifecycleHook）用于升级生命周期挂钩。
