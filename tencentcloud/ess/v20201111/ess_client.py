...
class EssClient(AbstractClient):
    ...
    def CancelOrganizationFlows(self, request):
        ...
        :type request: :class:`tencentcloud.ess.v20201111.models.CancelOrganizationFlowsRequest`
        :rtype: :class:`tencentcloud.ess.v20201111.models.CancelOrganizationFlowsResponse`
    ...
    def CancelUserAutoSignEnableUrl(self, request):
        r"""用来撤销<a href="https://qian.tencent.com/developers/companyApis/users/CreateUserAutoSignEnableUrl" target="_blank">获取个人用户“授权签”的开通状态</a>生成的开通链接，撤销生成的链接失效。
    ...
    def CreateDocument(self, request):
        r"""本接口用于基于**模板**创建合同的电子文档，并填充模板中由发起方补充的信息（归属发起方填写控件）。
    ...
    def CreateExtendedServiceAuthInfos(self, request):
        r"""创建企业扩展服务授权，当前仅支持授权 “企业“授权签”” 和 “批量签署” 给企业员工。
    ...
    def CreateFileConvertTask(self, request):
        ...
        :type request: :class:`tencentcloud.ess.v20201111.models.CreateFileConvertTaskRequest`
        :rtype: :class:`tencentcloud.ess.v20201111.models.CreateFileConvertTaskResponse`
    ...
    def CreateFlowReminds(self, request):
        r"""指定需要批量催办的签署流程ID，批量催办合同，最多100个
        ##### 需要符合以下条件的合同才可被催办：
        <ol>
    ...
    def CreateRequestWithEncryption(self, request):
        ...
        **SM4-CBC 示例**
        ...
        :type request: :class:`tencentcloud.ess.v20201111.models.CreateRequestWithEncryptionRequest`
        :rtype: :class:`tencentcloud.ess.v20201111.models.CreateRequestWithEncryptionResponse`
    ...
    def CreateSchemeUrl(self, request):
        r"""本接口（CreateSchemeUrl）用于获取跳转至腾讯电子签小程序的签署链接，签署人点击链接后即可跳转到腾讯电子签小程序完成合同的查看、填写与签署等操作。
    ...
    def DeleteExtendedServiceAuthInfos(self, request):
        r"""删除企业扩展服务授权，当前仅支持 “企业“授权签”” 和“批量签署”  的取消授权。
    ...
    def DescribeFileConvertTask(self, request):
        r"""此接口（DescribeFileConvertTask）用来查询转换任务的状态。如需发起转换任务，请使用<a href="https://qian.tencent.com/developers/companyApis/templatesAndFiles/CreateFileConvertTask" target="_blank">创建文件转换任务接口</a>进行资源文件的转换操作<br />
        ...
        :type request: :class:`tencentcloud.ess.v20201111.models.DescribeFileConvertTaskRequest`
        :rtype: :class:`tencentcloud.ess.v20201111.models.DescribeFileConvertTaskResponse`
    ...
    def DescribePersonCertificate(self, request):
        r"""此接口（DescribePersonCertificate）用于查询个人数字证书信息。<br />注：`1.目前仅用于查询开通了医疗“授权签”功能的个人数字证书。`<br />`2.调用此接口需要开通白名单，使用前请联系相关人员开通白名单。`
    ...
    def ModifyPartnerAutoSignAuthUrl(self, request):
        r"""创建一个用于更新他方“授权签”授权的链接（可选择他方授权或我方授权）。通过这个链接，合作方企业可以直接进入小程序，进行“授权签”授权的更新（更新印章）操作。
