...
class CallBackAck(AbstractModel):
    """回调ACK
    ...
    def __init__(self):
        ...
        :type StdRetMsg: str
        """
        self.StdRetCode = None
        self.StdRetMsg = None


    def _deserialize(self, params):
        self.StdRetCode = params.get("StdRetCode")
        self.StdRetMsg = params.get("StdRetMsg")


class CallBackData(AbstractModel):
    """异步接口返回ACK数据
    ...
    def __init__(self):
        """
        :param Res: 异步请求ACK内容
        :type Res: :class:`tencentcloud.cms.v20190321.models.CallBackAck`
        """
        self.Res = None
...
class CommonMediaRecognitionRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type MessageCommon: :class:`tencentcloud.cms.v20190321.models.MessageCommonGjh`
        :param MessageContent: 内容相关参数
        :type MessageContent: :class:`tencentcloud.cms.v20190321.models.MessageContentGjh`
        :param MessageId: 内容ID参数
        :type MessageId: :class:`tencentcloud.cms.v20190321.models.MessageIdGjh`
        """
    ...
    def _deserialize(self, params):
        if params.get("MessageCommon") is not None:
            self.MessageCommon = MessageCommonGjh()
            self.MessageCommon._deserialize(params.get("MessageCommon"))
        if params.get("MessageContent") is not None:
            self.MessageContent = MessageContentGjh()
            self.MessageContent._deserialize(params.get("MessageContent"))
        if params.get("MessageId") is not None:
            self.MessageId = MessageIdGjh()
            self.MessageId._deserialize(params.get("MessageId"))


class CommonMediaRecognitionResponse(AbstractModel):
    ...
    def __init__(self):
        """
        :param Data: 返回数据
        :type Data: :class:`tencentcloud.cms.v20190321.models.CallBackData`
...
class ContentMsgGjh(AbstractModel):
    """发送消息设备描述
    ...
    def __init__(self):
        ...
        self.CIPType = None
        self.StrMsgIP = None
        self.StrMsgIPv6 = None
        self.UiPostTime = None


    def _deserialize(self, params):
        self.CIPType = params.get("CIPType")
        self.StrMsgIP = params.get("StrMsgIP")
        self.StrMsgIPv6 = params.get("StrMsgIPv6")
        self.UiPostTime = params.get("UiPostTime")
...
class MediaGjh(AbstractModel):
    ...
    def __init__(self):
        """
        :param Pic: 数组类图片信息
        :type Pic: list of MediaInfoTypeGjh
        :param Text: 数组类文本信息
        :type Text: list of MediaInfoTypeGjh
        :param Video: 数组类视频信息
        :type Video: list of MediaInfoTypeGjh
        """
        self.Pic = None
        self.Text = None
        self.Video = None
    ...
    def _deserialize(self, params):
        if params.get("Pic") is not None:
            self.Pic = []
            for item in params.get("Pic"):
                obj = MediaInfoTypeGjh()
                obj._deserialize(item)
                self.Pic.append(obj)
        if params.get("Text") is not None:
            self.Text = []
            for item in params.get("Text"):
                obj = MediaInfoTypeGjh()
                obj._deserialize(item)
...
class MediaInfoTypeGjh(AbstractModel):
    """媒体信息
    ...
    def _deserialize(self, params):
        self.StrAction = params.get("StrAction")
        self.StrContent = params.get("StrContent")
        self.StrFileID = params.get("StrFileID")
        self.StrMD5 = params.get("StrMD5")
        self.StrSha = params.get("StrSha")
        self.StrTitle = params.get("StrTitle")
        self.StrUrl = params.get("StrUrl")
        self.UiSize = params.get("UiSize")


class MessageCommonGjh(AbstractModel):
    """广交会公共参数
    ...
    def __init__(self):
        ...
        :type StrPassword: str
        :param UiAppID: 账号（由腾讯提供）
        :type UiAppID: int
        :param UiAppSceneID: 业务场景ID: 1：媒体类；2：流媒体类；3：即时通讯类；4：社交日志；5：评论类；6：资料类；7：文件类；8：互动类；9：论坛类
        :type UiAppSceneID: int
        :param UiSeq: 请求序列号，会原样回到给业务侧请求序列号，会原样回到给业务侧，用于上游异步处理
        :type UiSeq: int
        """
        self.StrPassword = None
        self.UiAppID = None
        self.UiAppSceneID = None
        self.UiSeq = None


    def _deserialize(self, params):
        self.StrPassword = params.get("StrPassword")
        self.UiAppID = params.get("UiAppID")
        self.UiAppSceneID = params.get("UiAppSceneID")
        self.UiSeq = params.get("UiSeq")


class MessageContentGjh(AbstractModel):
    """广交会消息内容
    ...
    def __init__(self):
        """
        :param Media: 具体消息内容
        :type Media: :class:`tencentcloud.cms.v20190321.models.MediaGjh`
        :param User: 发表该信息的用户的信息
        :type User: :class:`tencentcloud.cms.v20190321.models.UserInfoGjh`
        :param Msg: 发表该消息的设备的消息
        :type Msg: :class:`tencentcloud.cms.v20190321.models.ContentMsgGjh`
        """
        self.Media = None
        self.User = None
        self.Msg = None
    ...
    def _deserialize(self, params):
        if params.get("Media") is not None:
            self.Media = MediaGjh()
            self.Media._deserialize(params.get("Media"))
        if params.get("User") is not None:
            self.User = UserInfoGjh()
            self.User._deserialize(params.get("User"))
        if params.get("Msg") is not None:
            self.Msg = ContentMsgGjh()
            self.Msg._deserialize(params.get("Msg"))


class MessageIdGjh(AbstractModel):
    """广交会消息Id
    ...
    def _deserialize(self, params):
        self.StrMsgID = params.get("StrMsgID")
...
class UserInfoGjh(AbstractModel):
    """广交会用户信息
    ...
    def __init__(self):
        ...
        """
        self.StrDesc = None
        self.StrHeadUrl = None
        self.StrNick = None
        self.StrUin = None
        self.UiAcntType = None


    def _deserialize(self, params):
        self.StrDesc = params.get("StrDesc")
        self.StrHeadUrl = params.get("StrHeadUrl")
        self.StrNick = params.get("StrNick")
        self.StrUin = params.get("StrUin")
        self.UiAcntType = params.get("UiAcntType")