...
class TtsClient(AbstractClient):
    ...
    async def CreateTtsTask(
            self,
            request: models.CreateTtsTaskRequest,
            opts: Dict = None,
        ...
        kwargs = {}
        kwargs["action"] = "CreateTtsTask"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.CreateTtsTaskResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
        
        return await self.call_and_deserialize(**kwargs)
        
    async def DescribeTtsTaskStatus(
            self,
            request: models.DescribeTtsTaskStatusRequest,
            opts: Dict = None,
    ) -> models.DescribeTtsTaskStatusResponse:
        """
        ...
        kwargs = {}
        kwargs["action"] = "DescribeTtsTaskStatus"
        kwargs["params"] = request._serialize()
        kwargs["resp_cls"] = models.DescribeTtsTaskStatusResponse
        kwargs["headers"] = request.headers
        kwargs["opts"] = opts or {}
