...
class AsrParam(AbstractModel):
    ...
    @property
    def Lang(self):
        r"""<p>转录服务使用的模型类型。示例值&quot;bigmodel-zh&quot;。语音转文本不同套餐版本支持的语言如下：</p><ol><li>V2版本(优先推荐)</li></ol><p>&quot;bigmodel-xxx&quot; ：大模型引擎，推荐使用。&quot;xxx&quot;填写具体语言，例如&quot;bigmodel-zh&quot;。&quot;xxx&quot;可以填写中文 (&quot;zh&quot;)，英语 (&quot;en&quot;)，粤语 (&quot;yue&quot;)，阿拉伯语 (&quot;ar&quot;)，德语 (&quot;de&quot;)，法语 (&quot;fr&quot;)，西班牙语 (&quot;es&quot;)，葡萄牙语 (&quot;pt&quot;)，印度尼西亚语 (&quot;id&quot;)，意大利语 (&quot;it&quot;)，韩语 (&quot;ko&quot;)，俄语 (&quot;ru&quot;)，泰语 (&quot;th&quot;)，越南语 (&quot;vi&quot;)，日语 (&quot;ja&quot;)，土耳其语 (&quot;tr&quot;)，印地语 (&quot;hi&quot;)，马来语 (&quot;ms&quot;)，荷兰语 (&quot;nl&quot;)，瑞典语 (&quot;sv&quot;)，丹麦语 (&quot;da&quot;)，芬兰语 (&quot;fi&quot;)，波兰语 (&quot;pl&quot;)，捷克语 (&quot;cs&quot;)，菲律宾语 (&quot;fil&quot;)，波斯语 (&quot;fa&quot;)，希腊语 (&quot;el&quot;)，匈牙利语 (&quot;hu&quot;)，马其顿语 (&quot;mk&quot;)，罗马尼亚语 (&quot;ro&quot;)。</p><ol start="2"><li>V1版本(旧版)</li></ol><p>标准语言引擎：</p><ul><li>&quot;16k_zh_large&quot;: 16k 大模型引擎，同时支持中文、英文、多种中文方言口音等语言的识别。</li><li>&quot;16k_zh_en&quot;: 最新 16k 中英大模型引擎，同时支持中文、英语、多种中文方言口音的识别，对中英混说场景识别更优。</li></ul><p>高级语言引擎：</p><ul><li>&quot;zh-yue&quot;: 中文粤语</li><li>&quot;vi&quot;: 越南语</li><li>&quot;ja&quot;: 日语</li><li>&quot;ko&quot;: 韩语</li><li>&quot;id&quot;: 印度尼西亚语</li><li>&quot;th&quot;: 泰语</li><li>&quot;pt&quot;: 葡萄牙语</li><li>&quot;tr&quot;: 土耳其语</li><li>&quot;ar&quot;: 阿拉伯语</li><li>&quot;es&quot;: 西班牙语</li><li>&quot;hi&quot;: 印地语</li><li>&quot;fr&quot;: 法语</li><li>&quot;ms&quot;: 马来语</li><li>&quot;fil&quot;: 菲律宾语</li><li>&quot;de&quot;: 德语</li><li>&quot;it&quot;: 意大利语</li><li>&quot;ru&quot;: 俄语</li><li>&quot;sv&quot;: 瑞典语</li><li>&quot;da&quot;: 丹麦语</li><li>&quot;no&quot;: 挪威语</li></ul><p>注意：<br>如果缺少满足您需求的语言，请联系我们技术人员。</p>
        :rtype: str
        """
        return self._Lang
    ...
    def VadSilenceTime(self):
        r"""<p>语音识别vad的时间，范围为240-2000，默认为1000，单位为ms。更小的值会让语音识别分句更快。<br>示例值：1000</p>
        :rtype: int
        """
    ...
    def HotWordList(self):
        r"""<p>临时热词表：该参数用于提升识别准确率。</p><ul><li>单个热词限制：&quot;热词|权重&quot;，单个热词不超过30个字符（最多10个汉字），权重[1-11]或者100，如：&quot;腾讯云|5&quot; 或 &quot;ASR|11&quot;。</li><li>临时热词表限制：多个热词用英文逗号分割，最多支持128个热词，如：&quot;腾讯云|10,语音识别|5,ASR|11&quot;。<br>注意：<br>热词权重设置为11时，当前热词将升级为超级热词，建议仅将重要且必须生效的热词设置到11，设置过多权重为11的热词将影响整体字准率。<br>热词权重设置为100时，当前热词开启热词增强同音同调替换功能，举例：热词配置&quot;蜜制|100&quot;时，与&quot;蜜制&quot;同拼音（mizhi）的&quot;秘制&quot;的识别结果会被强制替换成&quot;蜜制&quot;。因此建议客户根据自己的实际情况开启该功能。建议仅将重要且必须生效的热词设置到100，设置过多权重为100的热词将影响整体字准率。<br>热词不能包含空格，如：ASR 腾讯云<br>示例值：语音助理|10</li></ul>
        :rtype: str
        """
    ...
    def AlternativeLanguage(self):
        r"""<p>发起模糊识别为高级语言引擎能力, 仅支持填写除&quot;zh-dialect&quot;和&quot;zh-yue&quot;以外的高级语言引擎。注意：最多只能填写4种语言。</p>
        :rtype: list of str
        """
    ...
    @property
    def VadLevel(self):
        r"""<p>vad的远场人声抑制能力（不会对asr识别效果造成影响），范围为[0, 1]，默认为0。推荐设置为1，有较好的远场人声抑制能力。</p>
        :rtype: int
        """
    ...
    def FilterDirty(self):
        r"""<p>是否过滤脏词（目前仅支持填写基础语言引擎和标准语言引擎），范围为[0, 2]，默认值为 0。<br>0：不过滤脏词；1：过滤脏词；2：将脏词替换为 &quot; * &quot;。</p>
        :rtype: int
        """
    ...
    def FilterModal(self):
        r"""<p>是否过滤语气词（目前仅支持填写基础语言引擎和标准语言引擎），范围为[0, 2]，默认值为 0。<br>0：不过滤语气词；1：部分过滤；2：严格过滤。</p>
        :rtype: int
        """
    ...
    @property
    def FilterPunc(self):
        r"""<p>是否过滤句末的句号（目前仅支持填写基础语言引擎和标准语言引擎），范围为[0, 1]，默认值为 0。<br>0：不过滤句末的句号；1：过滤句末的句号。</p>
        :rtype: int
        """
...
class AudioFormat(AbstractModel):
    ...
    @property
    def Format(self):
        r"""<p>生成的音频格式，注意opus格式是ogg/opus编码</p><ul><li><p>TextToSpeechSSE 流式接口</p><p>支持 pcm,mp3,opus 默认: pcm</p></li><li><p>TextToSpeech 非流式接口</p><p>支持 pcm,wav,mp3,opus  默认: pcm</p></li><li><p>AsyncTextToSpeech<br>支持pcm,mp3,opus 默认: mp3</p></li></ul>
        :rtype: str
        """
        return self._Format
...
class AudioParams(AbstractModel):
    ...
    @property
    def SampleRate(self):
        r"""<p>音频采样率枚举值:(注意1 代表48000HZ, 2 代表44100HZ, 3 代表16000HZ)<br>1：48000Hz（默认）;<br>2：44100Hz<br>3：16000Hz。</p>
        :rtype: int
        """
        return self._SampleRate
    ...
    @property
    def Channel(self):
        r"""<p>声道数枚举值:<br>1：单声道;<br>2：双声道（默认）。</p>
        :rtype: int
        """
        return self._Channel
    ...
    @property
    def BitRate(self):
        r"""<p>音频码率: 取值范围[32000, 128000] ，单位bps，默认64000bps。</p>
        :rtype: int
        """
        return self._BitRate
...
class ControlAIConversationRequest(AbstractModel):
    ...
    @property
    def Command(self):
        r"""<p>控制命令，目前支持命令如下：- ServerPushText，服务端发送文本给AI机器人，AI机器人会播报该文本. - InvokeLLM，服务端发送文本给大模型，触发对话。- TransparentData，透传信息给客户端。</p>
        :rtype: str
        """
    ...
    def ServerPushText(self):
        r"""<p>服务端发送播报文本命令，当Command为ServerPushText时必填</p>
    ...
    @property
    def InvokeLLM(self):
        r"""<p>服务端发送命令主动请求大模型,当Command为InvokeLLM时会把content请求到大模型,头部增加X-Invoke-LLM=&quot;1&quot;</p>
...
class CreateCloudModerationRequest(AbstractModel):
    ...
    @property
    def SdkAppId(self):
        r"""<p>TRTC的<a href="https://cloud.tencent.com/document/product/647/46351#sdkappid">SdkAppId</a>，和TRTC的房间所对应的SdkAppId相同。</p>
        :rtype: int
        """
        return self._SdkAppId
    ...
    @property
    def RoomId(self):
        r"""<p>TRTC的<a href="https://cloud.tencent.com/document/product/647/46351#roomid">RoomId</a>，为TRTC房间所对应的RoomId。</p>
        :rtype: str
        """
        return self._RoomId
    ...
    @property
    def UserId(self):
        r"""<p>机器人的UserId，用于进房发起AI 内容理解任务。【*注意】这个UserId不能与当前房间内的主播观众UserId重复。如果一个房间发起多个切片任务时，机器人的userid也不能相互重复，否则会中断前一个切片任务。建议可以把房间ID作为UserId的标识的一部分，即机器人UserId在房间内唯一。</p>
        :rtype: str
        """
        return self._UserId
    ...
    @property
    def UserSig(self):
        r"""<p>机器人UserId对应的校验签名，即UserId和UserSig相当于机器人进房的登录密码，具体计算方法请参考TRTC计算UserSig的方案。</p>
        :rtype: str
        """
        return self._UserSig
    ...
    @property
    def RoomIdType(self):
        r"""<p>TRTC房间号的类型。 【*注意】必须和录制的房间所对应的RoomId类型相同: 0: 字符串类型的RoomId 1: 32位整型的RoomId（默认） 示例值：1</p>
        :rtype: int
        """
    ...
    def ResourceExpiredHour(self):
        r"""<p>任务ID可以调用的时效性，从成功开启任务并获得TaskID后开始计算，超时后无法调用查询、更新和停止等接口，但是切片任务不会停止。 参数的单位是小时，默认24小时（1天），最大可设置72小时（3天），最小设置6小时。举例说明：如果不设置该参数，那么开始切片成功后，查询、更新和停止切片的调用时效为24个小时。</p>
        :rtype: int
        """
...
class CreateRecognizeVocabV3Request(AbstractModel):
    r"""CreateRecognizeVocabV3请求参数结构体
...
class CreateRecognizeVocabV3Response(AbstractModel):
    r"""CreateRecognizeVocabV3返回参数结构体
...
class DeleteRecognizeVocabV3Request(AbstractModel):
...
class DeleteRecognizeVocabV3Response(AbstractModel):
    r"""DeleteRecognizeVocabV3返回参数结构体
...
class DescribeCloudModerationResponse(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Status: str
        :param _SubscribeStreamUserIds: <p>订阅黑白名单</p>
...
class DownloadRecognizeVocabV3Request(AbstractModel):
    r"""DownloadRecognizeVocabV3请求参数结构体
...
class GetRecognizeVocabListV3Request(AbstractModel):
    r"""GetRecognizeVocabListV3请求参数结构体
...
class GetRecognizeVocabV3Request(AbstractModel):
...
灰色：0x999999。
        :type BackGroundColor: str
        :param _BackgroundImageUrl: 整个画布的背景图片url，优先级高于BackGroundColor。支持png、jpg、jpeg格式。图片分辨率限制不超过2K，图片大小限制不超过5MB。
注：
...
灰色：0x999999。
    ...
    @property
    def BackgroundImageUrl(self):
        r"""整个画布的背景图片url，优先级高于BackGroundColor。支持png、jpg、jpeg格式。图片分辨率限制不超过2K，图片大小限制不超过5MB。
注：
1，您需要确保图片链接的可访问性，后台单次下载超时时间为10秒，最多重试3次，若最终图片下载失败，背景图片将不会生效。
2，url可支持字符集：【'0-9','a-z','A-Z','-', '.', '_', '~', ':', '/', '?', '#', '[', ']','@', '!', '&', '(', ')', '*', '+', ',', '%', '=', ';', '|'】，您需要确保url字符在可支持字符集内，若存在可支持字符集外的字符，背景图片将不会生效。
        :rtype: str
...
2，url可支持字符集：【'0-9','a-z','A-Z','-', '.', '_', '~', ':', '/', '?', '#', '[', ']','@', '!', '&', '(', ')', '*', '+', ',', '%', '=', ';', '|'】，您需要确保url字符在可支持字符集内，若存在可支持字符集外的字符，水印图片将不会生效。
    ...
    def WaterMarkUrl(self):
        r"""水印图片URL地址，支持png、jpg、jpeg格式。图片分辨率限制不超过2K，图片大小限制不超过5MB。
注：
1，您需要确保图片链接的可访问性，后台单次下载超时时间为10秒，最多重试3次，若最终图片下载失败，水印图片将不会生效。
2，url可支持字符集：【'0-9','a-z','A-Z','-', '.', '_', '~', ':', '/', '?', '#', '[', ']','@', '!', '&', '(', ')', '*', '+', ',', '%', '=', ';', '|'】，您需要确保url字符在可支持字符集内，若存在可支持字符集外的字符，水印图片将不会生效。
        :rtype: str
...
class McuWaterMarkParams(AbstractModel):
    ...
    def WaterMarkImage(self):
        r"""图片水印参数。WaterMarkType为0指定。图片分辨率限制不超过2K，图片大小限制不超过5MB。
...
class ModerationParams(AbstractModel):
    ...
    @property
    def ModerationType(self):
        r"""<p>AI 内容理解任务类型， 1:音频切片理解，2:视频截帧理解，3:音视切片+视频截帧理解  默认值1 </p><p>枚举值：</p><ul><li>1： 音频切片理解</li></ul>
        :rtype: int
        """
        return self._ModerationType
    ...
    @property
    def MaxIdleTime(self):
        r"""<p>房间内持续没有用户（主播）上行推流的状态超过MaxIdleTime的时长，自动停止切片，单位：秒。默认值为 30 秒，该值需大于等于 5秒，且小于等于1800秒(0.5小时)。示例值：30</p>
        :rtype: int
        """
        return self._MaxIdleTime
    ...
    @property
    def SliceAudio(self):
        r"""<p>音频切片时长，默认15s 示例值：15, 范围15-60s</p>
        :rtype: int
        """
        return self._SliceAudio
    ...
    def ModerationSupplierParam(self):
        r"""<p>第三方内容理解供应商需要配置信息, ModerationSupplier为trtc时，这个参数可以不需要初始化</p>
    ...
    @property
    def SaveModerationFile(self):
        r"""<p>是否保存文件:  0不保存文件 1保存所有文件 2仅保存命中文件</p>
        :rtype: int
        """
        return self._SaveModerationFile
    ...
    @property
    def CallbackAllResults(self):
        r"""<p>是否回调所有内容理解结果:0 默认回调所有结果 1 仅回调命中结果</p>
        :rtype: int
        """
        return self._CallbackAllResults
...
class STTConfig(AbstractModel):
    ...
    @property
    def Language(self):
        r"""<p>语音转文字支持识别的语言，默认是&quot;zh&quot; 中文</p><p>可通过购买「AI智能识别时长包」解锁或领取包月套餐体验版解锁不同语言. 详细说明参考：<a href="https://cloud.tencent.com/document/product/647/111976">AI智能识别计费说明</a></p><p>语音转文本不同套餐版本支持的语言如下：</p><p><strong>基础语言引擎</strong>：</p><ul><li> "zh": 中文（简体）</li><li>"zh-TW": 中文（繁体）</li><li>"en": 英语</li><li>"16k_zh_edu"：中文教育</li><li>"16k_zh_medical"：中文医疗</li><li>"16k_zh_court"：中文法庭</li></ul><p><strong>标准语言引擎：</strong></p><ul><li> "8k_zh_large": 普方大模型引擎. 当前模型同时支持中文等语言的识别，模型参数量极大，语言模型性能增强，针对电话音频中各类场景、各类中文方言的识别准确率极大提升.</li><li> "16k_zh_large": 普方英大模型引擎. 当前模型同时支持中文、英文、多种中文方言等语言的识别，模型参数量极大，语言模型性能增强，针对噪声大、回音大、人声小、人声远等低质量音频的识别准确率极大提升.</li><li> "16k_multi_lang": 多语种大模型引擎. 当前模型同时支持英语、日语、韩语、阿拉伯语、菲律宾语、法语、印地语、印尼语、马来语、葡萄牙语、西班牙语、泰语、土耳其语、越南语、德语的识别，可实现15个语种的自动识别(句子/段落级别).</li><li> "16k_zh_en": 中英大模型引擎. 当前模型同时支持中文、英语识别，模型参数量极大，语言模型性能增强，针对噪声大、回音大、人声小、人声远等低质量音频的识别准确率极大提升.</li></ul><p><strong>高级语言引擎：</strong></p><ul><li>"zh-dialect": 中国方言</li><li>"zh-yue": 中国粤语</li><li>"vi": 越南语</li><li>"ja": 日语</li><li>"ko": 韩语</li><li>"id": 印度尼西亚语</li><li>"th": 泰语</li><li>"pt": 葡萄牙语</li><li>"tr": 土耳其语</li><li>"ar": 阿拉伯语</li><li>"es": 西班牙语</li><li>"hi": 印地语</li><li>"fr": 法语</li><li>"ms": 马来语</li><li>"fil": 菲律宾语</li><li>"de": 德语</li><li>"it": 意大利语</li><li>"ru": 俄语</li><li>"sv": 瑞典语</li><li>"da": 丹麦语</li><li>"no": 挪威语</li><li>"pl": 波兰语</li><li>"uz": 乌兹别克语</li><li>"hu": 匈牙利语</li><li>"he": 希伯来语</li><li>"ur": 乌尔都语</li><li>"af-ZA": 南非荷兰语</li><li>"nl-BE": 比利时荷兰语</li><li>"nl-NL": 荷兰语(本土)</li></ul><p><strong>bigmodel全新大模型语音识别引擎</strong></p><ul><li>"bigmodel_auto": 多语言自动识别</li><li>"bigmodel_zh": 中文</li><li>"bigmodel_en": 英语</li><li>"bigmodel_yue": 粤语</li><li>"bigmodel_ar": 阿拉伯语</li><li>"bigmodel_de": 德语</li><li>"bigmodel_fr": 法语</li><li>"bigmodel_es": 西班牙</li><li>"bigmodel_pt": 葡萄牙语</li><li>"bigmodel_id": 印尼语</li><li>"bigmodel_it": 意大利语</li><li>"bigmodel_ko": 韩语</li><li>"bigmodel_ru": 俄语</li><li>"bigmodel_th": 泰语</li><li>"bigmodel_vi": 越南语</li><li>"bigmodel_tr": 土耳其语</li><li>"bigmodel_hi": 印地语</li><li>"bigmodel_ms": 马来语</li><li>"bigmodel_pl": 波兰语</li><li>"bigmodel_cs": 捷克语</li><li>"bigmodel_fil": 菲律宾语</li><li>"bigmodel_fa": 波斯语</li><li>"bigmodel_el": 希腊语</li><li>"bigmodel_ro": 罗马尼亚语</li><li>"bigmodel_hu": 匈牙利语</li><li>"bigmodel_mk": 马其顿语</li></ul><p><strong>注意：</strong><br>如果缺少满足您需求的语言，请联系我们技术人员。</p>
        :rtype: str
        """
        return self._Language
    ...
    @property
    def AlternativeLanguage(self):
        r"""<p><strong>发起模糊识别为高级版能力,默认按照高级版收费</strong><br>注意：不支持填写&quot;zh-dialect&quot;, &quot;16k_zh_edu&quot;, &quot;16k_zh_medical&quot;, &quot;16k_zh_court&quot;, &quot;8k_zh_large&quot;, &quot;16k_zh_large&quot;,&quot;16k_multi_lang&quot;, &quot;16k_zh_en&quot;</p>
        :rtype: list of str
        """
        return self._AlternativeLanguage
    ...
    @property
    def HotWordList(self):
        r"""<p>热词表：该参数用于提升识别准确率。 单个热词限制：&quot;热词|权重&quot;，单个热词不超过30个字符（最多10个汉字），权重[1-11]或者100，如：“腾讯云|5” 或 “ASR|11”； 热词表限制：多个热词用英文逗号分割，最多支持128个热词，如：“腾讯云|10,语音识别|5,ASR|11”；</p>
        :rtype: str
        """
        return self._HotWordList
    ...
    @property
    def VadLevel(self):
        r"""<p>vad的远场人声抑制能力（不会对asr识别效果造成影响），范围为[0, 5]，默认为0，表示不开启远场人声抑制能力。推荐设置为2，有较好的远场人声抑制能力。嘈杂的办公室环境下可以设置为3，更为嘈杂的环境下可以使用4和5。注意较高的VadLevel可能会将单字当作噪声给过滤。</p>
        :rtype: int
        """
        return self._VadLevel
...
class SetVocabStateV3Request(AbstractModel):
    r"""SetVocabStateV3请求参数结构体
...
取值范围15-60s
    ...
    @property
    def SliceImageType(self):
        r"""知道图片格式类型：
0 png, 1 jpg默认0
        :rtype: int
        """
        return self._SliceImageType

    @SliceImageType.setter
    def SliceImageType(self, SliceImageType):
        self._SliceImageType = SliceImageType
    ...
    def _deserialize(self, params):
        ...
        if params.get("SubscribeStreamUserIds") is not None:
            self._SubscribeStreamUserIds = SubscribeStreamUserIds()
            self._SubscribeStreamUserIds._deserialize(params.get("SubscribeStreamUserIds"))
        self._SliceImageType = params.get("SliceImageType")
...
class TTSParam(AbstractModel):
    ...
    @property
    def Model(self):
        r"""<p>tts模型参数，仅支持填写&quot;flow_02_turbo&quot;。</p>
        :rtype: str
        """
        return self._Model
...
class TTSVoice(AbstractModel):
    ...
    @property
    def VoiceId(self):
        r"""<p>音色 ID。对于不同的语言，需要填写特定的音色ID，如下所示：</p><ul><li>中文（&quot;zh&quot;）：男生音色&quot;v-male-s5NqE0rZ&quot;、女生音色&quot;v-female-R2s4N9qJ&quot;。</li><li>英语（&quot;en&quot;）：男生音色&quot;v-male-X6h4TvP9&quot;、女生音色&quot;v-female-P6q9LmR2&quot;。</li><li>日语（&quot;ja&quot;）：男生音色&quot;v-male-J3n8DxK2&quot;、女生音色&quot;v-female-J3k7NxR2&quot;。</li><li>粤语（&quot;yue&quot;）：男生音色&quot;v-male-D7p4XcL2&quot;、女生音色&quot;v-female-C5t1QxH9&quot;。</li><li>印度尼西亚语（&quot;id&quot;）：男生音色&quot;v-male-B5f2CnS3&quot;、女生音色&quot;v-female-W5n8HgB2&quot;。</li><li>泰语（&quot;th&quot;）：男生音色&quot;v-male-B5f2CnS3&quot;、女生音色&quot;v-female-W5n8HgB2&quot;。</li><li>越南语（&quot;vi&quot;）：男生音色&quot;v-male-B5f2CnS3&quot;、女生音色&quot;v-female-W5n8HgB2&quot;。</li><li>马来语（&quot;ms&quot;）：男生音色&quot;v-male-Q6p8ZxL3&quot;、女生音色&quot;v-female-C8k4NxL6&quot;。</li></ul><p>如果缺少满足您需求的音色，请联系我们的技术人员。</p>
        :rtype: str
        """
        return self._VoiceId
...
class TextToSpeechRequest(AbstractModel):
    ...
    @property
    def Language(self):
        r"""<p>需要合成的语言，默认为空，表示自动识别</p><p>flow_02_turbo支持以下语言：</p><ul><li>zh：中文</li><li>en：英文</li><li>ja：日语</li><li>ko：韩语</li><li>yue：粤语</li><li>ms：马来语</li><li>ar：阿拉伯语</li><li>id：印尼语</li><li>th：泰语</li><li>vi：越南语</li></ul><p>flow_01_ex支持以下语言：</p><ul><li>zh：中文（简体） (Chinese Simplified)</li><li>zh-tw：中文（繁体） (Chinese Traditional)</li><li>en：英语 (English)</li><li>ja：日语 (Japanese)</li><li>ko：韩语 (Korean)</li><li>ms：马来语 (Malay)</li><li>yue：粤语 (Cantonese)</li><li>ar：阿拉伯语 (Arabic)</li><li>ru：俄语 (Russian)</li><li>es：西班牙语 (Spanish)</li><li>fr：法语 (French)</li><li>pt：葡萄牙语 (Portuguese)</li><li>de：德语 (German)</li><li>tr：土耳其语 (Turkish)</li><li>nl：荷兰语 (Dutch)</li><li>uk：乌克兰语 (Ukrainian)</li><li>vi：越南语 (Vietnamese)</li><li>id：印尼语 (Indonesian)</li><li>it：意大利语 (Italian)</li><li>th：泰语 (Thai)</li><li>pl：波兰语 (Polish)</li><li>ro：罗马尼亚语 (Romanian)</li><li>el：希腊语 (Greek)</li><li>cs：捷克语 (Czech)</li><li>fi：芬兰语 (Finnish)</li><li>hi：印地语 (Hindi)</li><li>bg：保加利亚语 (Bulgarian)</li><li>da：丹麦语 (Danish)</li><li>he：希伯来语 (Hebrew)</li><li>fa：波斯语（法尔西语） (Persian)</li><li>sk：斯洛伐克语 (Slovak)</li><li>sv：瑞典语 (Swedish)</li><li>hr：克罗地亚语 (Croatian)</li><li>tl：菲律宾语（他加禄语） (Filipino)</li><li>hu：匈牙利语 (Hungarian)</li><li>no：挪威语 (Norwegian)</li><li>sl：斯洛文尼亚语 (Slovenian)</li><li>ca：加泰罗尼亚语 (Catalan)</li><li>nn：新挪威语 (Nynorsk)</li><li>ta：泰米尔语 (Tamil)</li><li>af：南非荷兰语 (Afrikaans)</li></ul>
        :rtype: str
        """
        return self._Language
...
class TranslationParam(AbstractModel):
    ...
    @property
    def TargetLang(self):
        r"""<p>翻译的目标语言，示例值[&quot;en&quot;, &quot;ja&quot;]。目标语种列表[中文 &quot;zh&quot;，英语 &quot;en&quot;，粤语&quot;yue&quot;，越南语 &quot;vi&quot;，日语 &quot;ja&quot;，韩语 &quot;ko&quot;，印度尼西亚语 &quot;id&quot;，泰语 &quot;th&quot;，葡萄牙语 &quot;pt&quot;，阿拉伯语 &quot;ar&quot;，西班牙语 &quot;es&quot;，法语 &quot;fr&quot;，马来语 &quot;ms&quot;，德语 &quot;de&quot;，意大利语 &quot;it&quot;，俄语 &quot;ru&quot;]。</p>
        :rtype: list of str
        """
        return self._TargetLang
...
class UpdateRecognizeVocabV3Request(AbstractModel):
    r"""UpdateRecognizeVocabV3请求参数结构体
...
class Voice(AbstractModel):
    ...
    @property
    def Volume(self):
        r"""<p>音量调节，默认1.0，10 为最大音量，建议保持默认值 1.0，区间：(0, 10]</p>
        :rtype: float
        """
        return self._Volume
