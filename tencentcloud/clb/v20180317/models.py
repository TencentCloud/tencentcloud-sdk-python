...
class AssociateBudgetRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type Resources: list of BudgetResource
        """
        self._BudgetId = None
    ...
    @property
    def Resources(self):
        r"""<p>要关联的资源列表。</p><p>仅支持企业型模型路由实例和企业型实例下的Key。同一请求内不允许重复资源；资源已关联其他Budget时将替换为新的Budget。</p>
        :rtype: list of BudgetResource
        """
...
class AssociateBudgetResponse(AbstractModel):
    r"""AssociateBudget返回参数结构体
...
class BudgetAssociation(AbstractModel):
    r"""Budget关联资源信息
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def ModelRouterId(self):
        r"""<p>模型路由实例ID。</p><p>当Type为ModelRouter时表示关联资源本身；当Type为Key时表示Key所属实例。</p>
        :rtype: str
        """
    ...
    @property
    def Status(self):
        r"""<p>关联关系的状态</p><p>枚举值：</p><ul><li>Active： 已生效</li><li>Configuring： 配置中</li><li>ConfigureFailed： 配置失败</li></ul>
        :rtype: str
        """
        return self._Status
...
class BudgetConfig(AbstractModel):
    r"""Budget预算配置
...
注意：此字段可能返回 null，表示取不到有效值。
        :type BudgetDuration: str
        :param _BudgetResetAt: <p>下一次刷新的时间</p>
        :type BudgetResetAt: str
        :param _MaxBudget: <p>最大预算。</p><p>单位：credit。取值需大于0且不超过10000000000；不传时默认100000。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :type MaxBudget: float
        """
        self._BudgetDuration = None
        self._BudgetResetAt = None
        self._MaxBudget = None

    @property
    def BudgetDuration(self):
        r"""<p>预算刷新周期。</p><p>枚举值：</p><ul><li>1d：按天刷新</li><li>7d：按周刷新</li><li>30d：按月刷新</li></ul><p>不传时默认30d。同一个Budget下每种刷新周期最多配置一次。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._BudgetDuration

    @BudgetDuration.setter
    def BudgetDuration(self, BudgetDuration):
        self._BudgetDuration = BudgetDuration

    @property
    def BudgetResetAt(self):
        r"""<p>下一次刷新的时间</p>
        :rtype: str
        """
        return self._BudgetResetAt

    @BudgetResetAt.setter
    def BudgetResetAt(self, BudgetResetAt):
        self._BudgetResetAt = BudgetResetAt

    @property
    def MaxBudget(self):
        r"""<p>最大预算。</p><p>单位：credit。取值需大于0且不超过10000000000；不传时默认100000。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: float
        """
    ...
    @MaxBudget.setter
    def MaxBudget(self, MaxBudget):
        self._MaxBudget = MaxBudget


    def _deserialize(self, params):
        self._BudgetDuration = params.get("BudgetDuration")
        self._BudgetResetAt = params.get("BudgetResetAt")
        self._MaxBudget = params.get("MaxBudget")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            property_name = name[1:]
            if property_name in memeber_set:
...
class BudgetConfigInput(AbstractModel):
    r"""Budget预算配置入参
    ...
    @property
    def BudgetDuration(self):
        r"""<p>预算刷新周期。</p><p>支持取值：</p><ul><li>1d：按天刷新</li><li>7d：按周刷新</li><li>30d：按月刷新</li></ul><p>不传时默认使用30d。同一个Budget下每种刷新周期最多配置一次。</p>
        :rtype: str
        """
        return self._BudgetDuration
...
class BudgetInfo(AbstractModel):
    r"""Budget信息
    ...
    def __init__(self):
        ...
        :type Status: str
        """
        self._AssociationKeyCount = None
        self._AssociationModelRouterCount = None
        self._AssociationUserGroupCount = None
        self._BudgetConfigs = None
        self._BudgetId = None
    ...
    @property
    def AssociationKeyCount(self):
        r"""<p>关联的key数量</p>
        :rtype: int
        """
        return self._AssociationKeyCount

    @AssociationKeyCount.setter
    def AssociationKeyCount(self, AssociationKeyCount):
        self._AssociationKeyCount = AssociationKeyCount

    @property
    def AssociationModelRouterCount(self):
        r"""<p>关联的模型路由数量</p>
        :rtype: int
        """
        return self._AssociationModelRouterCount

    @AssociationModelRouterCount.setter
    def AssociationModelRouterCount(self, AssociationModelRouterCount):
        self._AssociationModelRouterCount = AssociationModelRouterCount

    @property
    def AssociationUserGroupCount(self):
        r"""<p>关联的用户组数量</p>
        :rtype: int
        """
        return self._AssociationUserGroupCount

    @AssociationUserGroupCount.setter
    def AssociationUserGroupCount(self, AssociationUserGroupCount):
        self._AssociationUserGroupCount = AssociationUserGroupCount

    @property
    def BudgetConfigs(self):
        r"""<p>Budget预算配置数组。</p><p>最多返回3个元素，每种刷新周期（1d/7d/30d）各一个。</p>
        :rtype: list of BudgetConfig
        """
        return self._BudgetConfigs

    @BudgetConfigs.setter
    def BudgetConfigs(self, BudgetConfigs):
        self._BudgetConfigs = BudgetConfigs
    ...
    def RateLimitConfig(self):
        r"""<p>Budget限速信息。</p>
        :rtype: :class:`tencentcloud.clb.v20180317.models.RateLimitConfigForBudget`
        """
    ...
    @property
    def Status(self):
        r"""<p>Budget状态。</p><p>枚举值：</p><ul><li>Provisioning：创建中</li><li>Active：运行中</li><li>Configuring：变配中</li><li>Deleting：删除中</li><li>ProvisionFailed：创建失败</li><li>ConfigureFailed：变配失败</li><li>DeletionFailed：删除失败</li></ul>
        :rtype: str
        """
        return self._Status
    ...
    def _deserialize(self, params):
        self._AssociationKeyCount = params.get("AssociationKeyCount")
        self._AssociationModelRouterCount = params.get("AssociationModelRouterCount")
        self._AssociationUserGroupCount = params.get("AssociationUserGroupCount")
        if params.get("BudgetConfigs") is not None:
            self._BudgetConfigs = []
            for item in params.get("BudgetConfigs"):
                obj = BudgetConfig()
                obj._deserialize(item)
                self._BudgetConfigs.append(obj)
        self._BudgetId = params.get("BudgetId")
        self._BudgetName = params.get("BudgetName")
        self._CreatedTime = params.get("CreatedTime")
        self._ModifiedTime = params.get("ModifiedTime")
        if params.get("RateLimitConfig") is not None:
            self._RateLimitConfig = RateLimitConfigForBudget()
...
class BudgetResource(AbstractModel):
    r"""Budget关联资源对象。仅支持企业型模型路由实例和企业型实例下的Key。
    ...
    @property
    def ModelRouterId(self):
        r"""<p>模型路由实例ID。</p><p>当Type为ModelRouter时表示要关联的实例；当Type为Key时表示Key所属实例。</p>
        :rtype: str
        """
        return self._ModelRouterId
    ...
    @property
    def Type(self):
        r"""<p>资源类型。</p><p>枚举值：</p><ul><li>ModelRouter：模型路由实例</li><li>Key：模型路由Key</li><li>UserGroup：用户组（Type 为 UserGroup 时需传 UserGroupId）</li></ul>
        :rtype: str
        """
        return self._Type
    ...
    @property
    def KeyId(self):
        r"""<p>Key ID。</p><p>字段本身选填；当Type为Key时必填，当Type为ModelRouter时不传。</p>
        :rtype: str
        """
        return self._KeyId
...
class ClusterInfo(AbstractModel):
    ...
    @property
    def Type(self):
        r"""<p>集群类型</p><p>枚举值：</p><ul><li>Public： 公有云集群</li><li>Exclusive： 独占集群</li></ul><p>默认值：Public</p>
        :rtype: str
        """
        return self._Type
...
class CreateBudgetRequest(AbstractModel):
    ...
    @property
    def Resources(self):
        r"""<p>创建Budget时同时关联的资源列表。</p><p>仅支持企业型模型路由实例和企业型实例下的Key。如果资源不存在或不可关联，创建请求失败；资源已关联其他Budget时将替换为新创建的Budget。</p>
        :rtype: list of BudgetResource
        """
        return self._Resources
...
class CreateBudgetResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _BudgetId: <p>Budget ID。</p><p>创建请求提交后返回，可通过DescribeBudgets查询状态。</p>
        :type BudgetId: str
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
    ...
    @property
    def BudgetId(self):
        r"""<p>Budget ID。</p><p>创建请求提交后返回，可通过DescribeBudgets查询状态。</p>
        :rtype: str
        """
        return self._BudgetId
...
class CreateKeysRequest(AbstractModel):
    r"""CreateKeys请求参数结构体
    ...
    def __init__(self):
        ...
        :type Keys: list of InputKeyInfo
    ...
    @property
    def Mode(self):
        r"""<p>批量创建Key的模式</p><p>枚举值：</p><ul><li>Generate： 平台生成Key</li><li>Import： 导入自带Key</li></ul><p>默认值：Generate</p>
        :rtype: str
        """
        return self._Mode
...
class CreateKeysResponse(AbstractModel):
    r"""CreateKeys返回参数结构体
    ...
    def __init__(self):
        r"""
        :param _CreatedKeys: <p>创建的Key的信息</p>
        :type CreatedKeys: list of CreatedKey
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self._CreatedKeys = None
        self._RequestId = None

    @property
    def CreatedKeys(self):
        r"""<p>创建的Key的信息</p>
        :rtype: list of CreatedKey
        """
        return self._CreatedKeys

    @CreatedKeys.setter
    def CreatedKeys(self, CreatedKeys):
        self._CreatedKeys = CreatedKeys
    ...
    def _deserialize(self, params):
        if params.get("CreatedKeys") is not None:
            self._CreatedKeys = []
            for item in params.get("CreatedKeys"):
                obj = CreatedKey()
                obj._deserialize(item)
                self._CreatedKeys.append(obj)
        self._RequestId = params.get("RequestId")
...
class CreateListenerRequest(AbstractModel):
    ...
    @property
    def Ports(self):
        r"""<p>要将监听器创建到哪些端口，每个端口对应一个新的监听器。<br>端口范围：1~65535</p>
        :rtype: list of int
        """
        return self._Ports
    ...
    def ListenerNames(self):
        r"""<p>要创建的监听器名称列表，名称与Ports数组按序一一对应，如不需立即命名，则无需提供此参数。命名规则：1-80 个英文字母、汉字等国际通用语言字符，数字，连接线“-”、下划线“_”等常见字符（禁止Unicode补充字符，如emoji表情、生僻汉字等）。</p>
        :rtype: list of str
        """
    ...
    def Certificate(self):
        r"""<p>证书相关信息。参数限制如下：</p><li>此参数仅适用于TCP_SSL监听器和未开启SNI特性的HTTPS监听器。</li><li>创建TCP_SSL监听器和未开启SNI特性的HTTPS监听器时，此参数和参数MultiCertInfo至少需要传一个， 但不能同时传入。</li>
    ...
    @property
    def Scheduler(self):
        r"""<p>监听器转发的方式。可选值：WRR（按权重轮询）、LEAST_CONN（按最小连接数）<br>默认为 WRR。此参数仅适用于TCP/UDP/TCP_SSL/QUIC监听器。</p>
        :rtype: str
        """
    ...
    def KeepaliveEnable(self):
        r"""<p>是否开启长连接，此参数仅适用于HTTP/HTTPS监听器，0:关闭；1:开启， 默认关闭。<br>若后端服务对连接数上限有限制，则建议谨慎开启。此功能目前处于内测中，如需使用，请提交 <a href="https://cloud.tencent.com/apply/p/tsodp6qm21">内测申请</a>。</p>
        :rtype: int
        """
    ...
    def MultiCertInfo(self):
        r"""<p>证书信息，支持同时传入不同算法类型的多本服务端证书，参数限制如下：</p><li>此参数仅适用于TCP_SSL监听器和未开启SNI特性的HTTPS监听器。</li><li>创建TCP_SSL监听器和未开启SNI特性的HTTPS监听器时，此参数和参数Certificate至少需要传一个， 但不能同时传入。</li>
    ...
    def SslCloseSwitch(self):
        r"""<p>控制 TCP_SSL 类型的监听器是否移除 SSL 加密层。开启后，监听器将作为普通 TCP 协议运行。 可选值：</p><ul><li>True： 关闭 SSL 功能（协议降级为纯文本 TCP）。</li><li>False（默认）： 保持 SSL 功能开启。</li></ul>
        :rtype: bool
        """
...
class CreateLoadBalancerRequest(AbstractModel):
    ...
    def LoadBalancerType(self):
        r"""<p>负载均衡实例的网络类型：<br>OPEN：公网属性， INTERNAL：内网属性。</p>
        :rtype: str
        """
    ...
    @property
    def Forward(self):
        r"""<p>负载均衡实例的类型。1：通用的负载均衡实例，目前只支持传入1。</p>
        :rtype: int
        """
    ...
    @property
    def LoadBalancerName(self):
        r"""<p>负载均衡实例的名称，只在创建一个实例的时候才会生效。规则：1-80 个英文字母、汉字等国际通用语言字符，数字，连接线“-”、下划线“_”等常见字符（禁止Unicode补充字符，如emoji表情、生僻汉字等）。注意：如果名称与系统中已有负载均衡实例的名称相同，则系统将会自动生成此次创建的负载均衡实例的名称。</p>
        :rtype: str
        """
        return self._LoadBalancerName
    ...
    @property
    def VpcId(self):
        r"""<p>负载均衡后端目标设备所属的网络 ID，如vpc-12345678，可以通过 <a href="https://cloud.tencent.com/document/product/215/15778">DescribeVpcs</a> 接口获取。 不填此参数则默认为DefaultVPC。创建内网负载均衡实例时，此参数必填。</p>
        :rtype: str
        """
        return self._VpcId
    ...
    @property
    def ProjectId(self):
        r"""<p>负载均衡实例所属的项目 ID，默认项目 ID 为0。可以通过 <a href="https://cloud.tencent.com/document/api/651/78725">DescribeProject</a> 接口获取。不填此参数则视为默认项目。</p>
        :rtype: int
        """
        return self._ProjectId
    ...
    def AddressIPVersion(self):
        r"""<p>仅适用于公网负载均衡。IP版本，可取值：IPV4、IPV6、IPv6FullChain，不区分大小写，默认值 IPV4。说明：取值为IPV6表示为IPV6 NAT64版本；取值为IPv6FullChain，表示为IPv6版本。</p>
        :rtype: str
        """
    ...
    @property
    def Number(self):
        r"""<p>创建负载均衡的个数，默认值 1。创建个数不能超过账号所能创建的最大值，默认创建最大值为20。</p>
        :rtype: int
        """
        return self._Number
    ...
    @property
    def MasterZoneId(self):
        r"""<p>仅适用于公网且IP版本为IPv4的负载均衡。设置跨可用区容灾时的主可用区ID， 可用区 ID 和名称均支持，例如 100001 或 ap-guangzhou-1<br>注：主可用区是需要承载流量的可用区，备可用区默认不承载流量，主可用区不可用时才使用备可用区。</p>
        :rtype: str
        """
        return self._MasterZoneId
    ...
    @property
    def ZoneId(self):
        r"""<p>仅适用于公网且IP版本为IPv4的负载均衡。可用区ID，可用区 ID 和名称均支持，指定可用区以创建负载均衡实例。如：100001 或 ap-guangzhou-1。</p>
        :rtype: str
        """
        return self._ZoneId
    ...
    @property
    def VipIsp(self):
        r"""<p>仅适用于公网负载均衡。目前仅广州、上海、南京、济南、杭州、福州、北京、石家庄、武汉、长沙、成都、重庆地域支持静态单线 IP 线路类型，如需体验，请联系商务经理申请。申请通过后，即可选择中国移动（CMCC）、中国联通（CUCC）或中国电信（CTCC）的运营商类型，网络计费模式只能使用按带宽包计费(BANDWIDTH_PACKAGE)。 如果不指定本参数，则默认使用BGP。可通过 <a href="https://cloud.tencent.com/document/api/214/70213">DescribeResources</a>  接口查询一个地域所支持的Isp。</p>
        :rtype: str
        """
        return self._VipIsp
    ...
    @property
    def Tags(self):
        r"""<p>购买负载均衡的同时，给负载均衡打上标签，最大支持20个标签键值对。</p>
        :rtype: list of TagInfo
        """
        return self._Tags
    ...
    @property
    def Vip(self):
        r"""<p>指定VIP申请负载均衡。此参数选填，不填写此参数时自动分配VIP。IPv4和IPv6类型支持此参数，IPv6 NAT64类型不支持。<br>注意：当指定VIP创建内网实例、或公网IPv6 BGP实例时，若VIP不属于指定VPC子网的网段内时，会创建失败；若VIP已被占用，也会创建失败。</p>
        :rtype: str
        """
        return self._Vip
    ...
    @property
    def BandwidthPackageId(self):
        r"""<p>带宽包ID，可以通过 <a href="https://cloud.tencent.com/document/api/215/19209">DescribeBandwidthPackages</a> 接口获取。指定此参数时，网络计费方式（InternetAccessible.InternetChargeType）只支持按带宽包计费（BANDWIDTH_PACKAGE），带宽包的属性即为其结算方式。非上移用户购买的 IPv6 负载均衡实例，且运营商类型非 BGP 时 ，不支持指定具体带宽包id。</p>
        :rtype: str
        """
        return self._BandwidthPackageId
    ...
    @property
    def ExclusiveCluster(self):
        r"""<p>独占型实例信息。若创建独占型的内网负载均衡实例，则此参数必填。</p>
        :rtype: :class:`tencentcloud.clb.v20180317.models.ExclusiveCluster`
        """
        return self._ExclusiveCluster
    ...
    @property
    def ClusterIds(self):
        r"""<p>集群ID，集群标识，在需要配置公有云独占集群或本地专有集群时使用。公有云独占集群申请请<a href="https://console.cloud.tencent.com/workorder/category">提交工单</a>，本地专有集群请参考<a href="https://cloud.tencent.com/document/product/1346">本地专有集群</a>描述。</p>
        :rtype: list of str
        """
        return self._ClusterIds
    ...
    @property
    def SnatIps(self):
        r"""<p>开启绑定跨地域/跨Vpc绑定IP的功能后，创建SnatIp。</p>
        :rtype: list of SnatIp
        """
        return self._SnatIps
    ...
    @property
    def SlaveZoneId(self):
        r"""<p>仅适用于公网且IP版本为IPv4的负载均衡。设置跨可用区容灾时的备可用区ID，可用区 ID 和名称均支持，例如 100001 或 ap-guangzhou-1<br>注：备可用区是主可用区故障后，需要承载流量的可用区。可通过 <a href="https://cloud.tencent.com/document/api/214/70213">DescribeResources</a> 接口查询一个地域的主/备可用区的列表。【如果您需要体验该功能，请通过 <a href="https://console.cloud.tencent.com/workorder/category">工单申请</a>】</p>
        :rtype: str
        """
        return self._SlaveZoneId
    ...
    @property
    def EipAddressId(self):
        r"""<p>EIP 的唯一 ID，可以通过 <a href="https://cloud.tencent.com/document/product/215/16702">DescribeAddresses</a> 接口查询。形如：eip-qhx8udkc，仅适用于内网负载均衡绑定EIP。</p>
        :rtype: str
        """
        return self._EipAddressId
    ...
    def LoadBalancerPassToTarget(self):
        r"""<p>Target是否放通来自CLB的流量。开启放通（true）：只验证CLB上的安全组；不开启放通（false）：需同时验证CLB和后端实例上的安全组。IPv6 CLB安全组默认放通，不需要传此参数。</p>
        :rtype: bool
        """
...
class CreateLoadBalancerResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _LoadBalancerIds: <p>由负载均衡实例唯一 ID 组成的数组。<br>存在某些场景，如创建出现延迟时，此字段可能返回为空；此时可以根据接口返回的RequestId或DealName参数，通过DescribeTaskStatus接口查询创建的资源ID。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :type LoadBalancerIds: list of str
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def LoadBalancerIds(self):
        r"""<p>由负载均衡实例唯一 ID 组成的数组。<br>存在某些场景，如创建出现延迟时，此字段可能返回为空；此时可以根据接口返回的RequestId或DealName参数，通过DescribeTaskStatus接口查询创建的资源ID。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: list of str
        """
        return self._LoadBalancerIds
...
class CreateModelRouterRequest(AbstractModel):
    ...
    def ModelRouterType(self):
        r"""<p>模型路由类型</p><p>枚举值：</p><ul><li>Shared： 共享型</li><li>Enterprise： 企业级</li></ul>
        :rtype: str
        """
        return self._ModelRouterType

    @ModelRouterType.setter
    def ModelRouterType(self, ModelRouterType):
    ...
    def NetworkType(self):
        r"""<p>网络类型</p><p>枚举值：</p><ul><li>Internet： 公网</li><li>Intranet： 内网</li></ul>
        :rtype: str
        """
    ...
    def RateLimitConfig(self):
        r"""<p>限速配置</p>
        :rtype: :class:`tencentcloud.clb.v20180317.models.RateLimitConfigForModelRouter`
        """
        return self._RateLimitConfig
...
class CreateTargetGroupRequest(AbstractModel):
    ...
    @property
    def Port(self):
        r"""<p>目标组的默认端口， 后续添加服务器时可使用该默认端口。全监听目标组不支持此参数，非全监听目标组Port和TargetGroupInstances.N中的port二者必填其一。</p>
        :rtype: int
        """
        return self._Port
    ...
    @property
    def Type(self):
        r"""<p>目标组类型，当前支持v1(旧版目标组), v2(新版目标组), 默认为v1(旧版目标组)。</p>
        :rtype: str
        """
        return self._Type
    ...
    @property
    def Protocol(self):
        r"""<p>目标组后端转发协议。v2新版目标组该项必填。目前支持TCP、UDP、HTTP、HTTPS、GRPC。</p>
        :rtype: str
        """
        return self._Protocol
    ...
    @property
    def Weight(self):
        r"""<p>后端服务默认权重, 其中：</p><ul><li>取值范围[0, 100]</li><li>设置该值后，添加后端服务到目标组时， 若后端服务不单独设置权重， 则使用这里的默认权重。 </li><li>v1 目标组类型不支持设置 Weight 参数。</li></ul>
        :rtype: int
        """
        return self._Weight
    ...
    def FullListenSwitch(self):
        r"""<p>全监听目标组标识，true表示是全监听目标组，false表示不是全监听目标组。仅V2新版类型目标组支持该参数。</p>
        :rtype: bool
        """
    ...
    @property
    def KeepaliveEnable(self):
        r"""<p>是否开启长连接，此参数仅适用于HTTP/HTTPS目标组，0:关闭；1:开启， 默认关闭。</p>
        :rtype: bool
        """
        return self._KeepaliveEnable
    ...
    @property
    def SessionExpireTime(self):
        r"""<p>会话保持时间，单位：秒。可选值：30~3600，默认 0，表示不开启。仅V2新版且后端转发协议为HTTP/HTTPS/GRPC目标组支持该参数。</p>
        :rtype: int
        """
        return self._SessionExpireTime
...
class CreateUserGroupRequest(AbstractModel):
    ...
    def __init__(self):
        ...
        :type IntentRouters: list of str
    ...
    def UserGroupName(self):
        r"""<p>用户组名称。必填。同一模型路由实例下名称唯一，长度不超过255个字符。</p>
        :rtype: str
        """
    ...
    @property
    def BudgetId(self):
        r"""<p>建组时直接关联的预算 ID（须为已存在的 Budget）。关联后由该 Budget 统一管理本组的消费上限与限速。不传表示不关联预算，可建组后再用 AssociateBudget 关联。</p>
        :rtype: str
        """
        return self._BudgetId
    ...
    @property
    def IntentRouters(self):
        r"""<p>用户组意图路由白名单（ir-xxx）。每一项须为该实例已创建的意图路由名。命中意图路由名时其内部真实模型自动豁免白名单。为空表示不授权任何意图路由。</p>
        :rtype: list of str
        """
        return self._IntentRouters

    @IntentRouters.setter
    def IntentRouters(self, IntentRouters):
        self._IntentRouters = IntentRouters

    @property
    def KeyIds(self):
        r"""<p>建组时同时绑定的已有 Key ID 列表，最多100个。每个 Key 须属于同一模型路由实例。建组与绑定为一个原子异步任务，任一 Key 失败则整组创建回滚。不传表示建空组。</p>
        :rtype: list of str
        """
        return self._KeyIds
    ...
    @property
    def Models(self):
        r"""<p>用户组真实模型白名单。每一项须为该实例已关联的模型名。为空表示不在用户组层限制真实模型（按实例层白名单生效）。</p>
        :rtype: list of str
        """
        return self._Models
...
class CreateUserGroupResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _UserGroupId: <p>新建用户组的ID。</p>
        :type UserGroupId: str
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
...
class CreatedKey(AbstractModel):
    r"""批量创建的Key信息
...
class CreditUsage(AbstractModel):
    r"""Credit使用情况。该结构用于 CreditUsageSet 数组中的逐周期用量。
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def BudgetDuration(self):
        r"""<p>Budget刷新周期。</p><p>枚举值：</p><ul><li>1d：按天刷新</li><li>7d：按周刷新</li><li>30d：按月刷新</li></ul><p>仅在 CreditUsageSet 数组元素中返回。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._BudgetDuration
    ...
    @property
    def BudgetResetAt(self):
        r"""<p>下次刷新时间。</p><p>用户组关联Budget且Budget设置重置周期时返回；未关联Budget或未设置重置周期时为空。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._BudgetResetAt
    ...
    @property
    def Limit(self):
        r"""<p>Credit上限。</p><p>用户组关联Budget且Budget设置最大预算时返回；未设置最大预算时为空。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: float
        """
        return self._Limit
...
class DeleteBudgetsRequest(AbstractModel):
    r"""DeleteBudgets请求参数结构体
...
class DeleteBudgetsResponse(AbstractModel):
    r"""DeleteBudgets返回参数结构体
...
class DeleteKeysResponse(AbstractModel):
    r"""DeleteKeys返回参数结构体
...
class DeleteModelRoutersRequest(AbstractModel):
    r"""DeleteModelRouters请求参数结构体
    ...
    def __init__(self):
        ...
        :type ModelRouterIds: list of str
        """
        self._ModelRouterIds = None

    @property
    def ModelRouterIds(self):
        r"""<p>模型路由实例ID列表</p>
        :rtype: list of str
        """
        return self._ModelRouterIds

    @ModelRouterIds.setter
    def ModelRouterIds(self, ModelRouterIds):
        self._ModelRouterIds = ModelRouterIds


    def _deserialize(self, params):
        self._ModelRouterIds = params.get("ModelRouterIds")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            property_name = name[1:]
            if property_name in memeber_set:
...
class DeleteModelRoutersResponse(AbstractModel):
    r"""DeleteModelRouters返回参数结构体
...
class DeleteUserGroupsRequest(AbstractModel):
    ...
    def UserGroupIds(self):
        r"""<p>待删除的用户组ID列表，单次1-100个。不可包含「未分组」虚拟分组 ugrp-ungrouped。组内仍有 Key 时将拒绝删除，需先将 Key 移出或迁移到其他组。</p>
        :rtype: list of str
        """
...
class DescribeAsyncJobsResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _Jobs: <p>异步任务列表</p>
        :type Jobs: list of Job
        :param _NextToken: <p>分页游标</p>
        :type NextToken: str
        :param _MaxResults: <p>本次查询最大数量</p>
        :type MaxResults: int
        :param _TotalCount: <p>本次查询总数</p>
        :type TotalCount: int
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
...
class DescribeBudgetAssociationsRequest(AbstractModel):
    r"""DescribeBudgetAssociations请求参数结构体
    ...
    @property
    def BudgetId(self):
        r"""<p>Budget ID。</p><p>一次只允许查询一个Budget。</p>
        :rtype: str
        """
        return self._BudgetId
...
class DescribeBudgetAssociationsResponse(AbstractModel):
    r"""DescribeBudgetAssociations返回参数结构体

    """

    def __init__(self):
        r"""
        :param _AssociationSet: <p>Budget关联资源列表。</p>
        :type AssociationSet: list of BudgetAssociation
    ...
    def AssociationSet(self):
        r"""<p>Budget关联资源列表。</p>
        :rtype: list of BudgetAssociation
        """
...
class DescribeBudgetsRequest(AbstractModel):
    r"""DescribeBudgets请求参数结构体
    ...
    @property
    def Filters(self):
        r"""<p>过滤列表。</p><p>支持：BudgetId、BudgetName、Status。</p>
...
class DescribeBudgetsResponse(AbstractModel):
    r"""DescribeBudgets返回参数结构体

    """

    def __init__(self):
        r"""
        :param _BudgetSet: <p>Budget列表。</p>
        :type BudgetSet: list of BudgetInfo
        :param _TotalCount: <p>符合条件的总数。</p>
        :type TotalCount: int
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self._BudgetSet = None
        self._TotalCount = None
        self._RequestId = None
    ...
    def BudgetSet(self):
        r"""<p>Budget列表。</p>
        :rtype: list of BudgetInfo
        """
        return self._BudgetSet

    @BudgetSet.setter
    def BudgetSet(self, BudgetSet):
        self._BudgetSet = BudgetSet
    ...
    def _deserialize(self, params):
        if params.get("BudgetSet") is not None:
            self._BudgetSet = []
            for item in params.get("BudgetSet"):
                obj = BudgetInfo()
                obj._deserialize(item)
                self._BudgetSet.append(obj)
        self._TotalCount = params.get("TotalCount")
        self._RequestId = params.get("RequestId")
...
class DescribeModelRouterDetailResponse(AbstractModel):
    r"""DescribeModelRouterDetail返回参数结构体

    """

    def __init__(self):
        r"""
        :param _ModelRouter: <p>模型路由实例详情</p>
        :type ModelRouter: :class:`tencentcloud.clb.v20180317.models.ModelRouterDetail`
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self._ModelRouter = None
        self._RequestId = None

    @property
    def ModelRouter(self):
        r"""<p>模型路由实例详情</p>
        :rtype: :class:`tencentcloud.clb.v20180317.models.ModelRouterDetail`
        """
        return self._ModelRouter

    @ModelRouter.setter
    def ModelRouter(self, ModelRouter):
...
class DescribeModelRouterQuotaRequest(AbstractModel):
    r"""DescribeModelRouterQuota请求参数结构体
    ...
    def DisplayFields(self):
        r"""<p>需要展示的字段</p><p>枚举值：</p><ul><li>Used： 已使用的配额数量</li><li>Available： 剩余的配额数量</li></ul>
        :rtype: list of str
        """
...
class DescribeModelRouterQuotaResponse(AbstractModel):
    r"""DescribeModelRouterQuota返回参数结构体

    """

    def __init__(self):
        r"""
        :param _Quotas: <p>配额信息</p>
        :type Quotas: list of ModelRouterQuota
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self._Quotas = None
    ...
    def Quotas(self):
        r"""<p>配额信息</p>
        :rtype: list of ModelRouterQuota
        """
        return self._Quotas
...
class DescribeModelRoutersRequest(AbstractModel):
    r"""DescribeModelRouters请求参数结构体
    ...
    @property
    def Filters(self):
        r"""<p>过滤条件</p><p>支持：ModelRouterName、ModelRouterType、Status、BudgetId、tag-key、tag:&lt;tag-key&gt;。</p>
        :rtype: list of Filter
        """
        return self._Filters
...
class DescribeModelRoutersResponse(AbstractModel):
    r"""DescribeModelRouters返回参数结构体

    """

    def __init__(self):
        r"""
        :param _ModelRouterSet: <p>模型路由实例列表</p>
        :type ModelRouterSet: list of ModelRouterSet
        :param _TotalCount: <p>符合条件的总数</p>
        :type TotalCount: int
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
        self._ModelRouterSet = None
        self._TotalCount = None
        self._RequestId = None

    @property
    def ModelRouterSet(self):
        r"""<p>模型路由实例列表</p>
        :rtype: list of ModelRouterSet
        """
        return self._ModelRouterSet

    @ModelRouterSet.setter
    def ModelRouterSet(self, ModelRouterSet):
        self._ModelRouterSet = ModelRouterSet
    ...
    def _deserialize(self, params):
        if params.get("ModelRouterSet") is not None:
            self._ModelRouterSet = []
            for item in params.get("ModelRouterSet"):
                obj = ModelRouterSet()
                obj._deserialize(item)
                self._ModelRouterSet.append(obj)
        self._TotalCount = params.get("TotalCount")
        self._RequestId = params.get("RequestId")
...
class DescribeUserGroupsRequest(AbstractModel):
    ...
    @property
    def UserGroupIds(self):
        r"""<p>用户组ID列表，用于按ID过滤，单次最多100个；可包含「未分组」虚拟分组 ugrp-ungrouped。</p>
        :rtype: list of str
        """
        return self._UserGroupIds
    ...
    @property
    def Filters(self):
        r"""<p>过滤列表。支持：UserGroupName、Status、tag-key、tag:&lt;tag-key&gt;。</p>
        :rtype: list of Filter
        """
        return self._Filters
...
class DescribeUserGroupsResponse(AbstractModel):
    ...
    def __init__(self):
        r"""
        :param _UserGroups: <p>用户组列表。</p>
        :type UserGroups: list of UserGroupInfo
        :param _TotalCount: <p>符合条件的总数（含「未分组」逻辑组 ugrp-ungrouped：当其未被过滤条件排除时计入，即 TotalCount = 真实用户组数 + 1）。</p>
        :type TotalCount: int
        :param _RequestId: 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
        :type RequestId: str
        """
    ...
    @property
    def TotalCount(self):
        r"""<p>符合条件的总数（含「未分组」逻辑组 ugrp-ungrouped：当其未被过滤条件排除时计入，即 TotalCount = 真实用户组数 + 1）。</p>
        :rtype: int
        """
        return self._TotalCount
    ...
    def _deserialize(self, params):
        if params.get("UserGroups") is not None:
            self._UserGroups = []
            for item in params.get("UserGroups"):
                obj = UserGroupInfo()
                obj._deserialize(item)
                self._UserGroups.append(obj)
        self._TotalCount = params.get("TotalCount")
        self._RequestId = params.get("RequestId")


class DisassociateBudgetRequest(AbstractModel):
    r"""DisassociateBudget请求参数结构体
...
class DisassociateBudgetResponse(AbstractModel):
    r"""DisassociateBudget返回参数结构体
...
class FallBackItem(AbstractModel):
    r"""路由FallBack配置
    ...
    def __init__(self):
        ...
        :type DefaultFallBackModels: list of str
        """
        self._DefaultFallBackModels = None

    @property
    def DefaultFallBackModels(self):
        r"""<p>默认回退模型列表</p>
        :rtype: list of str
        """
        return self._DefaultFallBackModels

    @DefaultFallBackModels.setter
    def DefaultFallBackModels(self, DefaultFallBackModels):
        self._DefaultFallBackModels = DefaultFallBackModels


    def _deserialize(self, params):
        self._DefaultFallBackModels = params.get("DefaultFallBackModels")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            property_name = name[1:]
            if property_name in memeber_set:
...
class InputKeyInfo(AbstractModel):
    r"""创建Key的信息
    ...
    @property
    def PlainKey(self):
        r"""<p>导入的明文Key</p><p>仅允许导入Key模式下输入</p>
        :rtype: str
        """
        return self._PlainKey

    @PlainKey.setter
    def PlainKey(self, PlainKey):
        self._PlainKey = PlainKey


    def _deserialize(self, params):
        self._KeyName = params.get("KeyName")
        self._PlainKey = params.get("PlainKey")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
            property_name = name[1:]
            if property_name in memeber_set:
...
class Job(AbstractModel):
    ...
    @property
    def Status(self):
        r"""<p>异步任务状态</p><p>枚举值：</p><ul><li>Processing： 进行中</li><li>Succeeded： 成功</li><li>Failed： 失败</li></ul>
        :rtype: str
        """
        return self._Status
...
注意：此字段可能返回 null，表示取不到有效值。
        ...
        :type ServiceEndPoints: list of ServiceEndPoints
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def NetworkType(self):
        r"""<p>模型路由实例网络类型</p><p>枚举值：</p><ul><li>Internet： 公网</li><li>Intranet： 内网</li></ul>
        :rtype: str
        """
        return self._NetworkType
    ...
    def RouterSetting(self):
        r"""<p>模型路由的路由配置</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: :class:`tencentcloud.clb.v20180317.models.RouterSettingWithFallBack`
        """
        return self._RouterSetting
    ...
    @property
    def ServiceEndPoints(self):
        r"""<p>模型路由网络配置列表</p>
        :rtype: list of ServiceEndPoints
        """
        return self._ServiceEndPoints

    @ServiceEndPoints.setter
    def ServiceEndPoints(self, ServiceEndPoints):
        self._ServiceEndPoints = ServiceEndPoints

    @property
    def Status(self):
        r"""<p>模型路由实例状态</p><p>枚举值：</p><ul><li>Active： 运行中</li><li>Provisioning： 创建中</li><li>Configuring： 变配中</li></ul>
        :rtype: str
        """
        return self._Status
    ...
    def TradeStatus(self):
        r"""<p>模型路由实例的计费状态</p><p>枚举值：</p><ul><li>Normal： 正常</li><li>Isolated： 已隔离</li></ul>
        :rtype: str
        """
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def _deserialize(self, params):
        ...
        if params.get("ServiceEndPoints") is not None:
            ...
            for item in params.get("ServiceEndPoints"):
                obj = ServiceEndPoints()
                obj._deserialize(item)
                self._ServiceEndPoints.append(obj)
        self._Status = params.get("Status")
        self._SubnetId = params.get("SubnetId")
        if params.get("Tags") is not None:
            self._Tags = []
...
class ModelRouterQuota(AbstractModel):
    r"""模型路由相关配额
...
class ModelRouterSet(AbstractModel):
    r"""模型路由列表
...
class ModifyBudgetAttributesRequest(AbstractModel):
    r"""ModifyBudgetAttributes请求参数结构体
...
class ModifyBudgetAttributesResponse(AbstractModel):
    r"""ModifyBudgetAttributes返回参数结构体
...
class ModifyKeyAttributesRequest(AbstractModel):
    r"""ModifyKeyAttributes请求参数结构体
...
class ModifyKeyAttributesResponse(AbstractModel):
    r"""ModifyKeyAttributes返回参数结构体
...
class ModifyKeysBlockStatusRequest(AbstractModel):
    r"""ModifyKeysBlockStatus请求参数结构体
...
class ModifyKeysBlockStatusResponse(AbstractModel):
    r"""ModifyKeysBlockStatus返回参数结构体
...
class ModifyKeysUserGroupRequest(AbstractModel):
    r"""ModifyKeysUserGroup请求参数结构体
    ...
    @property
    def UserGroupId(self):
        r"""<p>目标归属用户组ID。传真实用户组ID表示批量入组或跨组移动（Key 已属其它组则改为目标组）；传 ugrp-ungrouped 表示批量移出到未分组。</p>
        :rtype: str
        """
        return self._UserGroupId
    ...
    @property
    def KeyIds(self):
        r"""<p>待变更归属的 Key ID 列表，单次1-100个。</p>
        :rtype: list of str
        """
        return self._KeyIds
...
class ModifyKeysUserGroupResponse(AbstractModel):
    r"""ModifyKeysUserGroup返回参数结构体
...
class ModifyListenerRequest(AbstractModel):
    ...
    @property
    def LoadBalancerId(self):
        r"""<p>负载均衡实例ID，可以通过 <a href="https://cloud.tencent.com/document/product/214/30685">DescribeLoadBalancers</a> 接口查询。</p>
        :rtype: str
        """
        return self._LoadBalancerId
    ...
    @property
    def ListenerId(self):
        r"""<p>负载均衡监听器ID，可以通过 <a href="https://cloud.tencent.com/document/product/214/30686">DescribeListeners</a> 接口查询。</p>
        :rtype: str
        """
        return self._ListenerId
    ...
    @property
    def ListenerName(self):
        r"""<p>新的监听器名称。命名规则：1-80 个英文字母、汉字等国际通用语言字符，数字，连接线“-”、下划线“_”等常见字符（禁止Unicode补充字符，如emoji表情、生僻汉字等）。</p>
        :rtype: str
        """
        return self._ListenerName
    ...
    @property
    def SessionExpireTime(self):
        r"""<p>会话保持时间，单位：秒。可选值：30~3600，默认 0，表示不开启。此参数仅适用于TCP/UDP监听器。</p>
        :rtype: int
        """
        return self._SessionExpireTime
    ...
    @property
    def Certificate(self):
        r"""<p>证书相关信息，此参数仅适用于HTTPS/TCP_SSL/QUIC监听器；此参数和MultiCertInfo不能同时传入。</p>
        :rtype: :class:`tencentcloud.clb.v20180317.models.CertificateInput`
        """
        return self._Certificate
    ...
    @property
    def Scheduler(self):
        r"""<p>监听器转发的方式。可选值：WRR（按权重轮询）、LEAST_CONN（按最小连接数）、IP_HASH（按 IP 地址哈希）<br>分别表示按权重轮询、最小连接数， 默认为 WRR。<br>使用场景：适用于TCP/UDP/TCP_SSL/QUIC监听器。七层监听器的均衡方式应在转发规则中修改。</p>
        :rtype: str
        """
        return self._Scheduler
    ...
    @property
    def SniSwitch(self):
        r"""<p>是否开启SNI特性，此参数仅适用于HTTPS监听器。默认0，表示不开启，1表示开启。注意：未开启SNI的监听器可以开启SNI；已开启SNI的监听器不能关闭SNI。</p>
        :rtype: int
        """
        return self._SniSwitch
    ...
    @property
    def TargetType(self):
        r"""<p>后端目标类型，NODE表示绑定普通节点，TARGETGROUP表示绑定目标组。</p>
        :rtype: str
        """
        return self._TargetType
    ...
    @property
    def KeepaliveEnable(self):
        r"""<p>是否开启长连接，此参数仅适用于HTTP/HTTPS监听器。<br>默认值0表示不开启，1表示开启。<br>若后端服务对连接数上限有限制，则建议谨慎开启。此功能目前处于内测中，如需使用，请提交 <a href="https://cloud.tencent.com/apply/p/tsodp6qm21">内测申请</a>。</p>
        :rtype: int
        """
        return self._KeepaliveEnable
    ...
    @property
    def SessionType(self):
        r"""<p>会话保持类型。NORMAL表示默认会话保持类型。QUIC_CID表示根据Quic Connection ID做会话保持。QUIC_CID只支持UDP协议。<br>使用场景：适用于TCP/UDP/TCP_SSL/QUIC监听器。<br>默认为 NORMAL。</p>
        :rtype: str
        """
        return self._SessionType
    ...
    @property
    def MultiCertInfo(self):
        r"""<p>证书信息，支持同时传入不同算法类型的多本服务端证书；此参数仅适用于未开启SNI特性的HTTPS监听器。此参数和Certificate不能同时传入。</p>
        :rtype: :class:`tencentcloud.clb.v20180317.models.MultiCertInfo`
        """
        return self._MultiCertInfo
    ...
    @property
    def MaxConn(self):
        r"""<p>监听器粒度并发连接数上限，当前仅性能容量型实例且仅TCP/UDP/TCP_SSL/QUIC监听器支持。取值范围：1-实例规格并发连接上限，其中-1表示关闭监听器粒度并发连接数限速。基础网络实例不支持该参数。<br>默认为 -1，表示不限速。</p>
        :rtype: int
        """
        return self._MaxConn
    ...
    @property
    def MaxCps(self):
        r"""<p>监听器粒度新建连接数上限，当前仅性能容量型实例且仅TCP/UDP/TCP_SSL/QUIC监听器支持。取值范围：1-实例规格新建连接上限，其中-1表示关闭监听器粒度新建连接数限速。基础网络实例不支持该参数。<br>默认为 -1 表示不限速。</p>
        :rtype: int
        """
        return self._MaxCps
...
class ModifyLoadBalancerAttributesRequest(AbstractModel):
    ...
    @property
    def LoadBalancerName(self):
        r"""<p>负载均衡实例名称，规则：1-80 个英文字母、汉字等国际通用语言字符，数字，连接线“-”、下划线“_”等常见字符（禁止Unicode补充字符，如emoji表情、生僻汉字等）。</p>
        :rtype: str
        """
        return self._LoadBalancerName
    ...
    @property
    def LoadBalancerPassToTarget(self):
        r"""<p>Target是否放通来自CLB的流量。<br>开启放通（true）：只验证CLB上的安全组；<br>不开启放通（false）：需同时验证CLB和后端实例上的安全组。<br>不填则不修改。</p>
        :rtype: bool
        """
        return self._LoadBalancerPassToTarget
...
class ModifyUserGroupAttributesRequest(AbstractModel):
    r"""ModifyUserGroupAttributes请求参数结构体
    ...
    @property
    def UserGroupId(self):
        r"""<p>待修改的用户组ID。不可为「未分组」虚拟分组 ugrp-ungrouped。</p>
        :rtype: str
        """
        return self._UserGroupId
    ...
    @property
    def BudgetId(self):
        r"""<p>用户组关联的预算ID。不传则不修改预算关联；传入有效 budget-xxx 则将该用户组关联到此预算（若已关联其它预算则替换为本预算）。仅支持关联/替换，不支持解绑——解绑请用 DisassociateBudget。预算与组内 Key、所属实例的预算各自独立判定。</p>
        :rtype: str
        """
        return self._BudgetId
    ...
    @property
    def IntentRouters(self):
        r"""<p>用户组意图路由白名单（ir-xxx）。每一项须为该实例已创建的意图路由名。不传则不修改；传入即整体覆盖。</p>
        :rtype: list of str
        """
        return self._IntentRouters
    ...
    @property
    def Models(self):
        r"""<p>用户组真实模型白名单。每一项须为该实例已关联的模型名。不传则不修改；传入即整体覆盖。</p>
        :rtype: list of str
        """
        return self._Models
    ...
    @property
    def UserGroupName(self):
        r"""<p>用户组名称。不传则不修改；传入时长度不超过255个字符、同实例下唯一。</p>
        :rtype: str
        """
        return self._UserGroupName
...
class ModifyUserGroupAttributesResponse(AbstractModel):
    r"""ModifyUserGroupAttributes返回参数结构体
...
class RateLimitConfigForBudget(AbstractModel):
    r"""Budget限速配置
    ...
    @property
    def TPM(self):
        r"""<p>每分钟限制的Token数量。</p><p>单位：个/分钟。</p>
        :rtype: int
        """
        return self._TPM
...
class RateLimitConfigForKey(AbstractModel):
    r"""限速配置
    ...
    def __init__(self):
        r"""
        :param _MaxParallelRequest: <p>最大并发请求数量</p><p>单位：次</p>
        :type MaxParallelRequest: int
        :param _RPM: <p>每分钟限制的请求数量</p><p>单位：次/分钟</p>
        :type RPM: int
        :param _TPM: <p>每分钟限制的Token数量</p><p>单位：个/分钟</p>
        :type TPM: int
        """
        self._MaxParallelRequest = None
        self._RPM = None
        self._TPM = None

    @property
    def MaxParallelRequest(self):
        r"""<p>最大并发请求数量</p><p>单位：次</p>
        :rtype: int
        """
        return self._MaxParallelRequest

    @MaxParallelRequest.setter
    def MaxParallelRequest(self, MaxParallelRequest):
        self._MaxParallelRequest = MaxParallelRequest
    ...
    def _deserialize(self, params):
        self._MaxParallelRequest = params.get("MaxParallelRequest")
        self._RPM = params.get("RPM")
        self._TPM = params.get("TPM")
        memeber_set = set(params.keys())
        for name, value in vars(self).items():
...
class RateLimitConfigForModelRouter(AbstractModel):
    r"""限速配置
...
class RegenerateKeysResponse(AbstractModel):
    r"""RegenerateKeys返回参数结构体
    ...
    def FailedKeyIds(self):
        r"""<p>重新生成失败的Key的ID列表</p>
        :rtype: list of str
        """
        return self._FailedKeyIds
...
class RegeneratedKey(AbstractModel):
    r"""重新生成的Key信息
...
class RouterSettingWithFallBack(AbstractModel):
    r"""路由设置
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    def FallBack(self):
        r"""<p>回退策略</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: :class:`tencentcloud.clb.v20180317.models.FallBackItem`
        """
...
class RouterSettingWithoutFallBack(AbstractModel):
    r"""路由设置
    ...
    @property
    def RoutingStrategy(self):
        r"""<p>路由策略</p><p>枚举值：</p><ul><li>SimpleShuffle： 简单随机路由</li><li>LeastBusy： 最低繁忙路由</li><li>LatencyBasedRouting： 最低延迟路由</li><li>UsageBasedRouting： 用量均衡路由</li><li>CostBasedRouting： 最低积分路由</li></ul>
        :rtype: str
        """
        return self._RoutingStrategy
...
class ServiceEndPoints(AbstractModel):
    r"""模型路由网络服务信息
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    @property
    def UserGroupId(self):
        r"""<p>用户组ID。「未分组」虚拟分组固定为 ugrp-ungrouped。</p>
        :rtype: str
        """
        return self._UserGroupId
    ...
    @property
    def UserGroupName(self):
        r"""<p>用户组名称。「未分组」虚拟分组固定为 ungrouped。</p>
        :rtype: str
        """
        return self._UserGroupName
    ...
    @property
    def Status(self):
        r"""<p>用户组状态。</p><p>枚举值：</p><ul><li>Creating：创建中</li><li>Active：正常</li><li>Configuring：配置中</li><li>Deleting：删除中</li></ul><p>「未分组」虚拟分组（ugrp-ungrouped）恒为 Active。</p>
        :rtype: str
        """
        return self._Status
    ...
    @property
    def IntentRouters(self):
        r"""<p>用户组意图路由白名单（ir-xxx）。「未分组」虚拟分组为空数组。</p>
        :rtype: list of str
        """
        return self._IntentRouters
    ...
    @property
    def BudgetId(self):
        r"""<p>关联的Budget ID。</p><p>未关联时为空；「未分组」虚拟分组恒为空。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._BudgetId
    ...
    @property
    def BudgetName(self):
        r"""<p>关联的Budget名称。</p><p>未关联时为空；「未分组」虚拟分组恒为空。</p>
注意：此字段可能返回 null，表示取不到有效值。
        :rtype: str
        """
        return self._BudgetName
    ...
    @property
    def KeyCount(self):
        r"""<p>用户组当前包含的 Key 数量。「未分组」虚拟分组（ugrp-ungrouped）返回该模型路由实例下未归属任何用户组的 Key 数量。</p>
        :rtype: int
        """
