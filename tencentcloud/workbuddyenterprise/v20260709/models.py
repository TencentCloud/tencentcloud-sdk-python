...
class DescribeUserAccessTokenRequest(AbstractModel):
    r"""DescribeUserAccessToken请求参数结构体

    """


class DescribeUserAccessTokenResponse(AbstractModel):
    r"""DescribeUserAccessToken返回参数结构体
