...
前往 [CNB](https://cnb.cool/tencent/cloud/api/sdk/tencentcloud-sdk-python)、[Github 仓库](https://github.com/tencentcloud/tencentcloud-sdk-python) 或者 [Gitee 仓库](https://gitee.com/tencentcloud/tencentcloud-sdk-python) 下载最新代码，解压后
